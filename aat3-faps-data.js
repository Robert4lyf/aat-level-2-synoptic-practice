...
(function (root) {
  ...
  var QUESTIONS = [
    ...
    {
      id: 'F-1-14', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.1.1'],
      type: 'mcq',
      q: 'Why does the Conceptual Framework treat investors, lenders and other creditors as the PRIMARY users of final accounts?',
      opts: [
        'They provide resources to the business and cannot demand the information they need directly',
        'They are the only parties with a legal right to receive the accounts',
        'They are the parties most affected by how the business trades day to day',
        'They are the users the accountant is contractually engaged to serve',
      ],
      ans: 0,
      exp: 'The test is dependence, not importance. These three commit resources and cannot compel a special report, so general purpose accounts are written for them. Management can ask for any report it likes, and employees and customers are affected without providing capital.',
    },
    {
      id: 'F-1-15', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.1.1'],
      type: 'picklist',
      q: 'Classify each party by its standing as a user of published final accounts.',
      picklist: {
        title: 'Users of final accounts',
        rowHeader: 'Party', choiceHeader: 'Standing',
        options: ['Primary user', 'Other user'],
        rows: [
          { text: 'A bank considering a loan to the business', answer: 0 },
          { text: 'A supplier deciding whether to offer credit terms', answer: 0 },
          { text: 'An individual thinking of buying a stake in the business', answer: 0 },
          { text: 'HMRC checking the tax return', answer: 1 },
          { text: 'An employee wondering whether their job is secure', answer: 1 },
          { text: 'The managing director planning next year', answer: 1 },
        ],
      },
      exp: 'Lenders, other creditors such as suppliers, and existing or potential investors are the three primary groups. HMRC, employees and management all use accounts, but each can require information on its own terms, so the accounts are not written specifically for them.',
    },
    {
      id: 'F-1-16', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.1.2'],
      type: 'mcq',
      q: 'A lender is deciding whether to renew an overdraft. Which question do the final accounts most directly help it answer?',
      opts: [
        'Whether the business will be able to pay the money back',
        'Whether the business is charging the right price for its product',
        'Whether the workforce is being paid at market rates',
        'Whether the owner is drawing more than the business can afford',
      ],
      ans: 0,
      exp: 'A lender is deciding whether to provide resources, so it reads the accounts for the ability to repay — liquidity, existing borrowing and the profits available to service it. Pricing and pay rates are management questions, and drawings matter only through that same repayment lens.',
    },
    {
      id: 'F-1-17', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.1.2'],
      type: 'truefalse',
      q: 'Identify whether each statement about how primary users use final accounts is correct.',
      statements: [
        { text: 'An investor uses them to decide whether to buy, hold or sell a stake.', answer: true },
        { text: 'A supplier uses them to judge whether it will be paid for goods supplied on credit.', answer: true },
        { text: 'Final accounts are prepared to tell primary users what the business is worth today.', answer: false },
        { text: 'Primary users can require the business to prepare a report to their own specification.', answer: false },
      ],
      exp: 'Investors decide about a stake and lenders and creditors about credit, which is what the accounts are for. They do not state a market value: assets are carried at cost less depreciation, not at what they would fetch. And a primary user unable to demand its own report is precisely why these accounts exist.',
    },
    {
      id: 'F-1-18', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.1.2'],
      type: 'mcq',
      q: 'A potential investor reads a sole trader\'s final accounts. What are they principally trying to assess?',
      opts: [
        'The returns they might expect, and the risk attached to them',
        'Whether the bookkeeping complies with the accounting standards',
        'How the owner intends to spend next year\'s profit',
        'Whether the business pays its taxes on time',
      ],
      ans: 0,
      exp: 'An investor commits money in the expectation of a return, so the accounts are read for the prospects of future cash and the risk of not receiving it. Compliance and tax matter, but they are means to a reliable set of figures rather than the decision itself.',
    },
    {
      id: 'F-1-19', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.1.2'],
      type: 'mcq',
      q: 'Final accounts are described as GENERAL PURPOSE. What does that mean?',
      opts: [
        'They serve the common needs of many users rather than any one user\'s needs exactly',
        'They may be used for any purpose the reader chooses without restriction',
        'They cover every part of the business rather than a single department',
        'They are prepared to a general format rather than a prescribed one',
      ],
      ans: 0,
      exp: 'One set of accounts is written for a whole group of users with different questions, so it answers each of them only in part. That is a deliberate compromise, not a shortcoming — and it is why a lender doing serious due diligence asks for more than the published accounts.',
    },
    {
      id: 'F-1-20', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'picklist',
      q: 'Identify the accounting principle each treatment rests on.',
      picklist: {
        title: 'Principles in practice',
        rowHeader: 'Treatment', choiceHeader: 'Principle',
        options: ['Accruals', 'Going concern', 'Business entity', 'Money measurement', 'Consistency'],
        rows: [
          { text: 'An electricity bill for December is charged to the year although it is paid in January', answer: 0 },
          { text: 'A van is carried at cost less depreciation rather than at auction value', answer: 1 },
          { text: 'The owner\'s private car is kept out of the accounts', answer: 2 },
          { text: 'A highly skilled workforce appears nowhere in the accounts', answer: 3 },
          { text: 'Inventory is valued on the same basis as last year', answer: 4 },
        ],
      },
      exp: 'Each row is the principle doing its everyday work. Accruals puts the cost in the period it belongs to. Going concern justifies the carrying value, and business entity keeps the owner separate. Money measurement excludes what cannot be priced, and consistency makes this year comparable with last.',
    },
    {
      id: 'F-1-21', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'mcq',
      q: 'A business is told by its bank that funding will be withdrawn and it will close within three months. What follows for the accounts?',
      opts: [
        'The going concern basis no longer applies, so assets are restated at what they would realise',
        'Depreciation is simply stopped, and the assets stay at their present carrying value',
        'Nothing changes until the business has actually ceased to trade',
        'Only the disclosure notes change; the figures themselves are unaffected',
      ],
      ans: 0,
      exp: 'Going concern is an assumption, and it can fail. Once the business will not continue, carrying an asset at cost less depreciation states a value nobody will ever get, so the break-up basis replaces it. Waiting for closure would publish one more set of misleading accounts.',
    },
    {
      id: 'F-1-22', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'mcq',
      q: 'A customer is suing the business. The lawyers say a loss is probable but a gain on a counterclaim is merely possible. Which principle decides the treatment?',
      opts: [
        'Prudence — recognise the probable loss, and not the possible gain',
        'Materiality — recognise whichever amount is larger',
        'Consistency — treat both the same way as last year',
        'Accruals — recognise both, since both arose in this period',
      ],
      ans: 0,
      exp: 'Prudence is caution under uncertainty. A probable loss is provided for; a gain that is merely possible is not recognised, because overstating what the business owns is the error that misleads a lender. Accruals decides WHEN a recognised item falls, not WHETHER an uncertain one is recognised.',
    },
    {
      id: 'F-1-23', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'mcq',
      q: 'A business changes from FIFO to AVCO for no reason other than that AVCO gives a higher profit this year. Which principle does that breach?',
      opts: [
        'Consistency',
        'Money measurement',
        'Business entity',
      ...
      ans: 0,
      exp: 'Consistency requires the same treatment period to period so the two can be compared. A change is allowed when it gives a better presentation. Changing to flatter the profit destroys the comparison, and a reader who is not told cannot see it happen.',
    },
    {
      id: 'F-1-24', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'truefalse',
      q: 'Identify whether each statement about the money measurement principle is correct.',
      statements: [
        { text: 'A brand\'s reputation built up over years is not recorded as an asset.', answer: true },
        { text: 'The loss of the business\'s most productive employee is recorded as an expense.', answer: false },
        { text: 'Only items that can be expressed in money terms enter the accounts.', answer: true },
        { text: 'Money measurement is why a business records a purchased patent but not staff morale.', answer: true },
      ],
      exp: 'The principle draws a hard line: if it cannot be measured in money it does not go in, however much it matters to the business. That is why a purchased patent is an asset and an equally valuable reputation built in-house is not, and why losing a key person changes nothing in the ledger.',
    },
    {
      id: 'F-1-25', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'mcq',
      q: 'The owner pays a personal credit card bill from the business bank account. How is it recorded?',
      opts: [
        'As drawings, because the business and the owner are separate',
        'As an expense, because the business paid it',
        'Not at all, because it is a private matter',
        'As a liability, because the owner now owes the business',
      ],
      ans: 0,
      exp: 'Business entity makes the business a separate accounting person from its owner, so money taken for private use is drawings and reduces capital. Treating it as an expense would understate profit; leaving it out would leave the bank balance wrong.',
    },
    {
      id: 'F-1-26', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'mcq',
      q: 'Rent of £12,000 for the year to 31 March is paid on 1 April. The accounts are made up to 31 December. What does the accruals principle require?',
      opts: [
        '£9,000 charged as an expense and £3,000 carried forward as a prepayment',
        'The whole £12,000 charged, because it was all paid in the year',
        '£3,000 charged, because that is the part relating to next year',
        'Nothing charged until the rent period has finished',
      ],
      ans: 0,
      exp: 'Nine of the twelve months fall in the year to 31 December, so 12,000 × 9/12 = £9,000 is the expense and the remaining £3,000 is an asset carried forward. Accruals matches cost to the period that benefits, whatever the cash did.',
    },
    {
      id: 'F-1-27', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'mcq',
      q: 'A business buys a stapler for £4 and charges it straight to expenses rather than treating it as a non-current asset. Which principle justifies that?',
      opts: [
        'Materiality',
        'Prudence',
        'Accruals',
      ...
      ans: 0,
      exp: 'The stapler will last for years, so in strict terms it is a non-current asset to be depreciated. Materiality says nobody\'s decision turns on £4, and the cost of tracking it exceeds any benefit. Prudence is about uncertainty, and would not by itself license the shortcut.',
    },
    {
      id: 'F-1-28', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'gapfill',
      q: 'Complete the statement of the business entity principle.',
      template: 'The business is treated as {0} from its owner. Amounts the owner takes for personal use are therefore recorded as {1}, which reduces {2}.',
      gaps: [
        { options: ['a separate accounting entity', 'the same legal person', 'a branch of the owner'], answer: 0 },
        { options: ['drawings', 'wages', 'an expense of trading'], answer: 0 },
        { options: ['capital', 'profit', 'the bank balance only'], answer: 0 },
      ],
      exp: 'Separation is what makes a sole trader\'s accounts meaningful at all. Without it the owner\'s spending and the business\'s trading run together, and no reader can tell what the business earned.',
    },
    {
      id: 'F-1-29', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'truefalse',
      q: 'Identify whether each statement about prudence is correct.',
      statements: [
        { text: 'Prudence permits deliberately understating profit to build a reserve for bad years.', answer: false },
        { text: 'Prudence requires caution in making judgements under conditions of uncertainty.', answer: true },
        { text: 'Prudence means liabilities and expenses are not understated.', answer: true },
        { text: 'Prudence applies whether or not the outcome is uncertain.', answer: false },
      ],
      exp: 'Prudence is caution where the outcome is genuinely uncertain, and nothing more. Deliberate understatement is as much a misstatement as overstatement, because the hidden reserve misleads in the other direction. Where there is no uncertainty, there is nothing for prudence to do.',
    },
    {
      id: 'F-1-30', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'mcq',
      q: 'Which of these is NOT one of the accounting principles underlying the preparation of final accounts?',
      opts: [
        'Maximisation',
        'Materiality',
        'Consistency',
      ...
      ans: 0,
      exp: 'The principles are accruals, going concern, business entity, materiality, consistency, prudence and money measurement. There is no principle of maximisation; accounts report what happened, and a rule to maximise anything would be the opposite of neutral.',
    },
    {
      id: 'F-1-31', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.2.1'],
      type: 'mcq',
      q: 'Which principle is the reason closing inventory is valued at the LOWER of cost and net realisable value?',
      opts: [
        'Prudence',
        'Consistency',
        'Business entity',
      ...
      ans: 0,
      exp: 'Where goods will sell for less than they cost, the loss has effectively happened and carrying them at cost would overstate both the asset and the profit. Taking the lower figure is prudence applied to a specific, recurring uncertainty.',
    },
    {
      id: 'F-1-32', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.1'],
      type: 'truefalse',
      q: 'Identify whether each statement about faithful representation is correct.',
      statements: [
        { text: 'Information must be complete, neutral and free from error.', answer: true },
        { text: 'Free from error means every figure is accurate to the penny.', answer: false },
        { text: 'Neutral means the information is not slanted to produce a particular reaction.', answer: true },
        { text: 'An estimate can never be a faithful representation.', answer: false },
      ],
      exp: 'Faithful representation has three parts: complete, neutral, free from error. Free from error is about the process and the description, not perfect accuracy — an estimate is faithful when it is described as an estimate and arrived at properly. Most accounts would be impossible otherwise.',
    },
    {
      id: 'F-1-33', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.1'],
      type: 'mcq',
      q: 'Information about a business is perfectly accurate but arrives too late to affect any decision. What is it missing?',
      opts: [
        'Relevance — it cannot make a difference to a decision',
        'Faithful representation — it is no longer complete',
        'Verifiability — nobody can now confirm it',
        'Understandability — the reader cannot follow it',
      ],
      ans: 0,
      exp: 'Relevance means capable of making a difference to a decision, so information that cannot reach a decision is irrelevant however accurate it is. Timeliness is the enhancing characteristic that supports relevance here, but the thing actually lost is relevance itself.',
    },
    {
      id: 'F-1-34', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.1'],
      type: 'mcq',
      q: 'What does it mean to say relevance and faithful representation are FUNDAMENTAL rather than enhancing?',
      opts: [
        'Information lacking either one is not useful at all',
        'They are harder to achieve than the other characteristics',
        'They were the first characteristics the framework identified',
        'They apply to the whole accounts rather than to single figures',
      ],
      ans: 0,
      exp: 'The two fundamentals are the entry requirement: fail either and there is nothing to enhance. The four enhancing characteristics make useful information more useful, and no amount of comparability or verifiability rescues a figure nobody needed.',
    },
    {
      id: 'F-1-35', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.2'],
      type: 'mcq',
      q: 'Two accountants independently value the same inventory and reach the same figure from the same records. Which enhancing characteristic does that demonstrate?',
      opts: [
        'Verifiability',
        'Comparability',
        'Timeliness',
      ...
      ans: 0,
      exp: 'Verifiability means knowledgeable, independent observers could reach broadly the same result. It is what stops a figure resting on one person\'s word. Comparability is about setting figures beside other periods or businesses, which is a different test.',
    },
    {
      id: 'F-1-36', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.2'],
      type: 'mcq',
      q: 'An accountant leaves out a complex but significant transaction because readers might find it hard to follow. Is that consistent with understandability?',
      opts: [
        'No — understandability never justifies omitting information users need',
        'Yes — information users cannot follow has no value to them',
        'Yes, provided the omission is disclosed in a note',
        'No, unless the transaction is immaterial in size',
      ],
      ans: 0,
      exp: 'Understandability asks for clear presentation, not a simpler set of facts. The framework assumes a reader with reasonable business knowledge who is willing to study the accounts. Dropping a significant transaction makes the accounts wrong rather than clear.',
    },
    {
      id: 'F-1-37', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.2'],
      type: 'truefalse',
      q: 'Identify whether each statement about comparability is correct.',
      statements: [
        { text: 'Comparability requires the same item to be treated the same way from year to year.', answer: true },
        { text: 'Comparability means every business must use identical accounting policies.', answer: false },
        { text: 'Disclosing the policies used supports comparability between businesses.', answer: true },
        { text: 'Uniformity and comparability mean the same thing.', answer: false },
      ],
      exp: 'Comparability lets a reader see likenesses and differences, which is not the same as forcing everyone to look alike. Two businesses may properly choose different depreciation methods; what comparability needs is that each says which it used, so the difference can be seen rather than mistaken for performance.',
    },
    {
      id: 'F-1-38', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.3'],
      type: 'mcq',
      q: 'Which best describes when a misstatement is MATERIAL?',
      opts: [
        'When it could reasonably be expected to influence a user\'s decision',
        'When it exceeds a fixed percentage of revenue set by the standards',
        'When it arises from a deliberate act rather than an error',
        'When it affects the statement of financial position rather than profit',
      ],
      ans: 0,
      exp: 'Materiality is judged by whether the decision changes, which depends on both size and nature and so cannot be reduced to a single percentage. Intent decides how serious the conduct was, not whether the figure matters to a reader.',
    },
    {
      id: 'F-1-39', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.3'],
      type: 'mcq',
      q: 'A small error would be immaterial by size, but correcting it turns a reported profit into a loss. What follows?',
      opts: [
        'It is material, because its nature changes the picture a reader takes away',
        'It is immaterial, because materiality is settled by size',
        'It is material only if the business is required to have an audit',
        'It is immaterial, provided the error is disclosed in a note',
      ],
      ans: 0,
      exp: 'Size and nature are both tests, and either can make an item material. Turning a profit into a loss changes what a lender or investor concludes, so the amount is beside the point. A note does not cure a figure that is wrong on the face of the accounts.',
    },
    {
      id: 'F-1-40', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.3'],
      type: 'truefalse',
      q: 'Identify whether each statement about material misstatement is correct.',
      statements: [
        { text: 'Several individually immaterial errors can be material when taken together.', answer: true },
        { text: 'Materiality depends on the size of the business as well as the size of the item.', answer: true },
        { text: 'An item is immaterial if it is below 5% of profit in every case.', answer: false },
        { text: 'Free from material misstatement means the accounts contain no errors at all.', answer: false },
      ],
      exp: 'Errors aggregate, and the same £5,000 matters differently to a corner shop and to a national chain. There is no universal percentage — a rule of thumb is a starting point, never the answer — and freedom from MATERIAL misstatement plainly allows immaterial ones to remain.',
    },
    {
      id: 'F-1-41', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.4'],
      type: 'mcq',
      q: 'The owner asks the accountant to value inventory optimistically so the accounts support a loan application. Which principle is engaged first?',
      opts: [
        'Objectivity — the request is an attempt to influence professional judgement',
        'Confidentiality — the loan application is private information',
        'Professional competence — inventory valuation requires specialist skill',
        'Professional behaviour — the request may bring the profession into disrepute',
      ],
      ans: 0,
      exp: 'The pressure is aimed squarely at the accountant\'s judgement, which is what objectivity protects. Integrity follows immediately if the figure is actually changed. Confidentiality and competence are not what the request threatens.',
    },
    {
      id: 'F-1-42', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.4'],
      type: 'mcq',
      q: 'An accountant accepts a schedule of accrued income from a client without asking how the figures were arrived at. Which is the failing?',
      opts: [
      ...
      ans: 0,
      exp: 'Scepticism means a questioning mind and a critical assessment of evidence. A schedule the client prepared is a representation, not evidence for itself, and accepting it unexamined is the failure the principle names. Competence is about ability, and nothing here suggests the accountant could not have asked.',
    },
    {
      id: 'F-1-43', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.4'],
      type: 'truefalse',
      q: 'Identify whether each response to pressure over the final accounts is acceptable.',
      statements: [
        { text: 'Raising the concern with the owner and recording the discussion.', answer: true },
        { text: 'Making the change and noting on file that it was done under instruction.', answer: false },
        { text: 'Seeking advice from AAT where the matter cannot be resolved internally.', answer: true },
        { text: 'Resigning without raising the matter at all.', answer: false },
      ],
      exp: 'Raising, documenting and escalating are what the Code expects. A note on file does not make a knowingly wrong figure acceptable — the accounts still go out wrong. And walking away in silence leaves the misstatement in place and the next person unwarned.',
    },
    {
      id: 'F-1-44', unitKey: 'faps', lo: 1, criteria: ['FAPS-1.3.4'],
      type: 'mcq',
      q: 'Why does professional scepticism matter particularly at the year end?',
      opts: [
        'The estimates and judgements that decide the result are concentrated there',
        'Most bookkeeping errors are made in the final month of the year',
        'The accountant has least time available at that point',
        'It is the only point at which the Code of Ethics applies',
      ],
      ans: 0,
      exp: 'Accruals, provisions, depreciation lives, inventory values and doubtful debts are all judgements, and all fall at the year end. That is where an optimistic assumption moves the reported profit most, and where a questioning mind is worth most.',
    },

    {
      id: 'F-2-40', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.1.1'],
      type: 'mcq',
      q: 'Why does the accounting equation matter for keeping accounting records?',
      opts: [
        'Every transaction keeps it in balance, so a broken equation signals an error',
        'It determines how much profit the business is allowed to report',
        'It sets the order in which ledger accounts must be written up',
        'It decides which transactions need authorisation before posting',
      ],
      ans: 0,
      exp: 'Assets = capital + liabilities holds after every single transaction, because each one changes two things by equal amounts. That is what makes double entry self-checking: the equation failing is proof that something was recorded wrongly.',
    },
    {
      id: 'F-2-41', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.1.1', 'FAPS-2.1.2'],
      type: 'truefalse',
      q: 'Identify whether each transaction changes the TOTAL of the accounting equation.',
      statements: [
        { text: 'Buying a van for cash.', answer: false },
        { text: 'The owner introducing capital in cash.', answer: true },
        { text: 'Paying a supplier from the bank.', answer: true },
        { text: 'A credit customer paying their balance.', answer: false },
      ],
      exp: 'Buying for cash and receiving from a customer swap one asset for another, so the total is unmoved. Introducing capital raises assets and capital together; paying a supplier lowers assets and liabilities together. Both sides always move by the same amount, which is why the equation survives either way.',
    },
    {
      id: 'F-2-42', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.1.3'],
      type: 'numeric',
      q: 'Opening capital was £62,000. The owner introduced £8,000, drawings were £21,500 and closing capital is £74,300. What was the profit for the year, in pounds?',
      answer: 25800, unit: '£',
      exp: 'Closing capital = opening + introduced + profit − drawings, so profit = 74,300 − 62,000 − 8,000 + 21,500 = £25,800. Drawings are added back because they reduced capital without being a cost of trading.',
    },
    {
      id: 'F-2-43', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.2.1'],
      type: 'picklist',
      q: 'Identify the classification of each of these ledger accounts.',
      picklist: {
        title: 'Ledger classification',
        rowHeader: 'Account', choiceHeader: 'Classification',
        options: ['Asset', 'Liability', 'Capital', 'Income', 'Expense'],
        rows: [
          { text: 'Allowance for doubtful receivables', answer: 0 },
          { text: 'Accruals', answer: 1 },
          { text: 'Drawings', answer: 2 },
          { text: 'Discounts received', answer: 3 },
          { text: 'Irrecoverable debts', answer: 4 },
          { text: 'Prepayments', answer: 0 },
        ],
      },
      exp: 'The allowance is a contra-asset, sitting against receivables, so it belongs with assets rather than liabilities. Drawings reduce capital and are classified with it, not as an expense. Discounts received are income; irrecoverable debts are the expense of a debt that failed.',
    },
    {
      id: 'F-2-44', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.3.1', 'FAPS-2.3.2'],
      type: 'picklist',
      q: 'Identify the book of prime entry for each document.',
      picklist: {
        title: 'Books of prime entry',
        rowHeader: 'Document', choiceHeader: 'Book of prime entry',
        options: ['Sales daybook', 'Purchases returns daybook', 'Cash book', 'Journal', 'Petty cash book'],
        rows: [
          { text: 'A sales invoice sent to a credit customer', answer: 0 },
          { text: 'A credit note received from a supplier', answer: 1 },
          { text: 'A BACS receipt from a customer', answer: 2 },
          { text: 'The year-end depreciation charge', answer: 3 },
          { text: 'A £6 taxi fare reimbursed from the tin', answer: 4 },
        ],
      },
      exp: 'A credit note RECEIVED reduces what the business owes a supplier, so it goes in the purchases returns daybook. The direction of the document decides the book, not the word on it. The journal takes what no other book covers: adjustments, corrections and opening balances.',
    },
    {
      id: 'F-2-45', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.3.2'],
      type: 'numeric',
      q: 'A purchases daybook for the month totals £18,400 net with VAT at 20%. What total is posted to the payables ledger control account, in pounds?',
      answer: 22080, unit: '£',
      exp: '£18,400 + (£18,400 × 20%) = £22,080. The control account carries the GROSS figure, because that is what the suppliers are owed. The net goes to purchases and the VAT to the VAT account, and the three agree.',
    },
    {
      id: 'F-2-46', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.3.4'],
      type: 'mcq',
      q: 'What makes the receivables ledger a MEMORANDUM ledger?',
      opts: [
        'It sits outside the double entry, which the control account carries instead',
        'It is kept only until the customer pays, then destroyed',
        'It records estimates rather than actual invoiced amounts',
        'It is a summary, while the control account holds the detail',
      ],
      ans: 0,
      exp: 'The control account is the account in the general ledger and part of the double entry. The individual customer accounts record who owes what without themselves being part of it — which is precisely why agreeing the two is a check rather than a certainty.',
    },
    {
      id: 'F-2-47', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.3.5'],
      type: 'numeric',
      q: 'A payables ledger control account opens at £24,700. Credit purchases are £86,300, payments to suppliers £79,400, and credit notes received £2,100. What is the closing balance, in pounds?',
      answer: 29500, unit: '£',
      exp: '£24,700 + £86,300 − £79,400 − £2,100 = £29,500. Purchases increase what is owed; payments and credit notes reduce it. A credit note received works the same way as a payment for this purpose, without any cash moving.',
    },
    {
      id: 'F-2-48', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.3.6', 'FAPS-2.4.2'],
      type: 'truefalse',
      q: 'Identify whether each statement about what accounting software does at the period end is correct.',
      statements: [
        { text: 'Posting a sales invoice updates the control account and the customer account together.', answer: true },
        { text: 'The software balances off and carries down ledger accounts without being asked.', answer: true },
        { text: 'Automatic posting makes a control account reconciliation unnecessary.', answer: false },
        { text: 'An invoice entered against the wrong customer still leaves the control account correct.', answer: true },
      ],
      exp: 'Automation removes the arithmetic differences a manual system produced, so the two records agree by construction. What it cannot catch is the right total against the wrong customer — the control account is fine and one customer is chased for another\'s debt.',
    },
    {
      id: 'F-2-49', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.4.1'],
      type: 'picklist',
      q: 'Identify what happens to each account at the period end.',
      picklist: {
        title: 'Period end treatment',
        rowHeader: 'Account', choiceHeader: 'At the period end',
        options: ['Balance carried down to the next period', 'Transferred to the statement of profit or loss'],
        rows: [
          { text: 'Rent expense', answer: 1 },
          { text: 'Sales revenue', answer: 1 },
          { text: 'Bank', answer: 0 },
          { text: 'Discounts allowed', answer: 1 },
          { text: 'Accumulated depreciation', answer: 0 },
          { text: 'Payables ledger control', answer: 0 },
        ],
      },
      exp: 'Income and expense accounts measure a period, so they are emptied into profit or loss and start the next period at nil. Assets, liabilities and capital describe a position at a date, so they carry down. Accumulated depreciation is the trap: it sounds like an expense and is a contra-asset.',
    },
    {
      id: 'F-2-50', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.4.3'],
      type: 'mcq',
      q: 'Which source would verify the balance on the bank account in the general ledger?',
      opts: [
        'A bank statement, reconciled for timing differences',
        'The cash book total for the year',
        'The list of payments authorised by the owner',
        'The payables ledger control account',
      ],
      ans: 0,
      exp: 'Verification means agreeing the ledger to something independent of it. The bank statement comes from outside the business, which is what gives it force. The cash book is the same record being checked, and neither of the other two describes the bank balance.',
    },
    {
      id: 'F-2-51', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.4.4'],
      type: 'numeric',
      q: 'A receivables ledger control account has debits totalling £142,600 and credits totalling £118,900. What balance is carried down, in pounds?',
      answer: 23700, unit: '£',
      exp: '£142,600 − £118,900 = £23,700, carried down on the DEBIT side because receivables are an asset. The balance is inserted on the smaller side to make the account total, then brought down on the other — which is why a debit balance appears as a credit entry when balancing off.',
    },
    {
      id: 'F-2-52', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.4.5'],
      type: 'truefalse',
      q: 'Identify whether each item should be included in the business\'s accounting records.',
      statements: [
        { text: 'An invoice addressed to the business for goods it ordered and received.', answer: true },
        { text: 'A subscription in the owner\'s own name, paid from the business account.', answer: false },
        { text: 'A supplier statement showing a balance the business has no invoice for.', answer: false },
        { text: 'A credit note the business has issued to a customer for returned goods.', answer: true },
      ],
      exp: 'The tests are whether the transaction belongs to the business and whether it is supported. The owner\'s subscription is drawings rather than an expense, and a statement is somebody else\'s record — it prompts an enquiry, never a posting on its own.',
    },
    {
      id: 'F-3-30', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.1.1', 'FAPS-3.1.2'],
      type: 'mcq',
      q: 'A purchase of £60,000 of plant is authorised by the person who will operate it. What is wrong?',
      opts: [
        'Authority should rest with someone independent of the request, at a level matching the amount',
        'Plant purchases do not require authorisation, only approval of the invoice',
        'Authorisation should always come from the external accountant',
        'The purchase is too small to require any authorisation',
      ],
      ans: 0,
      exp: 'Someone approving their own request is no control at all. Authority limits exist so that the size of the commitment decides how senior the approver must be, and so that the approver has nothing to gain from the purchase.',
    },
    {
      id: 'F-3-31', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.2.1'],
      type: 'mcq',
      q: 'Which standard sets out the accounting treatment of property, plant and equipment?',
      opts: [
        'IAS 16',
        'IAS 2',
        'IAS 37',
      ...
      ans: 0,
      exp: 'IAS 16 covers recognition, cost, depreciation and derecognition of property, plant and equipment. IAS 2 is inventories, IAS 37 provisions and contingencies, and IFRS 16 leases.',
    },
    {
      id: 'F-3-32', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.2.2'],
      type: 'numeric',
      q: 'An asset costs £74,000, has an estimated residual value of £9,000 and a useful life of five years. What is its depreciable amount, in pounds?',
      answer: 65000, unit: '£',
      exp: '£74,000 − £9,000 = £65,000. The depreciable amount is what the business expects to consume, so the part it expects to recover on sale is excluded. Useful life then decides how that £65,000 is spread, not how much it is.',
    },
    {
      id: 'F-3-33', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.2.3', 'FAPS-3.2.7'],
      type: 'numeric',
      q: 'A machine is invoiced at £52,000. Delivery is £900, installation £2,400, a testing run £600, and the first year of insurance £1,100. What amount is capitalised, in pounds?',
      answer: 55900, unit: '£',
      exp: '£52,000 + £900 + £2,400 + £600 = £55,900. Everything needed to bring the asset to the location and condition for its intended use is capitalised. Insurance is a cost of operating it once it is there, so it is revenue expenditure.',
    },
    {
      id: 'F-3-34', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.2.4', 'FAPS-3.2.6'],
      type: 'mcq',
      q: 'Revenue expenditure of £8,000 is wrongly capitalised. What is the immediate effect?',
      opts: [
        'Profit is overstated by £8,000 and non-current assets are overstated',
        'Profit is understated by £8,000 and non-current assets are overstated',
        'Profit is overstated by £8,000 and non-current assets are unaffected',
        'Neither profit nor non-current assets is affected until the asset is sold',
      ],
      ans: 0,
      exp: 'The cost never reaches profit or loss, so profit is too high by the full amount. It sits on the statement of financial position instead, so assets are too high by the same amount. Depreciation then leaks it into profit over later years, which spreads the error rather than curing it.',
    },
    {
      id: 'F-3-35', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.2.5'],
      type: 'truefalse',
      q: 'A business has a capitalisation policy of £1,000. Identify whether each treatment is correct.',
      statements: [
        { text: 'A £780 office chair expected to last ten years is charged to expenses.', answer: true },
        { text: 'A £1,450 laptop is capitalised and depreciated.', answer: true },
        { text: 'Five chairs at £780 each, bought together, are assessed against the policy as one item.', answer: false },
        { text: 'The policy exists because tracking small items costs more than it is worth.', answer: true },
      ],
      exp: 'The policy applies to the individual asset, so five chairs are five items each below the limit rather than one purchase above it. Buying them on one invoice does not change what each asset is, and treating the invoice as the unit would capitalise things the policy was written to exclude.',
    },
    {
      id: 'F-3-36', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.3.1', 'FAPS-3.3.4'],
      type: 'truefalse',
      q: 'Decide whether each description of the non-current asset register holds.',
      statements: [
        { text: 'It records each asset individually, with cost, depreciation and location.', answer: true },
        { text: 'It helps establish that the assets in the accounts physically exist.', answer: true },
        { text: 'It forms part of the double entry, so it must balance.', answer: false },
        { text: 'It may be a module of the accounting software or a separate spreadsheet.', answer: true },
      ],
      exp: 'The register is a memorandum record: detailed, useful for physical verification and for spotting assets scrapped without being written out, but outside the double entry. That is why reconciling it to the general ledger is a check worth doing rather than an identity.',
    },
    {
      id: 'F-3-37', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.3.2'],
      type: 'mcq',
      q: 'A disposals account is left with a DEBIT balance once the asset, its depreciation and the proceeds have been entered. What does that mean?',
      opts: [
        'A loss on disposal — the proceeds were less than the carrying amount',
        'A gain on disposal — the proceeds exceeded the carrying amount',
        'The asset has not yet been removed from the register',
        'Depreciation was over-charged during the asset\'s life',
      ],
      ans: 0,
      exp: 'The account is debited with cost and credited with accumulated depreciation and proceeds. A debit balance left over means the credits fell short, so less was recovered than the books carried. That balance is the loss, and it goes to profit or loss as an expense.',
    },
    {
      id: 'F-3-38', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.3.3', 'FAPS-3.3.7'],
      type: 'numeric',
      q: 'A van with a carrying amount of £6,400 is part-exchanged. The dealer allows £7,500 against a new van priced at £31,000, and the balance is paid by bank. What is the gain on disposal, in pounds?',
      answer: 1100, unit: '£',
      exp: '£7,500 allowance − £6,400 carrying amount = £1,100 gain. The part-exchange allowance is the proceeds; that it arrives as a reduction in the new van\'s price rather than as cash changes nothing about the disposal.',
    },
    {
      id: 'F-3-39', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.3.5'],
      type: 'mcq',
      q: 'Where does a LOSS on disposal appear in the financial statements?',
      opts: [
        'As an expense in the statement of profit or loss',
        'As a deduction from non-current assets on the statement of financial position',
        'As a reduction of capital, like drawings',
        'Netted against the depreciation charge for the year',
      ],
      ans: 0,
      exp: 'A loss on disposal is the depreciation that was never charged, arriving all at once. It is an expense of the period the asset left. The asset itself has already gone from the statement of financial position, so there is nothing there to deduct it from.',
    },
    {
      id: 'F-3-40', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.3.6'],
      type: 'truefalse',
      q: 'Identify whether each entry in the non-current asset register is correct when an asset is scrapped for nothing.',
      statements: [
        { text: 'The disposal date is recorded.', answer: true },
        { text: 'Proceeds are recorded as nil.', answer: true },
        { text: 'The asset line is deleted so no trace remains.', answer: false },
        { text: 'The whole carrying amount becomes the loss on disposal.', answer: true },
      ],
      exp: 'The register keeps the history: the asset is marked disposed, not erased, so the audit trail survives and the year\'s movements still reconcile. With no proceeds the loss is the entire carrying amount.',
    },
    {
      id: 'F-3-41', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.3.8'],
      type: 'numeric',
      q: 'A VAT-registered business buys a machine for £36,000 plus VAT at 20%. What amount is capitalised, in pounds?',
      answer: 36000, unit: '£',
      exp: 'Only the net £36,000 is capitalised. The VAT of £7,200 is recoverable as input tax, so it never becomes a cost of the asset and goes to the VAT account instead. A business NOT registered for VAT cannot recover it, and would capitalise the full £43,200.',
    },
    {
      id: 'F-3-42', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.3.7'],
      type: 'picklist',
      q: 'Identify the entries recording the disposal of a machine that cost £40,000 with accumulated depreciation of £31,000, sold for £6,500 by bank transfer.',
      picklist: {
        title: 'Disposal entries',
        rowHeader: 'Entry', choiceHeader: 'Debit or credit',
        options: ['Debit', 'Credit'],
        rows: [
          { text: 'Disposals, £40,000', answer: 0 },
          { text: 'Accumulated depreciation, £31,000', answer: 0 },
          { text: 'Bank, £6,500', answer: 0 },
          { text: 'Machinery at cost, £40,000', answer: 1 },
          { text: 'Disposals, £31,000', answer: 1 },
          { text: 'Disposals, £6,500', answer: 1 },
        ],
      },
      exp: 'Cost moves into disposals, accumulated depreciation comes out and follows it, and the proceeds go in. The account then shows 40,000 debit against 31,000 + 6,500 = 37,500 credit, leaving a £2,500 debit — a loss, because the carrying amount of £9,000 exceeded the £6,500 received.',
    },
    {
      id: 'F-4-30', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.1.1'],
      type: 'mcq',
      q: 'How does charging depreciation apply the accruals principle?',
      opts: [
        'It spreads the asset\'s cost across the periods that benefit from using it',
        'It sets aside cash to replace the asset when it wears out',
        'It reduces the asset to what it would sell for today',
        'It recognises the whole cost in the period the asset was paid for',
      ],
      ans: 0,
      exp: 'The asset earns revenue over several years, so its cost belongs to those years rather than to the one that bought it. Depreciation is an allocation of cost, not a valuation and not a fund — no money moves when it is charged.',
    },
    {
      id: 'F-4-31', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.1.2'],
      type: 'numeric',
      q: 'An asset costs £91,000 with a residual value of £7,000 and a useful life of seven years. What is the annual straight-line charge, in pounds?',
      answer: 12000, unit: '£',
      exp: '(£91,000 − £7,000) ÷ 7 = £12,000 a year. Straight line assumes the benefit is consumed evenly, which suits an asset whose usefulness does not fall away faster at the start.',
    },
    {
      id: 'F-4-32', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.1.4'],
      type: 'numeric',
      q: 'A business charges straight-line depreciation at 20% on cost, with a full year in the year of acquisition. An asset costing £45,000 was bought three years ago. What is its carrying amount now, in pounds?',
      answer: 18000, unit: '£',
      exp: '£45,000 × 20% = £9,000 a year, and three full years gives £27,000 accumulated. £45,000 − £27,000 = £18,000. On a percentage-of-cost policy the charge is the same every year until the asset is fully written down.',
    },
    {
      id: 'F-4-33', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.1.5'],
      type: 'numeric',
      q: 'Equipment costs £64,000 and is depreciated at 25% on the diminishing balance. What is the charge in the THIRD year, in pounds?',
      answer: 9000, unit: '£',
      exp: 'Year 1: £64,000 × 25% = £16,000, leaving £48,000. Year 2: £48,000 × 25% = £12,000, leaving £36,000. Year 3: £36,000 × 25% = £9,000. The charge falls each year because the base falls, which is what makes it diminishing.',
    },
    {
      id: 'F-4-34', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.1.4', 'FAPS-4.1.2'],
      type: 'numeric',
      q: 'A policy charges depreciation monthly from the month of acquisition. An asset costing £30,000 with a five-year life and no residual value was bought on 1 September. What is the charge to 31 December, in pounds?',
      answer: 2000, unit: '£',
      exp: '£30,000 ÷ 5 = £6,000 for a full year, and four months from September to December gives £6,000 × 4/12 = £2,000. A monthly policy is more accurate than a full-year one and is the reason the acquisition DATE matters, not just the year.',
    },
    {
      id: 'F-4-35', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.1.3'],
      type: 'truefalse',
      q: 'Identify whether each statement about depreciation calculated by accounting software is correct.',
      statements: [
        { text: 'The method, rate and life are set by the user, not by the software.', answer: true },
        { text: 'An asset entered with the wrong cost is depreciated wrongly every year.', answer: true },
        { text: 'Automatic calculation removes the need to review useful lives.', answer: false },
        { text: 'The charge still has to be reflected in the general ledger.', answer: true },
      ],
      exp: 'The software applies the policy it was given, faithfully and repeatedly, which makes a wrong input a wrong output for the asset\'s whole life. Useful life is an estimate that can change, and reviewing it is judgement no automation supplies.',
    },
    {
      id: 'F-4-36', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.2.1'],
      type: 'picklist',
      q: 'Identify the entries recording a depreciation charge of £7,800 for the year.',
      picklist: {
        title: 'Depreciation journal',
        rowHeader: 'Entry', choiceHeader: 'Debit or credit',
        options: ['Debit', 'Credit', 'Neither'],
        rows: [
          { text: 'Depreciation expense, £7,800', answer: 0 },
          { text: 'Accumulated depreciation, £7,800', answer: 1 },
          { text: 'Non-current asset at cost, £7,800', answer: 2 },
          { text: 'Bank, £7,800', answer: 2 },
        ],
      },
      exp: 'The expense is debited and the contra-asset credited. Cost is never touched: the asset stays at cost and the accumulated account grows beside it. That is what lets the accounts show cost, depreciation to date and carrying amount separately. No cash moves.',
    },
    {
      id: 'F-4-37', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.2.1'],
      type: 'mcq',
      q: 'Why is depreciation credited to a separate accumulated depreciation account rather than to the asset account itself?',
      opts: [
        'So the original cost and the depreciation to date both stay visible',
        'Because the asset account may not be reduced under IAS 16',
        'So the charge can be reversed more easily if the estimate changes',
        'Because the asset account is a memorandum record',
      ],
      ans: 0,
      exp: 'Keeping the two apart means a reader can see what was paid, how much has been consumed and what remains. Netting them would leave a single figure that tells you the carrying amount and nothing about the asset\'s age or the policy applied.',
    },
    {
      id: 'F-4-38', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.2.2'],
      type: 'mcq',
      q: 'The asset register shows a total carrying amount of £142,300 and the general ledger £147,800. Which would explain the difference?',
      opts: [
        'An asset was disposed of and removed from the register but not from the ledger',
        'An asset was depreciated in the ledger at the correct rate',
        'The register records assets by location as well as by cost',
        'The ledger uses the same depreciation policy as the register',
      ],
      ans: 0,
      exp: 'The ledger being higher means it still carries something the register has let go. A disposal entered in one record and not the other is the classic cause. It leaves an asset in the accounts that no longer exists, which is what makes the reconciliation worth doing.',
    },
    {
      id: 'F-4-39', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.1.2'],
      type: 'mcq',
      q: 'An asset\'s useful life is revised from eight years to five, three years into its life. How is the change handled?',
      opts: [
        'The remaining carrying amount is spread over the remaining two years',
        'The depreciation already charged is recalculated and corrected',
        'The asset is written off immediately',
        'The original charge continues, with a balancing adjustment on disposal',
      ],
      ans: 0,
      exp: 'A change of estimate is applied forward, not backwards: what has been charged stands, and what is left is spread over the life now expected. Restating past years would treat a revised estimate as though it had been an error.',
    },
    {
      id: 'F-4-40', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.1.4', 'FAPS-4.1.5'],
      type: 'numeric',
      q: 'An asset costing £20,000 with no residual value has a four-year life. What is the difference between the FIRST year\'s charge under straight line and under 40% diminishing balance, in pounds?',
      answer: 3000, unit: '£',
      exp: 'Straight line: £20,000 ÷ 4 = £5,000. Diminishing balance: £20,000 × 40% = £8,000. The difference is £3,000. Diminishing balance front-loads the charge, so early profits are lower and later ones higher than under straight line.',
    },
    {
      id: 'F-4-41', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.1.1', 'FAPS-4.1.2'],
      type: 'truefalse',
      q: 'Identify whether each statement about depreciation is correct.',
      statements: [
        { text: 'Land is not normally depreciated, because it has an indefinite useful life.', answer: true },
        { text: 'A fully depreciated asset still in use stays in the accounts at nil carrying amount.', answer: true },
        { text: 'Depreciation stops once the asset is fully written down.', answer: true },
        { text: 'An asset with a rising market value is not depreciated.', answer: false },
      ],
      exp: 'Depreciation allocates cost and takes no notice of market value, so a building worth more than it cost is still depreciated. It stops at nil because you cannot consume more than was paid, and the asset stays on the register while it is still in use.',
    },
    {
      id: 'F-4-42', unitKey: 'faps', lo: 4, criteria: ['FAPS-4.2.2'],
      type: 'numeric',
      q: 'The accumulated depreciation account opens at £58,400. The year\'s charge is £14,200 and depreciation of £9,700 is removed on a disposal. What is the closing balance, in pounds?',
      answer: 62900, unit: '£',
      exp: '£58,400 + £14,200 − £9,700 = £62,900. The charge adds to the account and a disposal takes the whole of that asset\'s accumulated depreciation out, because it leaves with the asset.',
    },
    {
      id: 'F-5-33', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.1'],
      type: 'mcq',
      q: 'Which principle requires an accrual to be made for an expense incurred but not yet invoiced?',
      opts: [
        'Accruals — the cost belongs to the period that consumed it',
        'Prudence — an unknown liability should be assumed at its highest',
        'Consistency — the same adjustment was made last year',
        'Materiality — the amount is large enough to matter',
      ],
      ans: 0,
      exp: 'The accruals principle recognises income and expenses in the period they are earned or incurred, whatever the cash did. Prudence explains caution about uncertain amounts and materiality decides whether a figure is worth adjusting, but neither is why the adjustment exists.',
    },
    {
      id: 'F-5-34', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.1', 'FAPS-5.2.1'],
      type: 'truefalse',
      q: 'Identify whether each period end adjustment applies the accruals principle.',
      statements: [
        { text: 'Accruing an electricity cost used but not yet billed.', answer: true },
        { text: 'Carrying forward the unused part of an insurance premium as a prepayment.', answer: true },
        { text: 'Making an allowance for receivables that may not pay.', answer: true },
        { text: 'Paying a supplier earlier than the due date to secure a discount.', answer: false },
      ],
      exp: 'All three adjustments move a cost or a loss into the period it belongs to rather than the period the cash moved. The allowance is the same idea applied to income already recognised: if some of this year\'s sales will not be collected, this year carries that cost. Paying early is a cash decision and adjusts nothing.',
    },
    {
      id: 'F-5-35', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.3'],
      type: 'mcq',
      q: 'An expense account carries an opening accrual brought down of £700. What happens to it in the new period?',
      opts: [
        'It is reversed, so the payment settling it does not charge the new period again',
        'It stays as a liability until the supplier is paid, then becomes an expense',
        'It is added to this period\'s expense to give the total charge',
        'It is written off to the statement of profit or loss as an adjustment',
      ],
      ans: 0,
      exp: 'Last year already carried that £700 as its expense. When the bill is paid this year the payment lands in the expense account, so without the reversal the same cost is charged twice. Reversing the opening balance is what stops the double count.',
    },
    {
      id: 'F-5-36', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.3', 'FAPS-5.1.8'],
      type: 'numeric',
      q: 'A rent account has an opening PREPAYMENT of £1,500. Payments during the year total £18,000 and £2,100 is prepaid at the year end. What is the charge to profit or loss, in pounds?',
      answer: 17400, unit: '£',
      exp: '£1,500 opening prepayment + £18,000 paid − £2,100 closing prepayment = £17,400. The opening prepayment was last year\'s cash buying this year\'s rent, so it is ADDED. The closing prepayment is this year\'s cash buying next year\'s, so it is taken out.',
    },
    {
      id: 'F-5-37', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.5', 'FAPS-5.3.6'],
      type: 'truefalse',
      q: 'Identify whether each statement about what accounting software automates is correct.',
      statements: [
        { text: 'A recurring journal can post an accrual and its reversal each period automatically.', answer: true },
        { text: 'Inventory software can track quantities and value them continuously.', answer: true },
        { text: 'Automation removes the need to check that the amount is still right.', answer: false },
        { text: 'A recurring entry set to the wrong date still posts to the wrong period.', answer: true },
      ],
      exp: 'Software repeats what it was told to repeat. A recurring accrual set up at last year\'s figure keeps posting last year\'s figure, and a date entered wrongly is reproduced faithfully every period. What automation removes is the typing, not the checking.',
    },
    {
      id: 'F-5-38', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.2.1', 'FAPS-5.2.2'],
      type: 'mcq',
      q: 'Why is an allowance for doubtful receivables made in the year of the SALE rather than when the debt finally fails?',
      opts: [
        'The cost belongs with the revenue it arose from, matching the two',
        'The law requires an allowance in the year the sale was made',
        'It keeps the receivables figure equal to the cash now expected',
        'It avoids having to write the debt off in a later period',
      ],
      ans: 0,
      exp: 'Recognising the sale this year and the resulting loss in two years\' time would flatter this year and punish that one. Matching the likely loss to the revenue is the same principle behind accruals and prepayments, applied to income already taken.',
    },
    {
      id: 'F-5-39', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.1', 'FAPS-5.3.3'],
      type: 'mcq',
      q: 'Which standard governs the valuation of inventory?',
      opts: [
        'IAS 2',
        'IAS 16',
        'IAS 1',
      ...
      ans: 0,
      exp: 'IAS 2 Inventories sets the lower of cost and net realisable value rule and says what may go into cost. IAS 16 covers property, plant and equipment, IAS 1 the presentation of financial statements, and IFRS 15 revenue from contracts with customers.',
    },
    {
      id: 'F-5-40', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.1'],
      type: 'mcq',
      q: 'How does carrying unsold goods forward as closing inventory apply the accruals principle?',
      opts: [
        'It holds their cost back until the period in which they are sold',
        'It values them at what they are expected to fetch',
        'It ensures the purchases figure equals the cash paid to suppliers',
        'It spreads their cost evenly over the periods they are held',
      ],
      ans: 0,
      exp: 'Purchases are charged as incurred, but goods still on the shelf have not earned any revenue yet. Deducting them from cost of sales holds their cost back for the period that sells them, so cost meets the revenue it produced.',
    },
    {
      id: 'F-5-41', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.8'],
      type: 'picklist',
      q: 'Identify the journal entries recording closing inventory of £26,400.',
      picklist: {
        title: 'Closing inventory journal',
        rowHeader: 'Entry', choiceHeader: 'Debit or credit',
        options: ['Debit', 'Credit', 'Neither'],
        rows: [
          { text: 'Inventory — statement of financial position, £26,400', answer: 0 },
          { text: 'Inventory — statement of profit or loss (cost of sales), £26,400', answer: 1 },
          { text: 'Purchases, £26,400', answer: 2 },
          { text: 'Bank, £26,400', answer: 2 },
        ],
      },
      exp: 'Closing inventory is one journal with two sides: debit the asset on the statement of financial position, credit cost of sales so the charge falls by the same amount. Purchases and bank are untouched — the goods were bought and paid for already, and the journal only decides which period bears the cost.',
    },
    {
      id: 'F-5-42', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.8', 'FAPS-5.3.7'],
      type: 'numeric',
      q: 'Opening inventory is £21,300, purchases £148,700 and closing inventory £24,900. What is the cost of sales, in pounds?',
      answer: 145100, unit: '£',
      exp: '£21,300 + £148,700 − £24,900 = £145,100. Opening inventory is added because it was bought in an earlier period and sold in this one; closing inventory is taken out because the reverse is true.',
    },
    {
      id: 'F-5-43', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.4.3'],
      type: 'truefalse',
      q: 'Identify whether each is a consequence of including a misleading period end adjustment.',
      statements: [
        { text: 'A lender may extend credit it would otherwise have refused.', answer: true },
        { text: 'The accounts may fail to comply with accounting standards.', answer: true },
        { text: 'The accountant may face disciplinary action from their professional body.', answer: true },
        { text: 'The error corrects itself, so no user is affected.', answer: false },
      ],
      exp: 'An adjustment that shifts profit misleads whoever relies on the accounts. A decision taken on the wrong figure has already been taken by the time the next period reverses it. Reversal in the following year repairs the ledger, never the decision.',
    },
    {
      id: 'F-5-44', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.4.3', 'FAPS-5.4.1'],
      type: 'mcq',
      q: 'Why do period end adjustments carry more risk of manipulation than routine postings?',
      opts: [
        'They rest on judgement, so a defensible-looking figure can be chosen to suit',
        'They are posted after the accounting software has been closed down',
        'They are not recorded in the general ledger',
        'They are outside the scope of the accounting standards',
      ],
      ans: 0,
      exp: 'A sales invoice says what it says. An accrual, an allowance and an inventory valuation are all estimates, and a range of figures can each look reasonable. That is exactly where pressure to report a particular result finds room to work.',
    },
    {
      id: 'F-5-45', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.2', 'FAPS-5.1.6'],
      type: 'numeric',
      q: 'A business is invoiced quarterly in arrears for £3,600 a quarter. The year ends two months after the last invoice was received and paid. What accrual is needed, in pounds?',
      answer: 2400, unit: '£',
      exp: 'Two months of the next quarter have been consumed but not yet billed: £3,600 × 2/3 = £2,400. Billing in arrears always leaves a gap at the year end, which is why an accrual rather than a prepayment is the usual adjustment on this pattern.',
    },
    {
      id: 'F-8-30', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.1.1'],
      type: 'mcq',
      q: 'A sole trader makes a profit of £38,000 and takes drawings of £21,000. What is the net effect on capital?',
      opts: [
        'Capital rises by £17,000, the profit less the drawings',
        'Capital rises by £38,000, and the drawings are an expense',
        'Capital falls by £21,000, and the profit does not affect it',
        'Capital is unchanged, since both pass through profit or loss',
      ],
      ans: 0,
      exp: '£38,000 − £21,000 = £17,000. Profit is added to capital and drawings deducted from it, which is how the statement of profit or loss reaches the statement of financial position. Drawings never touch profit.',
    },
    {
      id: 'F-8-31', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.1.2'],
      type: 'numeric',
      q: 'A business works to a mark-up of 60%. What is the equivalent gross profit margin, as a percentage to one decimal place?',
      answer: 37.5, unit: '%',
      exp: 'Mark-up is on cost, margin on sales. Cost 100 plus mark-up 60 gives sales of 160, so the margin is 60 ÷ 160 × 100 = 37.5%. The margin is always the smaller figure, because the denominator is larger.',
    },
    {
      id: 'F-8-32', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.1.3'],
      type: 'mcq',
      q: 'What does a profitability ratio actually tell a reader that the profit figure alone does not?',
      opts: [
        'How much profit was produced relative to the sales or capital that produced it',
        'Whether the business has enough cash to pay its debts',
        'How the profit will be divided between the owners',
        'Whether the accounting policies comply with the standards',
      ],
      ans: 0,
      exp: 'A profit of £50,000 means one thing on sales of £200,000 and quite another on sales of £5 million. Ratios put profit against the scale that produced it, which is what makes two businesses or two years comparable. Cash is a different question entirely.',
    },
    {
      id: 'F-8-33', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.1.4'],
      type: 'numeric',
      q: 'Sales revenue is £750,000, cost of sales £480,000 and expenses £135,000. What is the net profit margin, as a percentage to one decimal place?',
      answer: 18, unit: '%',
      exp: 'Gross profit £750,000 − £480,000 = £270,000. Profit for the year £270,000 − £135,000 = £135,000. £135,000 ÷ £750,000 × 100 = 18.0%. Both margins use sales revenue as the denominator, which is what lets them be compared with each other.',
    },
    {
      id: 'F-8-34', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.1.4'],
      type: 'numeric',
      q: 'Profit for the year is £72,000. Capital is £310,000, a long-term loan is £90,000 and trade payables are £46,000. What is return on capital employed, as a percentage to one decimal place?',
      answer: 18, unit: '%',
      exp: 'Capital employed = £310,000 + £90,000 = £400,000, and £72,000 ÷ £400,000 × 100 = 18.0%. Capital employed is the long-term funding of the business, so trade payables are excluded — they are a current liability, not capital.',
    },
    {
      id: 'F-8-35', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.1.4'],
      type: 'numeric',
      q: 'Cost of sales is £468,000 and the business works to a mark-up of 25%. What is the sales revenue, in pounds?',
      answer: 585000, unit: '£',
      exp: '£468,000 × 1.25 = £585,000. Mark-up is applied TO cost, so cost is the base and multiplying is the move. Had 25% been a margin, cost would be 75% of sales and the answer £624,000 — which is why the word matters.',
    },
    {
      id: 'F-8-36', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.2.1'],
      type: 'truefalse',
      q: 'Identify whether each is a use of ratio analysis in planning, decision making or control.',
      statements: [
        { text: 'Setting a target margin for next year\'s budget.', answer: true },
        { text: 'Comparing this year\'s expense ratios against last year\'s to find overspending.', answer: true },
        { text: 'Deciding whether to accept an order at a proposed price.', answer: true },
        { text: 'Determining the amount of VAT due on the quarter\'s sales.', answer: false },
        ],
      exp: 'Planning sets targets, control compares outcomes against them, and decisions test a proposal against what the business normally achieves. Working out VAT is a compliance calculation from the records, with no comparison in it.',
    },
    {
      id: 'F-8-37', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.2.2'],
      type: 'mcq',
      q: 'Gross profit margin has fallen while sales revenue has risen. Which explanation fits BOTH facts?',
      opts: [
        'Selling prices were cut to win volume',
        'A new administrative manager was appointed',
        'A long-term loan was repaid during the year',
        'The depreciation rate on delivery vans was increased',
      ],
      ans: 0,
      exp: 'Cutting prices sells more units at a thinner margin on each, which is exactly the pattern described. The other three touch expenses, financing or depreciation — all below the gross profit line, so none of them can move the gross margin at all.',
    },
    {
      id: 'F-8-38', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.2.2'],
      type: 'truefalse',
      q: 'Identify whether each would reduce the NET profit margin while leaving the GROSS profit margin unchanged.',
      statements: [
        { text: 'An increase in office rent.', answer: true },
        { text: 'An increase in the price paid for goods for resale.', answer: false },
        { text: 'Taking on an extra administrator.', answer: true },
        { text: 'Writing off an irrecoverable debt.', answer: true },
      ],
      exp: 'The gross margin is set by revenue and cost of sales alone. Rent, wages and irrecoverable debts all sit below it, so they cut the net margin only. A rise in purchase prices is inside cost of sales, so it moves both.',
    },
    {
      id: 'F-8-39', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.2.3'],
      type: 'picklist',
      q: 'For each ratio, identify whether a HIGHER figure is better or worse.',
      picklist: {
        title: 'Reading the direction',
        rowHeader: 'Ratio', choiceHeader: 'A higher figure is',
        options: ['Better', 'Worse'],
        rows: [
          { text: 'Gross profit margin', answer: 0 },
          { text: 'Net profit margin', answer: 0 },
          ...
          { text: 'Return on capital employed', answer: 0 },
          { text: 'Cost of sales as a percentage of revenue', answer: 1 },
          { text: 'Wages as a percentage of revenue', answer: 1 },
        ],
      },
      exp: 'Profitability ratios put profit on top, so higher is better. An expense ratio puts a cost on top, so the direction reverses — and reading it the same way as the others is the commonest mistake in an interpretation question.',
    },
    {
      id: 'F-8-40', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.2.3', 'FAPS-8.2.2'],
      type: 'mcq',
      q: 'A business reports ROCE of 22% against an industry average of 14%. What is the most cautious reading?',
      opts: [
        'It may be performing well, or using older assets with low carrying amounts',
        'It is definitely more efficient than its competitors',
        'Its capital employed must have been miscalculated',
        'It should reduce its capital to raise the ratio further',
      ],
      ans: 0,
      exp: 'A small denominator raises a ratio as surely as a large numerator does. Heavily depreciated assets shrink capital employed and flatter ROCE, while a business that has just reinvested looks worse for having done the right thing.',
    },
    {
      id: 'F-8-41', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.2.4'],
      type: 'mcq',
      q: 'A set of ratios is produced from figures a client prepared. What does professional scepticism require first?',
      opts: [
        'Establishing that the underlying figures are reliable first',
        'Recalculating each of the ratios a second time to be sure',
        'Comparing them only against the same business\'s prior year',
        'Accepting them, since the client knows the business best',
      ],
      ans: 0,
      exp: 'A ratio inherits every weakness of the figures beneath it, and a confident percentage hides that completely. Checking the arithmetic proves only that the wrong inputs were divided correctly.',
    },
    {
      id: 'F-8-42', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.1.4', 'FAPS-8.1.2'],
      type: 'numeric',
      q: 'Sales revenue is £480,000 and the gross profit margin is 35%. What is the cost of sales, in pounds?',
      answer: 312000, unit: '£',
      exp: 'Gross profit = £480,000 × 35% = £168,000, so cost of sales = £480,000 − £168,000 = £312,000. Equivalently, cost is 65% of sales: £480,000 × 0.65 = £312,000.',
    },
    {
      id: 'F-9-30', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.1.1'],
      type: 'numeric',
      q: 'Opening capital was £72,000 and closing capital £91,500. The owner introduced £6,000 and took drawings of £24,800. What was the profit for the year, in pounds?',
      answer: 38300, unit: '£',
      exp: 'Profit = closing − opening − introduced + drawings = 91,500 − 72,000 − 6,000 + 24,800 = £38,300. The capital account is the bridge: everything that moved capital other than profit is stripped out, and what remains is profit.',
    },
    {
      id: 'F-9-31', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.1.1'],
      type: 'numeric',
      q: 'Opening payables were £19,400 and closing payables £23,100. Payments to suppliers during the year were £164,000. What were the credit purchases, in pounds?',
      answer: 167700, unit: '£',
      exp: '£164,000 + £23,100 − £19,400 = £167,700. Reconstructing the control account gives the missing side: what was paid, adjusted for the change in what is owed. Payables rising means purchases outran payments.',
    },
    {
      id: 'F-9-32', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.1.1'],
      type: 'numeric',
      q: 'Opening receivables were £34,600 and closing receivables £29,800. Cash received from customers was £238,000 and irrecoverable debts of £1,900 were written off. What were the credit sales, in pounds?',
      answer: 235100, unit: '£',
      exp: '£238,000 + £1,900 + £29,800 − £34,600 = £235,100. A write-off leaves the control account without any cash arriving, so it has to be added back alongside receipts to recover the sales figure.',
    },
    {
      id: 'F-9-33', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.2.1'],
      type: 'gapfill',
      q: 'Complete the distinction between the two percentages.',
      template: 'Mark-up is expressed as a percentage of {0}, whereas margin is expressed as a percentage of {1}. For the same transaction the {2} is always the larger percentage.',
      gaps: [
        { options: ['cost', 'sales revenue', 'gross profit'], answer: 0 },
        { options: ['sales revenue', 'cost', 'purchases'], answer: 0 },
        { options: ['mark-up', 'margin', 'gross profit'], answer: 0 },
      ],
      exp: 'Both describe the same gross profit; only the denominator changes. Cost is the smaller number, so dividing by it gives the larger percentage — which is why a 25% mark-up and a 25% margin are different businesses.',
    },
    {
      id: 'F-9-34', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.2.2'],
      type: 'numeric',
      q: 'Goods costing £96,000 are sold at a margin of 20%. What is the sales revenue, in pounds?',
      answer: 120000, unit: '£',
      exp: 'A 20% margin means cost is 80% of sales, so sales = £96,000 ÷ 0.80 = £120,000. Treating 20% as a mark-up would give £115,200 — the same words, a £4,800 difference.',
    },
    {
      id: 'F-9-35', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.2.2'],
      type: 'numeric',
      q: 'Sales were £312,000 at a mark-up of 30%. What was the cost of sales, in pounds?',
      answer: 240000, unit: '£',
      exp: 'Cost 100 plus mark-up 30 gives sales of 130, so cost = £312,000 × 100/130 = £240,000. Working back from sales on a mark-up always divides by 1 plus the rate, never multiplies by 1 minus it.',
    },
    {
      id: 'F-9-36', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.2.3'],
      type: 'numeric',
      q: 'Opening inventory was £24,500, purchases £186,000 and the business works to a margin of 25% on sales of £232,000. What was the closing inventory, in pounds?',
      answer: 36500, unit: '£',
      exp: 'Cost of sales = £232,000 × 75% = £174,000. Closing inventory = £24,500 + £186,000 − £174,000 = £36,500. The margin supplies the cost of sales figure, and the inventory equation then yields the missing end.',
    },
    {
      id: 'F-9-37', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.2.3'],
      type: 'numeric',
      q: 'Inventory was destroyed by fire. Opening inventory was £18,200, purchases to the date of the fire £104,000, and sales £140,000 at a mark-up of 40%. What was the cost of the inventory lost, in pounds?',
      answer: 22200, unit: '£',
      exp: 'Cost of sales = £140,000 × 100/140 = £100,000. Inventory that should be on hand = £18,200 + £104,000 − £100,000 = £22,200. With nothing salvaged, that is the loss — the standard use of a cost structure to value what cannot be counted.',
    },
    {
      id: 'F-9-38', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.3.1'],
      type: 'mcq',
      q: 'A reconstruction produces drawings of £61,000 for a sole trader whose profit was £34,000. What does that suggest?',
      opts: [
        'A figure is probably wrong, as the drawings outrun the earnings',
        'The business is highly profitable and the owner takes the benefit',
        'Drawings are capped at profit, so the figure must become £34,000',
        'Nothing at all, because drawings and profit are unrelated',
      ],
      ans: 0,
      exp: 'Drawings above profit are possible — the owner may be running capital down — but they are unusual enough to check rather than accept. Reasonableness is a prompt to look again, not a rule that forces the figure to change.',
    },
    {
      id: 'F-9-39', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.3.2'],
      type: 'truefalse',
      q: 'Identify whether each could explain a calculated cash balance differing from the cash actually counted.',
      statements: [
        { text: 'Takings were used to pay an expense before being banked.', answer: true },
        { text: 'The owner took cash from the till without recording drawings.', answer: true },
        { text: 'A customer paid by card rather than cash.', answer: true },
        { text: 'The bank charged interest on the overdraft.', answer: false },
      ],
      exp: 'Anything that moved cash without reaching the record explains a difference — expenses paid from takings, unrecorded drawings, or receipts assumed to be cash that were not. Bank interest never passes through the till, so it cannot move the cash figure.',
    },
    {
      id: 'F-9-40', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.3.3'],
      type: 'mcq',
      q: 'A business keeps its books in accounting software, and a reconstructed sales figure disagrees with the software\'s. What follows?',
      opts: [
        'Both are worth testing — software reproduces whatever was entered into it',
        'The software figure is right, because it comes from the system',
        'The reconstruction is right, because it was done independently',
        'The difference can be posted to suspense and left there',
      ],
      ans: 0,
      exp: 'Software guarantees arithmetic, not completeness: a sale never entered is missing however good the system. The reconstruction rests on its own assumptions. A disagreement says one of them is wrong, and which needs finding out rather than assuming.',
    },
    {
      id: 'F-9-41', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.3.4'],
      type: 'mcq',
      q: 'A trader explains a large unexplained cash shortfall as "extra drawings I forgot about". What does professional scepticism require?',
      opts: [
        'Seeking corroboration rather than accepting the explanation on its own',
        'Accepting it, as only the owner can know what they took',
        'Recording it as an irrecoverable debt',
        'Adjusting the sales figure until the cash agrees',
      ],
      ans: 0,
      exp: 'An explanation from the person it concerns is a representation, not evidence. It may be entirely true, and scepticism does not assume otherwise — it asks what would support it. Forcing sales to make the cash agree buries the question instead of answering it.',
    },
    {
      id: 'F-9-42', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.1.1'],
      type: 'numeric',
      q: 'A trader banked £198,000 of takings. Before banking, £11,400 of expenses were paid from takings and the owner took £15,600. Opening cash in hand was £700 and closing cash in hand £900. What were the total takings, in pounds?',
      answer: 225200, unit: '£',
      exp: '£198,000 banked + £11,400 expenses + £15,600 drawings + £900 closing − £700 opening = £225,200. Everything paid out of takings before banking has to be added back, and the change in cash in hand adjusts for what was held rather than spent.',
    },
    ...
    },
    {
      ...
      exp: 'The whole £1,860 comes out of receivables, so the control account is credited with the gross. The debt is over six months past due, so the VAT of £1,860 ÷ 6 = £310 can be reclaimed. That debits the VAT control account, leaving the net £1,550 as the real cost to the business.',
    },
    {
      ...
      ans: 0,
      exp: 'Integrity and objectivity require the figure to be the one the evidence supports, and IAS 2 fixes what that figure is. Pressure from a period end or a covenant is exactly what the ethical principles exist for. A valuation chosen to reach a target is a misstatement, disclosed or not.',
    },
    {
    ...
    /* ── Depth pass: concepts that had fewer than three questions ─────────
       Forty-five FAPS concepts sat at one or two questions, far more than any
       other Level 3 unit, and they clustered in period end adjustments and in
       partnership statements \u2014 the two places this unit is hardest. The count
       that matters to a reader meeting a concept is the count per CONCEPT,
       and every outcome here was at forty. */
    {
      id: 'F-2-93', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.1.1'],
      type: 'numeric',
      q: 'A sole trader has assets of \u00a384,500 and liabilities of \u00a331,200. Opening capital was \u00a348,700, the owner introduced \u00a36,000 and drew \u00a319,400. What is the profit for the year, in pounds?',
      answer: 18000, unit: '\u00a3',
      exp: 'The equation is what lets a profit be found with no profit and loss account at all. Closing capital is assets less liabilities: \u00a384,500 \u2212 \u00a331,200 = \u00a353,300. Everything other than profit moved capital by \u00a348,700 + \u00a36,000 \u2212 \u00a319,400 = \u00a335,300. Profit is what is left over: \u00a353,300 \u2212 \u00a335,300 = \u00a318,000. That is the incomplete records method in three lines.',
    },
    {
      id: 'F-2-94', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.3.7'],
      type: 'numeric',
      q: 'A payables ledger control account opens with a credit balance of \u00a328,400. Credit purchases are \u00a396,700, payments to suppliers \u00a391,300 and credit notes received \u00a32,800. What is the closing balance, in pounds?',
      answer: 31000, unit: '\u00a3',
      exp: 'A payables balance rises with purchases and falls with anything that settles or cancels it. Payments settle: \u00a328,400 + \u00a396,700 = \u00a3125,100, then \u00a3125,100 \u2212 \u00a391,300 = \u00a333,800. A CREDIT NOTE cancels, cutting what is owed exactly as a payment does: \u00a333,800 \u2212 \u00a32,800 = \u00a331,000. It carries down as a credit because the business still owes it, and a closing debit would mean a supplier had been overpaid.',
    },
    {
      id: 'F-2-95', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.4.2'],
      type: 'mcq',
      q: 'Accounting software runs the period end routine automatically. What still has to be decided by a person?',
      opts: [
        'The judgements behind the adjustments \u2014 what to accrue, and how much',
        'The nominal codes that the closing entries are posted to',
        'Whether the ledgers still balance once the routine has run',
        'The date on which the accounting period is treated as ending',
      ],
      ans: 0,
      exp: 'Software closes the period, carries the balances forward and stops anything further being posted into it. What it cannot do is notice that a supply used in March was never invoiced, or decide how much of a debt will go bad. Codes, arithmetic and period dates are set up once and then repeat; the judgements arrive fresh every period.',
    },
    {
      id: 'F-2-96', unitKey: 'faps', lo: 2, criteria: ['FAPS-2.4.3'],
      type: 'truefalse',
      q: 'A payables ledger control account is reconciled to the total of the supplier accounts. Identify whether each statement is correct.',
      statements: [
        { text: 'Agreement shows the two records hold the same total.', answer: true },
        { text: 'A difference may be caused by a posting made to only one of them.', answer: true },
        { text: 'Agreement proves no invoice has been omitted from both.', answer: false },
        { text: 'A difference is always an error in the control account.', answer: false },
      ],
      exp: 'A reconciliation compares two records of the same thing, so it catches whatever reached one and not the other. What it cannot catch is anything missing from both \u2014 an invoice never entered anywhere agrees perfectly, which is the blind spot every control account has. And where the two differ, the error is as likely to sit in the individual accounts as in the control.',
    },
    {
      id: 'F-3-43', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.2.1'],
      type: 'mcq',
      q: 'What does the standard on property, plant and equipment require of the depreciation method chosen?',
      opts: [
        'That it reflects how the asset\u2019s benefits are actually consumed',
        'That it is the same for every class of asset the business holds',
        'That it is straight line unless the tax rules require otherwise',
        'That it is reviewed only when the asset is finally disposed of',
      ],
      ans: 0,
      exp: 'The method has to match the economic reality. An asset used evenly depreciates evenly; one that gives up most of its value early suits reducing balance. That is exactly why different classes can and should use different methods. Both the method and the useful life are reviewed at least annually rather than left until disposal, and tax rules never drive the accounts.',
    },
    {
      id: 'F-3-44', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.2.4'],
      type: 'truefalse',
      q: 'A machine is bought and installed. Identify whether each cost belongs in the capitalised value.',
      statements: [
        { text: 'The delivery charge for bringing the machine to site.', answer: true },
        { text: 'The cost of the foundations built to receive it.', answer: true },
        { text: 'The annual maintenance contract taken out on delivery.', answer: false },
        { text: 'Training the operators to use the new machine.', answer: false },
      ],
      exp: 'Capitalise what is needed to get the asset to its location and into working condition: delivery, installation, foundations, professional fees on the purchase. Maintenance keeps it working after it already works, and training develops the people rather than the machine. Both are revenue expenditure and belong in this year\u2019s statement of profit or loss.',
    },
    {
      id: 'F-3-45', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.2.5'],
      type: 'mcq',
      q: 'Why does a business set a capitalisation policy with a monetary limit?',
      opts: [
        'Tracking small long-lived items costs more than the accuracy gained',
        'Accounting standards set the limit that a business has to apply',
        'Items below the limit have no useful life beyond a single year',
        'HMRC refuses capital allowances on anything below a set amount',
      ],
      ans: 0,
      exp: 'A \u00a340 stapler may last ten years, and nobody wants it on the asset register for ten years. The limit is a materiality judgement made once and then applied consistently: below it, expense the item and move on. No standard sets the figure and no tax rule requires one. The items below the line have not stopped being long-lived \u2014 they have stopped being worth the trouble.',
    },
    {
      id: 'F-3-46', unitKey: 'faps', lo: 3, criteria: ['FAPS-3.3.4'],
      type: 'mcq',
      q: 'A non-current asset register is kept on a spreadsheet alongside the accounting software. What should be reconciled, and to what?',
      opts: [
        'Register totals to the general ledger cost and depreciation accounts',
        'Register totals to the physical assets counted at the year end only',
        'Register entries to the purchase invoices, and to nothing else',
        'Nothing \u2014 a register held outside the software cannot be reconciled',
      ],
      ans: 0,
      exp: 'The register is a second record of the same assets, so it is reconciled to the ledger exactly as a sales ledger is reconciled to its control account. Both directions matter: an asset in the register and not the ledger is as much a difference as the reverse. A physical inspection is also worth doing, but it is a separate exercise and does not replace this one.',
    },
    {
      id: 'F-6-93', unitKey: 'faps', lo: 6, criteria: ['FAPS-6.1.1'],
      type: 'mcq',
      q: 'A disposals account is left with a CREDIT balance after an asset has been sold. What does that mean?',
      opts: [
        'The asset sold for more than its carrying amount \u2014 a profit',
        'The asset sold for less than its carrying amount \u2014 a loss',
        'The asset has not yet been removed from the asset register',
        'Accumulated depreciation was transferred to the wrong side',
      ],
      ans: 0,
      exp: 'The disposals account collects the carrying amount on the debit side and the proceeds on the credit side, so a credit balance means the proceeds won. That balance goes to the statement of profit or loss as a profit on disposal. The same account gives a debit balance and a loss when the asset sells for less, which is what puts it among the accounts that go either way.',
    },
    {
      id: 'F-6-94', unitKey: 'faps', lo: 6, criteria: ['FAPS-6.1.2'],
      type: 'mcq',
      q: 'A trial balance is extracted and the debits exceed the credits by \u00a3450. What does that establish?',
      opts: [
        'That at least one error exists, with a net one-sided effect of \u00a3450',
        'That exactly one error exists, and that it is an entry of \u00a3450',
        'That an entry of \u00a3225 has been posted to the wrong side',
        'That a transposition has been made somewhere in the ledger',
      ],
      ans: 0,
      exp: 'A difference proves that something is wrong and says how much on a NET basis. It does not say how many errors there are or how large: two can partly cancel, and a single \u00a3225 posted to the wrong side opens a gap of \u00a3450 on its own. A difference divisible by nine hints at a transposition, and \u00a3450 is divisible by nine and by a good deal else.',
    },
    {
      id: 'F-6-95', unitKey: 'faps', lo: 6, criteria: ['FAPS-6.1.3'],
      type: 'mcq',
      q: 'A purchase of stationery is debited to the drawings account instead of the stationery account. Which error is this, and will the trial balance reveal it?',
      opts: [
        'An error of principle \u2014 no, the trial balance still agrees',
        'An error of commission \u2014 no, the trial balance still agrees',
        'An error of original entry \u2014 yes, the totals will differ',
        'A reversal of entries \u2014 yes, the totals will differ',
      ],
      ans: 0,
      exp: 'Both accounts take a debit, so the trial balance balances and tells you nothing. It is a principle error rather than a commission error because drawings and expenses are different KINDS of account. Commission means the wrong account of the right kind, such as the wrong customer in the sales ledger. Here profit is understated and drawings overstated by the same amount.',
    },
    {
      id: 'F-6-96', unitKey: 'faps', lo: 6, criteria: ['FAPS-6.1.4'],
      type: 'mcq',
      q: 'Accounting software produces the trial balance directly from the ledgers. Which type of error does that eliminate?',
      opts: [
        'A transfer error, such as a balance copied across incorrectly',
        'An error of principle, such as a cost in the wrong kind of account',
        'An error of omission, such as an invoice never entered at all',
        'A compensating error, where two mistakes cancel one another out',
      ],
      ans: 0,
      exp: 'Software removes the copying step, so the figure in the trial balance IS the figure in the ledger by construction. Every other error listed happens earlier, at the moment of entry, and a faultless transfer of a wrong figure is still a wrong figure. A software trial balance that agrees proves the arithmetic and nothing at all about the bookkeeping.',
    },
    {
      id: 'F-6-97', unitKey: 'faps', lo: 6, criteria: ['FAPS-6.2.1'],
      type: 'mcq',
      q: 'A journal is posted and the software immediately restates every affected balance. What does that change about how the work is checked?',
      opts: [
        'The check moves to the journal, the effect no longer showing as a step',
        'No check is needed, since the software does the arithmetic correctly',
        'The trial balance must be re-extracted by hand to confirm the change',
        'The journal must be reversed and re-posted to prove that it worked',
      ],
      ans: 0,
      exp: 'On paper an adjustment left a visible trail: the entry, the changed balance, the restated total, each one a place to look. Software collapses all of that into a single instant, so the only thing left to check is whether the journal was right BEFORE it was posted. The arithmetic is reliable; the judgement that produced it is what still needs a reviewer.',
    },
    {
      id: 'F-6-98', unitKey: 'faps', lo: 6, criteria: ['FAPS-6.3.1'],
      type: 'mcq',
      q: 'Why is the extended trial balance prepared before the financial statements rather than after them?',
      opts: [
        'It is where adjustments are made and proved before anything is presented',
        'Accounting standards require it as a statement in its own right',
        'It removes the need to prepare a statement of profit or loss',
        'It is the only document HMRC will accept with a tax return',
      ],
      ans: 0,
      exp: 'The extended trial balance is a working paper and never a published one. Its job is to take the initial balances, apply every period end adjustment in a visible column, and cross-cast so the two halves still agree. Only then are the figures split between the two statements. The other order means adjusting accounts that have already been written out.',
    },
    {
      id: 'F-6-99', unitKey: 'faps', lo: 6, criteria: ['FAPS-6.3.1'],
      type: 'truefalse',
      q: 'Identify whether each statement about the extended trial balance is correct.',
      statements: [
        { text: 'Each adjustment appears in its own column, not in the ledger balance.', answer: true },
        { text: 'The adjustment columns must themselves show equal debits and credits.', answer: true },
        { text: 'An extended figure appears in both the profit or loss and position columns.', answer: false },
        { text: 'It is filed with the accounts as part of the published statements.', answer: false },
      ],
      exp: 'The adjustment columns are the point of the exercise: they keep the original balance and the change side by side, so a reviewer can see what was done and why. Those columns balance among themselves, because every adjustment is a double entry. Each extended figure then goes to exactly ONE of the two statements, and the sheet itself stays in the working papers.',
    },
    {
      id: 'F-8-43', unitKey: 'faps', lo: 8, criteria: ['FAPS-8.1.3'],
      type: 'mcq',
      q: 'Gross profit margin is unchanged year on year but operating profit margin has fallen. What does that point to?',
      opts: [
        'Overheads that have risen faster than sales',
        'A cost of sales that has risen faster than sales',
        'Selling prices that have been cut across the range',
        'Inventory that has been valued on a different basis',
      ],
      ans: 0,
      exp: 'The two margins differ by exactly one thing: the operating costs that sit between them. A steady gross margin says buying and selling prices moved together, so the damage is below that line \u2014 administrative and distribution costs growing faster than the revenue supporting them. A price cut or a cost of sales rise would both have shown in the GROSS margin first.',
    },
    {
      id: 'F-9-43', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.3.3'],
      type: 'mcq',
      q: 'Which check would reveal that a sales invoice was entered into the software at \u00a34,500 when the invoice itself says \u00a35,400?',
      opts: [
        'Comparing a sample of postings back to the source documents',
        'Re-running the trial balance to confirm that it still agrees',
        'Confirming that the software applied VAT at the correct rate',
        'Checking that the invoice number sequence contains no gaps',
      ],
      ans: 0,
      exp: 'A transposition entered as a complete double entry balances perfectly, so the trial balance, the VAT calculation and the number sequence all pass it without complaint. The only thing that catches it is going back to the paper: what does the invoice actually say, and does the ledger say the same. Checking software output means checking it against something outside the software.',
    },
    {
      id: 'F-9-44', unitKey: 'faps', lo: 9, criteria: ['FAPS-9.3.4'],
      type: 'mcq',
      q: 'In reconstructing incomplete records, which figure most needs professional scepticism applied to it?',
      opts: [
        'The one the owner supplied from memory rather than from a document',
        'The one taken directly from the bank statements for the year',
        'The one calculated from the opening and closing capital figures',
        'The one supported by a supplier statement received in the post',
      ],
      ans: 0,
      exp: 'Scepticism is spent where the evidence is weakest, and a figure recalled by the person whose profit it is carries two problems at once: memory, and an interest in the answer. Bank and supplier statements come from third parties, and a derived figure can be checked by redoing the arithmetic. Ask for the document, or test the recalled figure against one.',
    },

    /* ── Depth pass, period end adjustments ───────────────────────────────
       Eighteen of the forty-five thin FAPS concepts were in this outcome
       alone. It is where judgement enters the accounts, so it is also where
       a reader who has seen only one question on a concept is most exposed. */
    {
      id: 'F-5-92', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.1'],
      type: 'mcq',
      q: 'A business pays its insurance a year ahead. Which principle requires part of that payment to be carried forward at the year end?',
      opts: [
        'Accruals \u2014 cost belongs to the period that gets the benefit',
        'Prudence \u2014 a cost is recognised as early as it can be',
        'Consistency \u2014 the same treatment is applied every year',
        'Going concern \u2014 the business will still be trading next year',
      ],
      ans: 0,
      exp: 'Accruals matches a cost to the period that consumed it, not to the period that paid for it. Eleven months of cover bought and not yet used is an asset at the year end, and it becomes an expense as the cover is taken. Prudence would push the whole cost into this year, which is the opposite of what matching requires.',
    },
    {
      id: 'F-5-93', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.3'],
      type: 'numeric',
      q: 'An electricity account has an opening ACCRUAL brought down of \u00a3900. Payments during the year total \u00a314,600 and \u00a31,250 is accrued at the year end. What is the charge to profit or loss, in pounds?',
      answer: 14950, unit: '\u00a3',
      exp: 'Reverse the opening accrual, because that cost belonged to last year and was charged there: \u00a314,600 \u2212 \u00a3900 = \u00a313,700. Then add this year\u2019s closing accrual, which is cost used and not yet paid: \u00a313,700 + \u00a31,250 = \u00a314,950. Forgetting the reversal charges the \u00a3900 twice, which is the commonest slip in this calculation.',
    },
    {
      id: 'F-5-94', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.5'],
      type: 'mcq',
      q: 'Accounting software is set up to post a recurring monthly accrual automatically. What is the risk that creates?',
      opts: [
        'It keeps posting the old amount after the underlying cost changes',
        'It posts the entry to the wrong side of the ledger each month',
        'It prevents the accrual from being reversed in the next period',
        'It stops the trial balance agreeing while the entry is in place',
      ],
      ans: 0,
      exp: 'A recurring entry is right until the world changes and then wrong every month without complaint. A rent rise, a contract ending, a supplier changing terms \u2014 none of these reaches the schedule on its own. The entry is correct double entry and reverses properly, so nothing in the ledger looks wrong. Somebody has to review the schedule against reality.',
    },
    {
      id: 'F-5-95', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.5', 'FAPS-5.3.6'],
      type: 'mcq',
      q: 'What do automated accrual schedules and automated inventory valuation have in common as a risk?',
      opts: [
        'Both run on assumptions set once, and neither questions them again',
        'Both require a manual journal before the period can be closed',
        'Both are prohibited where financial statements are published',
        'Both leave the ledgers out of balance until they are reviewed',
      ],
      ans: 0,
      exp: 'Automation is reliable at repeating a decision and incapable of revisiting it. A monthly accrual keeps the amount it was given; a valuation routine keeps the costing basis it was set to use. Both produce clean, balanced, plausible figures from a premise nobody has checked since setup. The work moves from doing the calculation to auditing the assumption.',
    },
    {
      id: 'F-5-96', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.7'],
      type: 'mcq',
      q: 'At the year end \u00a32,400 of gas has been used and not yet billed. What is the journal entry?',
      opts: [
        'Debit gas expense \u00a32,400, credit accruals \u00a32,400',
        'Debit accruals \u00a32,400, credit gas expense \u00a32,400',
        'Debit gas expense \u00a32,400, credit prepayments \u00a32,400',
        'Debit prepayments \u00a32,400, credit gas expense \u00a32,400',
      ],
      ans: 0,
      exp: 'An accrual adds a cost the business has had and adds the liability that goes with it: more expense on the debit side, more owed on the credit side. A PREPAYMENT does the reverse and creates an asset, so the two must not be confused. Next period the entry is reversed, which is what stops the same gas being charged twice.',
    },
    {
      id: 'F-5-97', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.1.7'],
      type: 'numeric',
      q: 'A rates account shows payments of \u00a39,600 in the year. \u00a3800 was accrued at the start and \u00a3600 is prepaid at the end. What is the charge to profit or loss, in pounds?',
      answer: 8200, unit: '\u00a3',
      exp: 'Two adjustments in opposite directions, and each has to be taken in turn. Reverse the opening accrual, which belonged to last year: \u00a39,600 \u2212 \u00a3800 = \u00a38,800. Then take out the closing prepayment, which belongs to next year: \u00a38,800 \u2212 \u00a3600 = \u00a38,200. Both movements reduce this year\u2019s charge, which is why the answer is well below the cash paid.',
    },
    {
      id: 'F-5-98', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.2.1'],
      type: 'mcq',
      q: 'Why is an allowance for doubtful receivables an application of the accruals principle rather than of prudence alone?',
      opts: [
        'The cost of a bad debt belongs to the period that made the sale',
        'It ensures profit is stated at the lowest defensible figure',
        'It removes the debt from the ledger as soon as doubt arises',
        'It matches the allowance to the cash actually received later',
      ],
      ans: 0,
      exp: 'A sale and the risk that it will not be collected are two halves of the same event, so both belong in the period the sale was made. Waiting until the debt finally fails would put the income in one year and its cost in another. Prudence supports the same answer, but it is matching that requires it \u2014 and the debt stays in the ledger throughout.',
    },
    {
      id: 'F-5-99', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.2.5'],
      type: 'mcq',
      q: 'The allowance for doubtful receivables is to be increased from \u00a34,100 to \u00a35,300. What is the journal?',
      opts: [
        'Debit irrecoverable debts \u00a31,200, credit the allowance \u00a31,200',
        'Debit irrecoverable debts \u00a35,300, credit the allowance \u00a35,300',
        'Debit the allowance \u00a31,200, credit irrecoverable debts \u00a31,200',
        'Debit trade receivables \u00a31,200, credit the allowance \u00a31,200',
      ],
      ans: 0,
      exp: 'Only the MOVEMENT is journalled, because the allowance is a standing balance that is adjusted rather than rebuilt: \u00a35,300 \u2212 \u00a34,100 = \u00a31,200. Posting the whole \u00a35,300 would charge this year with an allowance most of which was made last year. A DECREASE reverses the entry and credits profit or loss, and trade receivables are never touched by an allowance.',
    },
    {
      id: 'F-5-100', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.2.5'],
      type: 'mcq',
      q: 'A customer who owes \u00a31,800 has gone into liquidation with no prospect of payment. What is the journal?',
      opts: [
        'Debit irrecoverable debts \u00a31,800, credit trade receivables \u00a31,800',
        'Debit the allowance \u00a31,800, credit trade receivables \u00a31,800',
        'Debit irrecoverable debts \u00a31,800, credit the allowance \u00a31,800',
        'Debit trade receivables \u00a31,800, credit irrecoverable debts \u00a31,800',
      ],
      ans: 0,
      exp: 'A write-off and an allowance are different entries for different situations. This debt is known to have failed, so the receivable itself goes: expense on the debit, receivable removed on the credit. An ALLOWANCE is for debts that MIGHT fail, and it never touches the receivables balance \u2014 which is why the second and third options both belong to that other case.',
    },
    {
      id: 'F-5-101', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.1'],
      type: 'mcq',
      q: 'Goods bought this year and still unsold at the year end are carried forward as closing inventory. Which period bears their cost?',
      opts: [
        'The period in which they are eventually sold',
        'The period in which they were bought and paid for',
        'The two periods in equal proportions between them',
        'Neither \u2014 the cost is capitalised and never expensed',
      ],
      ans: 0,
      exp: 'Carrying inventory forward is the accruals principle doing its plainest work: the cost waits in the statement of financial position until the revenue it earns arrives. That is why closing inventory reduces cost of sales this year and opening inventory increases it next year. The cost is not lost and it is not split \u2014 it is deferred until the sale.',
    },
    {
      id: 'F-5-102', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.2'],
      type: 'numeric',
      q: 'Closing inventory was valued at \u00a342,000. A review finds one line valued at cost \u00a37,500 has a net realisable value of \u00a34,900. What is the corrected profit if it was \u00a368,000 before, in pounds?',
      answer: 65400, unit: '\u00a3',
      exp: 'Writing inventory down reduces closing inventory, which raises cost of sales, which reduces profit \u2014 all by the same amount. The write-down is \u00a37,500 \u2212 \u00a34,900 = \u00a32,600. So profit becomes \u00a368,000 \u2212 \u00a32,600 = \u00a365,400, and closing inventory becomes \u00a339,400. Every inventory change moves profit one for one, in the same direction.',
    },
    {
      id: 'F-5-103', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.3'],
      type: 'mcq',
      q: 'What does the inventory standard require where cost and net realisable value differ?',
      opts: [
        'The lower of the two, taken line by line rather than in total',
        'The lower of the two, taken across the inventory as a whole',
        'Cost in every case, net realisable value being an estimate',
        'Net realisable value in every case, as the more prudent figure',
      ],
      ans: 0,
      exp: 'Lower of cost and NRV, and the LINE BY LINE part is what the assessment tests. Comparing totals lets a line carried above its realisable value hide behind another line worth more than cost, which is exactly the offsetting the rule exists to prevent. Applied properly, a write-down on one line stands whatever the rest of the inventory is worth.',
    },
    {
      id: 'F-5-104', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.3'],
      type: 'truefalse',
      q: 'Identify whether each statement about the inventory standard is correct.',
      statements: [
        { text: 'Net realisable value is selling price less the costs to complete and sell.', answer: true },
        { text: 'The comparison with cost is made for each line of inventory.', answer: true },
        { text: 'Inventory may be carried at expected selling price where a sale is certain.', answer: false },
        { text: 'A write-down may be offset against a line worth more than its cost.', answer: false },
      ],
      exp: 'NRV is what the goods will actually fetch, net of getting them sold, so it is never simply the selling price. The comparison runs line by line, and a line above cost is carried at COST \u2014 unrealised profit is never taken. That is also why an uplift on one line cannot pay for a write-down on another: only the downward adjustment is recognised.',
    },
    {
      id: 'F-5-105', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.4'],
      type: 'numeric',
      q: 'Inventory has two lines. P: 200 units at cost \u00a314, expected to sell at \u00a318 with \u00a35 of selling costs. Q: 150 units at cost \u00a39, expected to sell at \u00a316 with \u00a32 of selling costs. What is the total valuation, in pounds?',
      answer: 3950, unit: '\u00a3',
      exp: 'Work out NRV before comparing anything. P: \u00a318 \u2212 \u00a35 = \u00a313, below its cost of \u00a314, so P is valued at \u00a313 \u00d7 200 = \u00a32,600. Q: \u00a316 \u2212 \u00a32 = \u00a314, above its cost of \u00a39, so Q is valued at cost: \u00a39 \u00d7 150 = \u00a31,350. The total is \u00a32,600 + \u00a31,350 = \u00a33,950. A line worth MORE than cost is never written up.',
    },
    {
      id: 'F-5-106', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.5'],
      type: 'mcq',
      q: 'Which of these forms part of the cost of inventory?',
      opts: [
        'Carriage inwards paid to bring the goods to the warehouse',
        'Carriage outwards paid to deliver the goods to a customer',
        'Storage costs incurred while the goods await a buyer',
        'The salary of the sales staff who will eventually sell them',
      ],
      ans: 0,
      exp: 'Cost of inventory is what it took to get the goods to their present location and condition, which is why carriage INWARDS is in and carriage OUTWARDS is out. Storage after arrival, selling costs and general administration are all period expenses: they attach to the passage of time or to the act of selling, not to the goods.',
    },
    {
      id: 'F-5-107', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.6'],
      type: 'mcq',
      q: 'Inventory software values stock continuously as goods move in and out. What does a business still have to do at the year end?',
      opts: [
        'Count the goods, and investigate where the count and the system differ',
        'Re-enter every movement so the software can recalculate the total',
        'Switch the valuation basis from cost to net realisable value',
        'Nothing further, a perpetual system being complete by design',
      ],
      ans: 0,
      exp: 'A perpetual system records what it was TOLD moved. Theft, breakage, miscounts at delivery and unrecorded returns all leave the figure intact and wrong. The physical count is the one check that comes from outside the system, and the differences it throws up are the interesting part: each one is a process that is not working.',
    },
    {
      id: 'F-5-108', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.7'],
      type: 'numeric',
      q: 'A count on 4 January values inventory at \u00a358,200. Between the 31 December year end and the count, goods costing \u00a34,700 were received and goods costing \u00a33,100 were sold. What was inventory at the year end, in pounds?',
      answer: 56600, unit: '\u00a3',
      exp: 'Work backwards from the count to the year end, reversing what happened in between. Goods received after the year end were not there, so take them out: \u00a358,200 \u2212 \u00a34,700 = \u00a353,500. Goods sold after the year end were still there, so add them back: \u00a353,500 + \u00a33,100 = \u00a356,600. Running the adjustments the wrong way is the trap in every version of this question.',
    },
    {
      id: 'F-5-109', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.3.8'],
      type: 'mcq',
      q: 'Closing inventory of \u00a331,700 is to be recorded. What is the journal entry?',
      opts: [
        'Debit inventory (asset) \u00a331,700, credit cost of sales \u00a331,700',
        'Debit cost of sales \u00a331,700, credit inventory (asset) \u00a331,700',
        'Debit inventory (asset) \u00a331,700, credit purchases \u00a331,700',
        'Debit purchases \u00a331,700, credit inventory (asset) \u00a331,700',
      ],
      ans: 0,
      exp: 'Closing inventory creates an asset and takes the same amount out of cost of sales, which is what leaves only the cost of goods actually sold in the charge for the year. The OPENING inventory journal is the mirror image: the asset goes, cost of sales rises. Purchases are never touched by either \u2014 they stay exactly as recorded during the year.',
    },
    {
      id: 'F-5-110', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.4.1'],
      type: 'truefalse',
      q: 'Identify whether each statement about making period end adjustments is correct.',
      statements: [
        { text: 'Each adjustment should be supported by a calculation that can be followed.', answer: true },
        { text: 'The basis used should be the same as last year unless there is a reason.', answer: true },
        { text: 'An adjustment may be set at whatever figure brings profit to target.', answer: false },
        { text: 'An estimate need not be documented, being an estimate rather than a fact.', answer: false },
      ],
      exp: 'An estimate is not a guess, and the difference is the working behind it. Anyone reviewing has to be able to see what was assumed and why that assumption is reasonable. Consistency of basis is what makes one year comparable with the next, and a change of basis is legitimate only when the circumstances changed \u2014 not when the answer was unwelcome.',
    },
    {
      id: 'F-5-111', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.4.2'],
      type: 'mcq',
      q: 'A manager says the usual inventory write-down is unnecessary this year because "trade will pick up". What does professional scepticism require?',
      opts: [
        'Evidence for the claim \u2014 recent sales, orders, or a firm enquiry',
        'Accepting it, the manager being closer to the market than finance',
        'Making the write-down anyway, since managers cannot be relied upon',
        'Referring the matter straight to the business\u2019s external auditors',
      ],
      ans: 0,
      exp: 'Scepticism sits between two failures and is neither of them. Accepting an assertion because of who made it is credulity; rejecting it because of who made it is cynicism, and both skip the work. The claim may well be true, and the way to find out is to ask what it rests on. Escalation comes later, and only if the answer is nothing.',
    },
    {
      id: 'F-5-112', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.4.2'],
      type: 'mcq',
      q: 'Which period end figure is MOST exposed to a loss of objectivity, and why?',
      opts: [
        'The allowance for doubtful receivables, being a judgement with a wide range',
        'The depreciation charge, being fixed by the method chosen years ago',
        'The closing bank balance, being confirmed by a third-party statement',
        'The wages accrual, being calculable from the payroll to the penny',
      ],
      ans: 0,
      exp: 'Objectivity is under most pressure where the right answer is a range rather than a number. An allowance can be defended anywhere across a wide band, so the figure chosen says as much about the pressure on the preparer as about the debtors. A bank balance is confirmed externally and a wages accrual is arithmetic \u2014 neither leaves much room to move.',
    },
    {
      id: 'F-5-113', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.4.3'],
      type: 'mcq',
      q: 'An inventory valuation is knowingly overstated so the year meets a bank covenant. What happens in the FOLLOWING year?',
      opts: [
        'Opening inventory is overstated, so next year\u2019s profit is understated',
        'Nothing \u2014 the misstatement is confined to the year it was made in',
        'The overstatement repeats automatically unless it is journalled out',
        'Next year\u2019s profit is overstated too, the error compounding itself',
      ],
      ans: 0,
      exp: 'Closing inventory becomes opening inventory, so an overstatement borrows profit from next year rather than creating it. The covenant is met once and the shortfall arrives twelve months later, usually larger. That reversal is what makes this kind of manipulation so visible in hindsight, and it is on top of the regulatory and reputational consequences.',
    },
    {
      id: 'F-5-114', unitKey: 'faps', lo: 5, criteria: ['FAPS-5.4.4'],
      type: 'mcq',
      q: 'A year end must close two weeks early and there is no time to review the estimates properly. What is the right response?',
      opts: [
        'Say what has not been reviewed, and what that means for the figures',
        'Use last year\u2019s figures unchanged, as the least risky available basis',
        'Complete the work to the deadline and raise the shortcut afterwards',
        'Refuse to produce any figures at all until the deadline is extended',
      ],
      ans: 0,
      exp: 'Pressure at the period end is normal and is not by itself an ethical problem. It becomes one when unreviewed figures go out looking like reviewed ones. Naming the limitation lets whoever relies on the accounts decide what to do about it, which is the whole point. Silence now and an explanation later is the option that does the damage.',
    },

    /* ── Depth pass, partnership statements ───────────────────────────────
       Ten concepts in this outcome held one or two questions, and six of the
       ten were about the partners\u2019 own accounts \u2014 which is the part of the
       unit that differs from everything taught before it, and therefore the
       part a reader has the least prior knowledge to fall back on. */
    {
      id: 'F-7-58', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.1.1'],
      type: 'mcq',
      q: 'What question does the statement of profit or loss answer that the statement of financial position cannot?',
      opts: [
        'How the business performed across a period of time',
        'What the business is worth on one particular day',
        'How much cash the business holds at the year end',
        'Who has a claim on the assets the business holds',
      ],
      ans: 0,
      exp: 'One is a film and the other a photograph. The statement of profit or loss covers a period and reports performance: income earned, costs incurred, profit made. The statement of financial position covers a single instant and reports position. The other three options are all answered by that second statement, which is what makes them the distractors here.',
    },
    {
      id: 'F-7-59', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.1.3'],
      type: 'mcq',
      q: 'A business makes a profit and the owner takes no drawings. What does the accounting equation say must happen?',
      opts: [
        'Net assets rise by the amount of the profit',
        'Liabilities fall by the amount of the profit',
        'Assets and liabilities both rise by the profit',
        'Capital introduced rises by the amount of profit',
      ],
      ans: 0,
      exp: 'Capital equals assets less liabilities, and profit increases capital. With nothing drawn and nothing introduced, the whole profit lands in capital, so net assets must rise by exactly that amount. The identity is what lets a set of accounts be checked: a profit that does not appear in the movement on net assets has gone somewhere it should not.',
    },
    {
      id: 'F-7-60', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.1.4'],
      type: 'mcq',
      q: 'Closing inventory appears in both financial statements. In what role does it appear in each?',
      opts: [
        'A deduction from cost of sales in one, a current asset in the other',
        'A current asset in one, and again as a current asset in the other',
        'An expense in one, and a deduction from capital in the other',
        'Income in one, and a non-current asset held in the other',
      ],
      ans: 0,
      exp: 'The same figure does two jobs because it stands for one thing: goods bought and not yet sold. In the statement of profit or loss it comes out of cost of sales, so only goods actually sold are charged. In the statement of financial position it is a current asset, since the business still holds it. That is a link between the two, not a duplication.',
    },
    {
      id: 'F-7-61', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.3.1'],
      type: 'mcq',
      q: 'In a partnership, where does a partner\u2019s salary appear?',
      opts: [
        'In the appropriation account, as a division of profit already made',
        'In the statement of profit or loss, as an expense of the business',
        'In the statement of financial position, as a liability at the year end',
        'In neither statement, being drawings taken during the year',
      ],
      ans: 0,
      exp: 'A partner is an owner and not an employee, so a partner\u2019s salary is not a cost of running the business. It is one of the ways the profit is SHARED OUT, and the appropriation account is where that sharing is set out. Treating it as an expense understates the profit and then divides the wrong figure between the partners.',
    },
    {
      id: 'F-7-62', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.3.3'],
      type: 'mcq',
      q: 'Which figure passes from the statement of profit or loss into the appropriation account?',
      opts: [
        'Profit for the year, before any appropriation has been made',
        'Gross profit, before the operating expenses are deducted',
        'Profit after each partner\u2019s salary has been deducted from it',
        'Each partner\u2019s share, already divided between the partners',
      ],
      ans: 0,
      exp: 'The statement of profit or loss is prepared exactly as it would be for a sole trader, and it stops at profit for the year. That single figure is the opening line of the appropriation account, which then adds interest on drawings, allocates salaries and interest on capital, and divides what is left. Nothing about the partners reaches the statement itself.',
    },
    {
      id: 'F-7-63', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.3.3'],
      type: 'numeric',
      q: 'A partnership\u2019s profit for the year is \u00a381,000. Partners\u2019 salaries total \u00a326,000, interest on capital totals \u00a34,500 and interest on drawings totals \u00a31,900. What is the residual profit to be shared, in pounds?',
      answer: 52400, unit: '\u00a3',
      exp: 'Interest on DRAWINGS is charged to the partners, so it comes back into the pot rather than out of it: \u00a381,000 + \u00a31,900 = \u00a382,900. Salaries and interest on capital are then allocated out: \u00a382,900 \u2212 \u00a326,000 = \u00a356,900, then \u00a356,900 \u2212 \u00a34,500 = \u00a352,400. That residue is what the profit-sharing ratio divides.',
    },
    {
      id: 'F-7-64', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.3.6'],
      type: 'truefalse',
      q: 'Identify whether each item appears in a partnership\u2019s statement of profit or loss.',
      statements: [
        { text: 'Wages paid to employees who are not partners.', answer: true },
        { text: 'Interest paid on a bank loan taken out by the partnership.', answer: true },
        { text: 'A salary credited to one of the partners.', answer: false },
        { text: 'Interest allowed to a partner on their capital account.', answer: false },
      ],
      exp: 'The test is whether the amount is a cost of trading or a division of profit. Employees\u2019 wages and bank interest are both owed to outsiders, so they reduce the profit before anyone shares it. A partner\u2019s salary and interest on their capital are both ways of splitting profit between owners, so they wait for the appropriation account.',
    },
    {
      id: 'F-7-65', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.3.6'],
      type: 'numeric',
      q: 'Residual profit after appropriations is \u00a348,000, shared between A, B and C in the ratio 3:2:1. A also has a salary of \u00a315,000. What is A\u2019s TOTAL share of profit, in pounds?',
      answer: 39000, unit: '\u00a3',
      exp: 'A partner\u2019s total share is everything allocated to them and not only the residue. The ratio splits the residual six ways: \u00a348,000 \u00f7 6 = \u00a38,000 a part, and A takes three of them, so \u00a38,000 \u00d7 3 = \u00a324,000. Adding the salary already appropriated gives \u00a324,000 + \u00a315,000 = \u00a339,000. B takes \u00a316,000 and C takes \u00a38,000.',
    },
    {
      id: 'F-7-66', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.4.1'],
      type: 'mcq',
      q: 'A sole trader\u2019s statement of financial position shows one capital figure. What replaces it in a partnership\u2019s?',
      opts: [
        'A capital account and a current account for each partner',
        'One combined capital figure for all of the partners together',
        'The appropriation account, carried down as a closing balance',
        'One capital account for each partner, and nothing further',
      ],
      ans: 0,
      exp: 'A sole trader has one owner and one figure, so introductions, profit and drawings all run through it. A partnership separates two different things: the long-term stake each partner put in, which is capital, and the year-to-year movement of profit and drawings, which is current. Showing both for each partner is what makes the statement look different.',
    },
    {
      id: 'F-7-67', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.4.1'],
      type: 'numeric',
      q: 'A partnership\u2019s net assets are \u00a3164,000. The partners\u2019 capital accounts total \u00a3120,000 and A\u2019s current account is \u00a329,000 in credit. What is the balance on B\u2019s current account, in pounds?',
      answer: 15000, unit: '\u00a3',
      exp: 'The financed-by side must equal net assets, exactly as it does for a sole trader. Capital and current accounts together come to \u00a3164,000, so the current accounts hold \u00a3164,000 \u2212 \u00a3120,000 = \u00a344,000 between them. B\u2019s balance is \u00a344,000 \u2212 \u00a329,000 = \u00a315,000, in credit. A DEBIT balance is possible and means that partner has drawn more than was allocated.',
    },
    {
      id: 'F-7-68', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.4.2'],
      type: 'mcq',
      q: 'What is the relationship between the appropriation account and the partners\u2019 current accounts?',
      opts: [
        'The appropriation decides the shares; the current accounts hold them',
        'They are two names for the same account in a partnership\u2019s books',
        'The current accounts decide the shares; the appropriation records them',
        'The appropriation holds the shares until the partnership is wound up',
      ],
      ans: 0,
      exp: 'One is a working and the other is a ledger account. The appropriation account exists to divide one year\u2019s profit and is closed as soon as that is done. The current accounts are running balances that never close: each share arrives as a credit, each partner\u2019s drawings leave as a debit, and whatever is left carries forward.',
    },
    {
      id: 'F-7-69', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.4.2'],
      type: 'truefalse',
      q: 'Identify whether each entry is made in a partner\u2019s CURRENT account.',
      statements: [
        { text: 'The partner\u2019s share of residual profit for the year.', answer: true },
        { text: 'Drawings the partner took during the year.', answer: true },
        { text: 'Cash paid in to increase their long-term stake.', answer: false },
        { text: 'A revaluation of the premises on a change of partners.', answer: false },
      ],
      exp: 'The current account carries what changes every year: profit shares, salaries, interest on capital, and the drawings taken against them. The capital account carries the long-term stake, so money introduced permanently goes there \u2014 and so does a revaluation, which adjusts the value of what the partners already own between them.',
    },
    {
      id: 'F-7-70', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.4.3'],
      type: 'mcq',
      q: 'A partner\u2019s current account shows a DEBIT balance at the year end. What does that tell you?',
      opts: [
        'They have drawn more than has been allocated to them',
        'They have introduced more capital than the other partners',
        'The partnership owes them money as at the year end',
        'Their share of the profit has not yet been calculated',
      ],
      ans: 0,
      exp: 'A current account is normally a credit balance: profit allocated in, drawings taken out, and a credit left that the partnership owes the partner. A debit means the arrows crossed and more was taken than earned, so the partner owes the partnership instead. It is a warning about drawings policy rather than a bookkeeping error.',
    },
    {
      id: 'F-7-71', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.4.4'],
      type: 'mcq',
      q: 'A partner in a decorating business has the partnership\u2019s staff redecorate their own home at no charge. How is that treated?',
      opts: [
        'As drawings, at what the work cost the partnership to provide',
        'As an expense, the staff having been paid for the time anyway',
        'As nothing at all, since no money left the partnership over it',
        'As a sale to the partner at the normal external selling price',
      ],
      ans: 0,
      exp: 'Value taken out by an owner is drawings whatever form it arrives in \u2014 cash, goods off the shelf, or the use of the business\u2019s people. The measure is what it COST the partnership, because that is what the business gave up. Treating it as an expense charges the other partners for one partner\u2019s house, which is exactly what the entry exists to stop.',
    },
    {
      id: 'F-7-72', unitKey: 'faps', lo: 7, criteria: ['FAPS-7.4.4'],
      type: 'numeric',
      q: 'A partner takes goods that cost the partnership \u00a31,800 and would sell for \u00a32,700. What amount is debited to their current account, in pounds?',
      answer: 1800, unit: '\u00a3',
      exp: 'Drawings of goods are recorded at COST and not at selling price: the business has given up what it paid, and it has not made a sale to itself. So \u00a31,800 is debited to the partner\u2019s current account and credited to purchases. Using \u00a32,700 would credit the partnership with \u00a3900 of profit that nobody outside the business ever paid.',
    },
  ];
