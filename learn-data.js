/* AAT Level 2 — Learning Journey content
   ...
   Every lesson is tagged against aat2-syllabus.js and check-aat2-quality.js
   fails a unit whose criteria are not covered, or a lesson that claims none.

   This file used to carry four Level 3 PREVIEW groups as well (faps, mats,
   tpfb, buaw), which had accumulated the off-syllabus lessons moved out of the
   Level 2 units. They have been removed: Level 3 has its own subject in the
   registry, and the "what's next" readiness panel is built from L3_BRIDGE in
   app.js rather than from lesson data. Do not add a Level 3 group back here —
   material that is not in the Level 2 specification does not belong in the
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'The transaction to slow down on is paying a supplier, because the instinct is to look for an expense. The expense arose earlier, when the goods were received and the liability was created. Paying settles that liability, so both effects are decreases and nothing about the overall position changes.',
            ],
            example: {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'A credit note is issued for a small set of reasons. Goods may be returned as faulty, damaged or wrong, or invoiced but never delivered. The original invoice may carry an overcharge, or omit a discount that should have been applied. Or the customer may subsequently take a prompt payment discount.',
              'A wrongly issued invoice is never deleted or replaced. The numbering must stay unbroken, because a gap is exactly what an auditor or HMRC looks for. The customer may also have entered the original in their own books. They need a document to record against it, not a hole where an invoice used to be.',
            ],
            split: {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'What it does not prove is that the entries are right. Six kinds of error leave the trial balance in perfect balance, and they are the ones this qualification spends its time on. An error of **omission** is a transaction never recorded at all. An error of **commission** puts the right amount in the wrong account of the right type. An error of **principle** puts it in an account of the wrong type entirely. An error of **original entry** posts both halves at the same wrong figure. A **reversal** swaps the debit and the credit. A **compensating** error is two unrelated mistakes that happen to cancel out.',
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'The ÷ 6 rule is better understood than memorised. If net is 100 then VAT is 20 and gross is 120, so VAT is 20/120 of the gross — which is one sixth. Knowing where it comes from is what stops you reaching for it in the wrong direction, which is the commonest VAT error at this level.',
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'Follow the whole route once, because every individual step in this unit is a stage of it. A transaction happens and generates a document. The document is checked and entered in the relevant book of prime entry, coded to the right account. At the period end the daybook columns are totalled and cross cast.',
        ...
        cards: [
          {
            ...
            p: [
              ...
              'Working through those two questions in order resolves the five categories almost mechanically, and doing it deliberately beats doing it by instinct. The commonest error at this level is not arithmetic but classification: treating money owed by a customer as income, or the purchase of equipment as an expense.',
            ],
            table: {
        ...
        cards: [
          {
            ...
            p: [
              ...
              'Level 3 does not repeat this material — it assumes it. The Diploma takes the records you now know how to build and asks harder questions of them. How are the figures adjusted at a year end? How are financial statements prepared from a trial balance? How are costs analysed for management decisions, and how are VAT and payroll obligations met?',
          ...
          },
          {
            ...
            p: [
              'FAPS extends everything in ITBK. You will produce and interpret an extended trial balance. You will account for complex depreciation scenarios: straight-line and reducing balance in the same year, part-year depreciation, and disposal of non-current assets. You will handle accruals and prepayments for income as well as expenses, and use journals to correct a wider range of errors.',
          ...
          },
          {
            ...
            p: [
              ...
              'Be precise about what transfers, because the temptation is either to assume everything ahead is new or to assume it is all revision. Neither is true.',
    ...
    lessons: [
         ...
         lessons supply that. */
      {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'Those three cover the assessment, and they have something in common. Each one produces a figure that can be compared against a figure produced some other way, and each one leaves a documented trail of what was compared and when.',
          ...
          },
          {
            ...
            p: [
              ...
              'The reason is worth spelling out. The trial balance tests one property of the ledger — that the debit total equals the credit total — and there are many ways to be wrong while preserving that property.',
        ...
        check: [
          ...
          { q: 'A business has strong monthly reconciliations but no authorisation limits. What is the consequence?', opts: [
              'It will find its errors reliably, and always after the money has gone',
              'It will find its errors before any payment leaves the bank account',
              'It will not detect errors at all until the annual accounts are prepared',
              'It will detect errors only where the two records were built the same way'],
            ans: 0, exp: 'Detective controls are cheap to run but expensive per error, because by the time they fire the wrong figure may already have been paid or filed. A well-designed system weights towards prevention and uses detection to catch what prevention misses.' },
          { q: 'A sole trader employs one bookkeeper, so duties cannot be segregated. What should be recommended?', opts: [
              'Compensating controls — the owner reviews the bank statement and signs the cheques',
              'A three-person authorisation chain, applied to every payment above a set limit',
              'Nothing, since segregation of duties is impossible in a business of that size',
              'Monthly rotation of the bookkeeper between recording and banking duties'],
            ans: 0, exp: 'Where full segregation is genuinely impossible, the answer is to substitute controls the owner can actually perform. Marks are for a control that is realistic at the size described — recommending a three-person chain in a two-person business earns none.' },
          { q: 'Why does £270 entered instead of £720 on both sides leave the trial balance in agreement?', opts: [
              'The same wrong figure appears as a debit and as a credit, so the totals still match',
              'A transposition of digits always cancels out across the two columns of the ledger',
              'The difference of £450 is posted automatically to the suspense account',
              'An error of original entry affects the profit figure rather than the trial balance'],
            ans: 0, exp: 'The trial balance tests one property — that total debits equal total credits — and there are many ways to be wrong while preserving it. An error of original entry, an omission, and an error of commission or principle all survive it untouched.' },
        ],
      },
      {
        id: 'L-pobc-2',
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'Do the arithmetic once slowly. Suppose a receipt of £300 from a customer was posted as Dr sales ledger control, Cr bank, when it should have been Dr bank, Cr sales ledger control.',
        ...
        cards: [
          {
            ...
            p: [
              ...
              'Be clear about what the suspense account is not. It is not a real account in the sense that bank or purchases are real: no transaction ever happened in it, and no asset or liability corresponds to it.',
          ...
          },
          {
            ...
            p: [
              ...
              'One nuance: a suspense balance genuinely too small to investigate is written off to profit or loss on grounds of materiality, but that is a documented decision taken deliberately, not a way of tidying up a difference nobody understood.',
            ],
            callout: {
              kind: 'key',
        ...
        cards: [
          {
            ...
            p: [
              ...
              'Those deductions fall into two groups. **Statutory** deductions are the ones the tax and pensions system requires — income tax under PAYE, the employee’s Class 1 National Insurance contribution, student loan repayments, and pension contributions where the employer has automatically enrolled the employee.',
              'Auto-enrolment is the one people get wrong. The employee may opt out, but the duty to enrol them and deduct sits on the EMPLOYER and comes from the Pensions Act, so the deduction is statutory in the same way PAYE is.',
              '**Voluntary** deductions are ones the employee has agreed to: trade union subscriptions, charitable giving under Give As You Earn, a season ticket loan, or pension contributions ABOVE the auto-enrolment minimum.',
          ...
          },
          {
            ...
            p: [
              ...
              'Do that on any payroll question you are unsure about. If the control account will not clear, one figure has been used twice or omitted, and the check finds it before the marks are lost.',
            ],
        ...
        cards: [
          {
            ...
            p: [
              ...
              'That is why they have to be found some other way. Reconcile the control accounts against the memorandum ledgers. Reconcile the bank. Review the ledger for entries that look out of character. Or someone notices that a supplier statement does not match.',
          ...
          },
          {
            ...
            p: [
              ...
              'The practical consequence is the one to remember. If an error preserved the balance, there was no suspense account, so no correcting journal for it can touch suspense — and an answer that puts one there is wrong regardless of the amounts.',
            ],
            split: {
          ...
          },
          {
            ...
            p: [
              ...
              'Remember too what suspense is not: it is not a real account, no transaction ever occurred in it, and nothing in the business corresponds to its balance. It is a placeholder for ignorance.',
            ],
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'A reconciliation has two halves, and keeping them physically separate on the page pays off. On one side you adjust the **control account** for errors made in it; on the other you adjust the **list of individual balances** for errors made in the memorandum ledger.',
          ...
          },
          {
            ...
            p: [
              ...
              'One practical difference stands out. Because suppliers issue statements, a purchases ledger reconciliation is usually done supplier by supplier against those statements, which finds errors the internal list alone would never reveal.',
            ],
            split: {
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              'Almost every VAT calculation error at this level is a gross-versus-net error, so be mechanical about it. At a standard rate of 20%, net is 100, VAT is 20 and gross is 120.',
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'A **dishonoured cheque** deserves a closer look. A customer’s cheque was recorded as a receipt, then the bank refused it. The receipt has to be reversed — credit the cash book, debit the sales ledger control account — because the customer still owes the money.',
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              '**Faster Payments** move funds between UK banks in seconds and are the normal method for one-off electronic transfers up to the scheme limit. **CHAPS** (Clearing House Automated Payment System) also settles the same working day, and is used for large, time-critical amounts such as a property completion. It carries a fee of roughly £20 to £30, so it is reserved for cases where the certainty is worth paying for.',
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              'Extraction is mechanical, which is exactly why it needs discipline. Work down the ledger account by account and transfer the **balance brought down**, not the total of the account.',
          ...
          },
          {
            ...
            p: [
              ...
              'Calculate the difference and look at it before you start hunting. A difference divisible by nine often means a transposition; a difference exactly equal to a figure in the ledger often means a one-sided entry; a difference that is exactly twice a figure often means an entry posted to the wrong side.',
            ],
            example: {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'Take the initial trial balance from the previous lesson, which carries suspense of £20,620 debit. That debit balance exists because the credit column was the larger one, so clearing it needs journals that **credit** suspense. Journal one: debit purchases £20,000, credit suspense £20,000, correcting a page of the purchases day book credited to the purchases ledger control account but never debited to purchases. Journal two: debit purchases ledger control account £620, credit suspense £620, correcting a supplier payment credited to bank with no matching debit.',
              'Purchases rises from £64,300 debit to £84,300 debit, because the journal is on the same side as the balance. The purchases ledger control account falls from £11,400 credit to £10,780 credit, because a debit journal is on the opposite side to a credit balance. Suspense receives £20,000 and £620 of credits against its £20,620 debit, clearing to nil.',
              'Now total again. The redrafted columns agree at £112,000 with no suspense line, which is the signal that the corrections were complete and correctly journalled. Note that the redrafted total is not the initial total: £112,620 included the suspense figure, which was never a real balance.',
            ],
            example: {
              ...
              rows: [
                ...
                ['Purchases', '64,300', '', '84,300', ''],
                ['Drawings', '9,500', '', '9,500', ''],
                ['Purchases ledger control account', '', '11,400', '', '10,780'],
                ['VAT control account', '', '2,560', '', '2,560'],
                ['Sales', '', '78,660', '', '78,660'],
                ['Capital', '', '20,000', '', '20,000'],
                ['Suspense', '20,620', '', '—', '—'],
                ['Totals', '112,620', '112,620', '112,000', '112,000'],
              ],
            },
          },
          {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'The clearest example is the **extended trial balance**. It is the redrafted trial balance you have just learned, with extra columns for year-end adjustments: accruals, prepayments, depreciation, irrecoverable debts and the allowance for doubtful debts. Further columns then split the adjusted figures between profit or loss and the statement of financial position.',
          ...
          },
          {
            ...
            p: [
              ...
              'Fluency is the goal, not familiarity. If you can look at a described error and see the correcting journal without writing out WAS and SHOULD HAVE BEEN, you have reached the level POBC is trying to get you to. Level 3 then becomes a course about accounting rather than a course about bookkeeping.',
    ...
    lessons: [
         ...
         the foundation of every calculation in the unit. */
      {
        ...
        check: [
          ...
          { q: 'A sales region is measured on the sales it achieves but has no control over costs. Which kind of centre is it?', opts: [
              'A revenue centre, because income is the only thing its manager controls',
              'A profit centre, because sales achieved determines the profit it earns',
              'A cost centre, because the salaries of its staff are incurred within it',
              'An investment centre, because it employs vehicles and other equipment'],
            ans: 0, exp: 'The four centres form a ladder and each rung adds one thing the manager controls: costs, revenue, both, then capital as well. A region controlling income alone is a revenue centre, and it should be judged on income alone.' },
          { q: 'Why is it wrong to judge a cost centre manager on the profit their centre generates?', opts: [
              'They have no control over selling prices, so the measure is unfair and useless',
              'Profit cannot be calculated for a centre that has no external revenue at all',
              'Cost centre managers are judged by the finance function rather than by the board',
              'Profit is a financial accounting measure, so it cannot apply to a cost centre'],
            ans: 0, exp: 'The principle underneath responsibility accounting is that a manager is held responsible only for what they can actually influence. Judging costs against a measure the manager does not control tells you nothing about how well they performed.' },
          { q: 'Codes are in the form CCC/TTT, with 200 for Stores and 430 for Overheads. How is the electricity used in the stores coded?', opts: [
              '200/430',
              '430/200',
              '200/410',
              '430/430'],
            ans: 0, exp: 'The first segment answers "where was this cost incurred?" and the second "what kind of cost is it?". Electricity is an overhead incurred in stores, so 200 then 430 — and the order is always the one the question gives you.' },
        ],
      },
      {
        id: 'L-poc-2',
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'The test is traceability, and it is worth stating exactly: a **direct** cost can be traced to one cost unit without apportionment; an **indirect** cost cannot, so it has to be shared out.',
          ...
          },
          {
            ...
            p: [
              ...
              'That is the source of nearly every mark lost on cost behaviour questions, so check your own answers against it. If a table shows the fixed cost per unit unchanged at two output levels, something has gone wrong.',
            ],
            table: {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'Splitting it matters because the two elements are often treated differently. Basic pay for overtime hours is a direct cost, like any other hour worked. The premium is frequently treated as a production **overhead** instead. The reasoning is that it arises from the general need to meet demand, not from the particular job that happened to be running late in the day.',
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'Addition also has a range form: =SUM(B2:B10) adds every cell from B2 to B10 inclusive. The colon means "through", and it is what keeps the formula working when the numbers in those cells change.',
          ...
          },
          {
            ...
            p: [
              'The specification lists what will not be credited, and the list is unusually specific. Learn it as a list of things to avoid, because each one describes a formula that produces the right answer and scores zero.',
    ...
    lessons: [
         ...
         worth 17 marks between them — with no lesson at all. */
      {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'The relationship between the two needs stating. **Statute** — Acts of Parliament — takes precedence, and Parliament can override case law by legislating. **Case law**, developed by judges deciding real disputes, fills the gaps and interprets what a statute actually means in a situation its drafters did not foresee.',
          ...
          {
            h: 'Equity, and public against private law',
            p: [
              'The specification names three pairs of classifications, and the criminal and civil pair on the next card is only one of them. The other two are asked for just as often and are answered in a sentence each.',
              '**Equity** grew up alongside the common law because the common law had become rigid: it offered damages and very little else, so a claimant who needed the other party to *do* something had no useful remedy. Petitions to the Chancellor produced a separate body of principle built on fairness, and the two systems were merged into one court structure in the 1870s. What survives of the distinction is the remedies. Damages are a **common-law** right, available as of right once breach is proved. Specific performance, an injunction and rescission are **equitable** remedies, granted at the court’s discretion and only where damages would not be adequate.',
              'That is why the two words matter to an accountant rather than only to a lawyer. Whether a client is *entitled* to a remedy or merely *may be granted* one changes what a receivable is worth.',
              '**Public law** governs the relationship between the individual and the state: constitutional law, administrative law and criminal law all sit here. **Private law** governs disputes between individuals and organisations — contract, tort, company law, employment. Almost everything an accountant meets is private law, with tax the obvious exception.',
              'Note that the pairs cut across each other. Criminal law is public law, but civil law is not the same thing as private law: a judicial review of a government decision is a civil claim brought in public law. Keeping the three pairs separate in your mind is what the question is testing.',
            ],
            table: {
              headers: ['Classification', 'What it divides', 'Where an accountant meets it'],
              rows: [
                ['**Common law and equity**', 'Remedies available as of right, against remedies granted at the court’s discretion', 'Damages for an unpaid invoice, against an injunction to enforce a restrictive covenant'],
                ['**Public and private law**', 'The individual against the state, against disputes between private parties', 'Tax and regulation, against contracts with customers and suppliers'],
                ['**Criminal and civil law**', 'Offences punished by the state, against wrongs put right between parties', 'Fraud and bribery, against breach of contract and negligence'],
              ],
            },
            examtrap: 'Civil law and private law are not synonyms. Criminal law is a branch of public law, but a civil claim can be brought in public law too — judicial review is the standard example.',
          },
          {
          ...
          },
          {
            ...
            p: [
              ...
              'Watch for facts that generate both. A driver who injures someone through careless driving may be prosecuted by the state **and** sued by the injured person. The two proceedings are independent. An acquittal in the criminal court does not defeat the civil claim, precisely because the standards of proof differ.',
            ],
        ...
        check: [
          ...
          { q: 'Damages are a common-law remedy and an injunction is an equitable one. What practical difference does that make?', opts: [
              'Damages are available as of right; an injunction is granted at the court’s discretion',
              'Damages are awarded by a jury; an injunction is ordered by a judge sitting alone',
              'Damages are available in contract only; an injunction is available in tort only',
              'Damages must be claimed within six years; an injunction has no time limit at all'],
            ans: 0, exp: 'Equity grew up because the common law offered damages and very little else. Once breach is proved damages follow as of right, while specific performance, an injunction and rescission are discretionary and granted only where damages would be inadequate.' },
          { q: 'A company challenges a government department’s decision by judicial review. How is that classified?', opts: [
              'A civil claim brought in public law, since the dispute is with the state',
              'A criminal matter, because only the state can be a party to public law',
              'A civil claim brought in private law, since a company is a private party',
              'Neither civil nor criminal, because judicial review is a tribunal process'],
            ans: 0, exp: 'This is why civil law and private law are not synonyms. Public law governs the relationship between the individual and the state, and a challenge to a state decision sits there — while remaining a civil claim rather than a prosecution.' },
          { q: 'On what ground can a statutory instrument be challenged in the courts?', opts: [
              'That it goes beyond the power the parent Act granted, and so is ultra vires',
              'That it received less parliamentary debate than a Bill would have received',
              'That the minister who made it has since left the department concerned',
              'That an Act of Parliament covering the same subject already exists'],
            ans: 0, exp: 'Ultra vires is the main check on delegated legislation, and it is a judicial rather than a parliamentary one. Thin scrutiny is the acknowledged disadvantage of statutory instruments, but it is not itself a ground for striking one down.' },
        ],
      },
      {
        id: 'L-besy-2',
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'Limited liability is the defining feature, and it needs stating precisely: a shareholder’s liability is limited to the amount unpaid on their shares. Once the shares are fully paid, the shareholder can lose their investment but cannot be pursued for the company’s debts.',
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'For an accountant the key obligations are three. Know the client. Be alert to warning signs: unexplained cash, reluctance to provide identification, transactions with no commercial rationale. And report a suspicion to the firm’s Money Laundering Reporting Officer or the National Crime Agency. Failing to report is an offence, and so is tipping off the client.',
            ],
          },
        ],
        check: [
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'Two consecutive quarters of falling GDP is the conventional definition of a recession — a definition to learn verbatim.',
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'The wider benefits and disadvantages of trading internationally follow the same pattern. On one side: a larger market, economies of scale and access to cheaper inputs. On the other: currency risk, tariffs and customs administration, longer lead times, cultural and language barriers and harder credit control.',
            ],
            example: {
        ...
        cards: [
          {
            ...
            p: [
              ...
              'The skills that follow are worth naming explicitly: spreadsheet fluency, an understanding of how the accounting system is configured, the ability to interrogate data rather than merely accept a report, and the ability to explain a finding to someone who does not read accounts.',
          ...
          },
          {
            ...
            p: [
              ...
              'The specification names the **role of finance in CSR reporting** explicitly, so be ready to say what it is. Finance collects and verifies the data. It ensures the measures are consistent between periods. And it presents them so that a reader can rely on them, rather than merely be reassured by them.',
            ],
         ...
         judge a source of information — all named in the specification. */
      {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              'The specification asks specifically about the effect of government action on three things, and they are connected in a chain you should be able to describe.',
        ...
        cards: [
          {
            ...
            p: [
              ...
              'Be ready to state the trade-off, because a written task will often ask whether a business should incorporate. Limited liability and easier access to finance sit on one side; public filing, higher compliance cost and directors\' duties sit on the other.',
      ...
      },
      {
        ...
        check: [
          {
            q: 'A supplier disputes a £480 difference on their statement. Which opening sentence earns the marks?',
            opts: [
              'Your statement shows £2,880 and our records show £2,400 — a difference of £480.',
              'There appears to be a discrepancy between our two records that we are investigating.',
              'We have looked into your account and believe our own figure to be the correct one.',
              'Thank you for your statement, which we have received and passed to the relevant team.',
            ],
            ans: 0,
            exp: 'Figure, cause, action, close. Naming the specific amount is where the first mark sits; "a discrepancy" states that something is wrong without saying what, which tells the reader nothing they did not already know.',
          },
          {
            q: 'Which medium suits a final demand for an overdue debt?',
            opts: [
              'A formal letter, which carries weight and creates a dated, retrievable record',
              'An email, which is faster and will reach the customer on the same working day',
              'A telephone call, which allows the position to be explained and questions answered',
              'A post on the organisation’s social media accounts naming the outstanding amount',
            ],
            ans: 0,
            exp: 'Serious and potentially legal matters go by formal letter. A telephone call leaves no record of what was said, and naming a customer’s debt publicly would breach confidentiality as well as damaging the organisation.',
          },
          {
            q: 'Writing to an operations manager, which sentence communicates the variance properly?',
            opts: [
              'Materials cost £2,900 more than budgeted, which is 3.5% over the planned figure',
              'The materials variance for the period is adverse against the flexed budget',
              'There is an adverse variance on the materials line of the management accounts',
              'The materials figure has moved unfavourably against the standard we had set',
            ],
            ans: 0,
            exp: 'Assume the reader is intelligent and busy but does not share the vocabulary. "Adverse variance" means nothing outside a finance office; a figure with its units and a percentage gives the manager something they can act on.',
          },
          {
            q: 'A statutory filing deadline and a colleague’s request for a report both arrive today. How should the work be prioritised?',
            opts: [
              'By urgency and importance together, which places the statutory deadline first',
              'By urgency alone, which places whichever arrived with the shorter notice first',
              'By whoever asked first, since that is the fairest basis and avoids disputes',
              'By whichever task can be completed fastest, to reduce the outstanding list',
            ],
            ans: 0,
            exp: 'Urgent and important are different things. A statutory deadline is both; a colleague’s request may be urgent without being important. Ranking on urgency alone lets a loud request displace an obligation with a legal consequence.',
          },
          {
            q: 'You realise a reconciliation will not be finished in time for the management accounts. What does the specification expect?',
            opts: [
              'Tell whoever depends on it as early as possible, before the deadline passes',
              'Complete as much as possible and report the position once the deadline has passed',
              'Ask a colleague to sign the reconciliation off so the deadline is formally met',
              'Submit the figures unreconciled and correct them in the following month',
            ],
            ans: 0,
            exp: 'Not completing a task affects others downstream — a late reconciliation delays the management accounts, which delays a decision. The failure to warn is often more damaging than the delay itself, and the other three options all conceal the problem.',
          },
          {
            type: 'truefalse',
            q: 'Identify whether each statement about business communication is true or false.',
            statements: [
              { text: 'A telephone call should be followed up in writing where something was agreed.', answer: true },
              { text: 'A supplier chasing payment is entitled to be told which manager is on leave.', answer: false },
              { text: 'Notes made during a meeting help make a later account of it credible.', answer: true },
              { text: 'The intranet is a suitable medium for information many people need at once.', answer: true },
              { text: 'Copying a third party into an account dispute speeds up its resolution.', answer: false },
            ],
            exp: 'Two are false. A supplier is entitled to know their invoice is being processed and when it will be paid, and nothing more about how the business is run. And copying in a third party discloses the dispute to someone with no right to see it, which is a confidentiality breach rather than an efficiency.',
          },
        ],
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            p: [
              ...
              'The distinction is the same one you met in Principles of Costing, and you should be able to state it crisply, because it appears in both units.',
          ...
          },
          {
            ...
            p: [
              ...
              'The specification lists what the finance function **receives**, and learning it as a list pays off, because a task may ask you to identify a document. Purchase orders, supplier invoices, credit notes, statements, remittance advices, and information from customers and suppliers all arrive from outside.',
        ...
        check: [
          {
            q: 'The specification splits the role of the finance function in two. What are the two halves?',
            opts: [
              'Producing the statutory financial statements, and providing a service to stakeholders',
              'Producing the statutory financial statements, and approving the prices the business charges',
              'Setting the annual budget, and deciding which products the business should discontinue',
              'Recording transactions accurately, and auditing those records independently afterwards',
            ],
            ans: 0,
            exp: 'Statutory accounts are the obligation nobody else in the business can discharge. The service half — information, support, advice and guidance to internal and external stakeholders — is the part that has grown, and it is what keeps a modern finance function busy all year.',
          },
          {
            q: 'Which characteristic of useful information do businesses most often fail on?',
            opts: [
              'Timeliness, since a report arriving after the decision has little value left',
              'Accuracy, since most finance systems produce figures that cannot be relied upon',
              'Understandability, since accounting language is inherently technical',
              'Comparability, since no two accounting periods are ever really alike',
            ],
            ans: 0,
            exp: 'A perfectly accurate report produced six weeks after the month end has lost most of its value, because the decisions it should have informed are already taken. There is a genuine trade-off between accuracy and timeliness, and management accounting usually resolves it in favour of timeliness.',
          },
          {
            q: 'Why is the split of duties within a finance function described as a control rather than as tidy organisation?',
            opts: [
              'It stops one person both causing an error or fraud and concealing it afterwards',
              'It allows each role to be measured against a separate departmental budget',
              'It lets the organisation employ fewer staff in the finance function overall',
              'It ensures every transaction is recorded twice, once by each of two people',
            ],
            ans: 0,
            exp: 'Segregation of duties means the person who sets up a supplier is not the person who authorises payments to it, and the person who banks receipts is not the person who records them. It generally needs more staff, not fewer, which is the standard wrong answer.',
          },
          {
            q: 'The specification names four things the actions of finance staff support. Which is NOT one of them?',
            opts: [
              'The market share the organisation holds against its competitors',
              'The solvency of the organisation and the effective management of its funds',
              'Compliance with the legal and regulatory requirements that apply',
              'Efficient working practices and long-term financial stability',
            ],
            ans: 0,
            exp: 'Efficient working practices, solvency, legal and regulatory compliance, and long-term financial stability are the four. Market share is a commercial outcome that sales and marketing pursue — finance measures it rather than delivering it.',
          },
          {
            q: 'An operations manager complains that finance keeps asking for production volumes. What is the best answer?',
            opts: [
              'Finance cannot cost a unit or flex a budget without knowing how many were made',
              'Finance is required to collect the figures for the annual statutory accounts',
              'Finance needs them to check whether the production department met its targets',
              'Finance passes the figures to the external auditor as part of the audit file',
            ],
            ans: 0,
            exp: 'The flow runs both ways, and showing that is what earns marks. Finance needs operational data to cost anything at all; in return operations gets budgets built on real figures and variance analysis it can act on.',
          },
          {
            type: 'truefalse',
            q: 'Identify whether each statement about the finance function is true or false.',
            statements: [
              { text: 'A management report has no prescribed format.', answer: true },
              { text: 'Outsourcing the payroll transfers legal responsibility for it to the provider.', answer: false },
              { text: 'Companies House filings go on a public register; HMRC returns do not.', answer: true },
              { text: 'A finance member is bound only by policies specific to the finance function.', answer: false },
              { text: 'Information that is not financial can still be useful to the finance function.', answer: true },
            ],
            exp: 'Two are false. Outsourcing adds a relationship to manage and data to share securely, but the business stays accountable for what is filed and paid. And a finance member is bound by organisation-wide policies — data protection, a code of conduct — as well as by finance-specific ones such as an authorisation limit.',
          },
        ],
      },
    ],
