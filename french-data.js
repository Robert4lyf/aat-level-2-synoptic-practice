...
window.FR_QUESTIONS = [
  ...
  {"id":"fr-005","topic":"fr-salut","lesson":"fr-l01","type":"mcq","q":"\"À bientôt\" means?","opts":["See you soon","See you tomorrow","Goodbye forever","Good night"],"ans":0,"exp":"\"À bientôt\" means see you soon."},
  ...
  {"id":"fr-773","topic":"fr-gram","lesson":"fr-l05","type":"mcq","q":"What is the plural of 'un cheval'?","opts":["des chevals","des chevaux","des chevales","des chevals"],"ans":1,"exp":"-al → -aux in the plural: un cheval → des chevaux. Other examples: un animal → des animaux, un journal → des journaux."},
  {"id":"fr-774","topic":"fr-gram","lesson":"fr-l05","type":"mcq","q":"What is the plural of 'un gâteau'?","opts":["des gâteaus","des gâteaux","des gâteaux","des gâteauxs"],"ans":1,"exp":"-eau → -eaux: un gâteau → des gâteaux. Similarly: un bateau → des bateaux, un chapeau → des chapeaux."},
  ...
  {"id":"fr-776","topic":"fr-gram","lesson":"fr-l05","type":"mcq","q":"What is the plural of 'un œil'?","opts":["des œils","des yeux","des œils","des œux"],"ans":1,"exp":"un œil → des yeux is an irregular plural that must be memorised. Compare: un genou → des genoux, un pou → des poux."},
  ...
  {"id":"fr-796","topic":"fr-gram","lesson":"fr-l20","type":"mcq","q":"What is the imparfait stem of 'faire'?","opts":["fais-","fer-","faisions-","fais-"],"ans":0,"exp":"The imparfait stem = nous form present minus -ons: nous faisons → fais-. Exception: être → ét-. Imparfait endings: -ais, -ais, -ait, -ions, -iez, -aient."},
  ...
  {"id":"fr-1268","topic":"fr-clinic-adj","type":"mcq","q":"What is the correct feminine form of 'sportif'?","opts":["sportife","sportive","sportife","sportifs"],"ans":1,"exp":"The -if/-ive pattern: sportif → sportive. Other examples: actif/active, négatif/négative, naïf/naïve. Never 'sportife' — that ending doesn't exist.","lesson":"fr-clinic-adj"},
  ...
  {"id":"fr-1437","topic":"fr-clinic-register","type":"mcq","q":"Which greeting is most appropriate to start a formal email?","opts":["Salut !","Yo !","Madame, Monsieur,","Coucou !"],"ans":2,"exp":"'Madame, Monsieur,' or 'Madame,' / 'Monsieur,' are standard formal email openings. 'Salut', 'Coucou', 'Yo' are all informal/slang and completely inappropriate in formal writing.","lesson":"fr-clinic-register"},
  ...
  {"id":"fr-1448","topic":"fr-clinic-register","type":"mcq","q":"Which is the correct formal way to close a French letter?","opts":["Bisous !","À plus !","Veuillez agréer l'expression de mes salutations distinguées.","Ciao !"],"ans":2,"exp":"'Veuillez agréer l'expression de mes salutations distinguées' is the traditional formal closing. 'Bisous' and 'Ciao' are very informal. 'À plus' is informal shorthand for 'à plus tard'.","lesson":"fr-clinic-register"},
  ...
  {"id":"fr-1460","topic":"fr-clinic-register","type":"mcq","q":"Which greeting is appropriate at the start of a professional email?","opts":["Bonjour Madame Martin,","Salut !","Yo Madame Martin,","Wesh !"],"ans":0,"exp":"'Bonjour Madame Martin,' is a common semi-formal opening. For more formal emails, 'Madame,' alone is used. 'Salut', 'Yo', and 'Wesh' are all far too informal.","lesson":"fr-clinic-register"},
