...
window.FR_QUESTIONS = [
  ...
  {"id":"fr-932","topic":"fr-gram","lesson":"fr-l11","type":"typed","q":"What is the French for 'the books' (les livres)?","ans":"les livres","alts":["Les livres"],"ignoreAccents":false,"exp":"livre (m.) → les livres. The definite article for all plurals is les regardless of gender. Do not confuse: le livre (sing. masc.) / la livre (the pound — different word!) / les livres (the books)."},
  ...
  {"id":"fr-978","topic":"fr-phon","lesson":"fr-l40","type":"typed","tts":"père","q":"What accent does the 'e' in 'père' (father) carry?","ans":"grave","alts":["accent grave","Grave","Accent grave"],"ignoreAccents":false,"exp":"è = accent grave → open 'eh' sound (like 'e' in 'bed'). père /pɛʁ/. Other accent grave examples: très, après, frère, mère. Compare: é (aigu) = closed 'ay' / è (grave) = open 'eh'."},
  ...
  {"id":"fr-987","topic":"fr-gram","lesson":"fr-l19","type":"typed","q":"Translate to French: 'every day' (tous les jours)","ans":"tous les jours","alts":["Tous les jours"],"ignoreAccents":false,"exp":"tous les jours = every day (literally 'all the days'). jour (m.) → tous les jours. Compare: toute la journée = all day long. Common time expressions: tous les jours, chaque jour, le matin, le soir."},
  ...
  {"id":"fr-1065","topic":"fr-clinic-prep","type":"typed","q":"Complete: 'Je vais ___ France.' (I'm going to France.)","ans":"en","alts":["En"],"ignoreAccents":false,"exp":"'Je vais en France.' — Countries: en + feminine (la France → en France) / au + masculine (le Mexique → au Mexique) / aux + plural (les États-Unis → aux États-Unis) / en + masculine starting with vowel (en Iran, en Irak). Cities: à (à Paris, à Rome).","lesson":"fr-clinic-prep"},
  ...
  {"id":"fr-1069","topic":"fr-clinic-prep","type":"typed","q":"Complete: 'Je vais ___ travail.' (I go to work.) — à contracts with le.","ans":"au","alts":["Au"],"ignoreAccents":false,"exp":"'Je vais au travail.' — à + le = au (mandatory contraction). à + la = à la. à + les = aux. à + vowel = à l'. So: au travail (m.) / à la maison (f.) / à l'école (vowel) / aux États-Unis (pl.). Never write 'à le' — it must contract to 'au'.","lesson":"fr-clinic-prep"},
  ...
  {"id":"fr-1081","topic":"fr-clinic-verbs","type":"typed","q":"Complete: 'Tu parl___.' (You speak — present tense -er verb.)","ans":"parles","alts":["Parles"],"ignoreAccents":false,"exp":"'Tu parles.' — -er verbs present tense: je parle / tu parles / il-elle parle / nous parlons / vous parlez / ils-elles parlent. The -s of 'tu parles' is SILENT but mandatory in writing. Very common error: 'tu parle' without the -s.","lesson":"fr-clinic-verbs"},
  ...
  {"id":"fr-1083","topic":"fr-clinic-verbs","type":"typed","q":"[A2] Complete: 'Il fin___.' (He finishes — present tense, regular -ir verb.)","ans":"finit","alts":["Finit"],"ignoreAccents":false,"exp":"'Il finit.' — Regular -ir verbs (finir type): je finis / tu finis / il-elle finit / nous finissons / vous finissez / ils-elles finissent. 'Il finit' ends in -t (no extra -s). Don't confuse with short -ir verbs (partir, sortir): je pars / tu pars / il part (no -iss- infix).","lesson":"fr-clinic-verbs"},
  ...
  {"id":"fr-1139","topic":"fr-shop","lesson":"fr-l48","type":"mcq","q":"You see 'SOLDES −50%' in a shop window. What does this mean?","opts":["50% price increase","50% discount","50 items only","Open 50 hours a week"],"ans":1,"exp":"Les soldes = the sales. −50% = 50% reduction. In France, les soldes are biannual regulated events in January and July."},
