...
window.FR_QUESTIONS = [
  ...
  // ── fr-num extended: days, months, time expressions (fr-673 to fr-690) ────
  ...
  // ── fr-vocab extended: professions, places, body (fr-691 to fr-708) ────────
  ...
  // ── fr-l25 (comparatives/superlatives) ───────────────────────────────────────
  ...
  // ── fr-l38 (irregular verbs — pouvoir/vouloir/devoir/savoir) ─────────────────
  ...
  // ── typed practice (fr-926 to fr-933) ──────────────────────────────────────
  ...
  // ── articles: un/une/le/la/les/des/du/de la (fr-934 to fr-943) ─────────────
  ...
  // ── adjective agreement (fr-944 to fr-949) ─────────────────────────────────
  ...
  // ── present-tense verb endings (fr-950 to fr-955) ──────────────────────────
  ...
  // ── passé composé with avoir (fr-956 to fr-959) ────────────────────────────
  ...
  // ── passé composé with être (fr-960 to fr-962) ─────────────────────────────
  ...
  // ── basic prepositions: à, de, en, au, aux (fr-963 to fr-968) ──────────────
  ...
  // ── word order and negation (fr-969 to fr-972) ─────────────────────────────
  ...
  // ── formal vs informal phrases (fr-973 to fr-976) ──────────────────────────
  ...
  // ── sentence completion — mixed A2 (fr-981 to fr-987) ──────────────────────
  ...
  // ── listen-typed dictation (fr-994 to fr-1003) ────────────────────────────
  ...
  // ── Listening: numbers and dates (fr-1004 to fr-1009) ────────────────────
  ...
  // ── Listening: greetings and introductions (fr-1010 to fr-1014) ───────────
  ...
  // ── Listening: café and restaurant (fr-1015 to fr-1019) ──────────────────
  ...
  // ── Listening: travel and directions (fr-1020 to fr-1024) ────────────────
  ...
  // ── Listening: work and daily routine (fr-1025 to fr-1029) ───────────────
  ...
  // ── Listening: short dialogues (fr-1030 to fr-1034) ─────────────────────
  ...
  // ── Listening: near-homophones (fr-1035 to fr-1040) ─────────────────────
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // MISTAKE CLINIC — fr-1041 to fr-1104
  // No 'lesson' field: always accessible, not gated by lesson completion.
  // A1 = no prefix; [A2] or [B1] prefix in question text for CEFR labelling.
  // ══════════════════════════════════════════════════════════════════════════

  // ── Clinic 1: Genre & articles (fr-1041 to fr-1048) ──────────────────────
  {"id":"fr-1041","topic":"fr-clinic-gender","type":"mcq","q":"Which article correctly completes: '___ café est fermé' (the café is closed)?","opts":["le","la","les","un"],"ans":0,"exp":"'le café' — café is masculine. Definite articles: le (m. sing.) / la (f. sing.) / l' (before vowel or h muet) / les (plural). Tip: always learn a noun with its article — 'le café', 'la table', 'l'école', 'les amis'."},
  {"id":"fr-1042","topic":"fr-clinic-gender","type":"mcq","q":"Which article is correct: '___ école est grande' (the school is big)?","opts":["le","la","l'","une"],"ans":2,"exp":"'l'école' — école starts with a vowel, so le/la → l' (elision). école is feminine (l' replaces la). Elision: l'ami (m.), l'hôtel (m.), l'orange (f.), l'eau (f.). Elision is mandatory — you cannot say 'la école'."},
  {"id":"fr-1043","topic":"fr-clinic-gender","type":"typed","q":"Translate 'a table' into French (indefinite article + noun).","ans":"une table","alts":["Une table"],"ignoreAccents":false,"exp":"'une table' — table is feminine. Indefinite articles: un (m. sing.) / une (f. sing.) / des (plural). 'la table' = the table (definite); 'une table' = a table (indefinite). Remember: un ami (m.) but une amie (f.)."},
  ...
  // ── Clinic 2: Accords des adjectifs (fr-1049 to fr-1056) ─────────────────
  {"id":"fr-1049","topic":"fr-clinic-adj","type":"mcq","q":"Complete: 'une ___ maison' — the adjective 'petit' must agree with the feminine noun.","opts":["petit","petite","petits","petites"],"ans":1,"exp":"'une petite maison' = a small house. Base rule: m. sing. + nothing / f. sing. + e / m. pl. + s / f. pl. + es. If an adjective already ends in -e (rouge, facile), the feminine form stays the same."},
  ...
  {"id":"fr-1068","topic":"fr-clinic-prep","type":"mcq","q":"Complete: 'Je joue ___ guitare.' (I play the guitar.)","opts":["au","du","de la","à la"],"ans":2,"exp":"'Je joue de la guitare.' — jouer DE + instrument: du piano (m.) / de la guitare (f.) / de l'accordéon (vowel). Compare: jouer AU + sport: au foot (m.) / à la pétanque (f.) / aux échecs (pl.). Instrument = DE; sport = À."},
  ...
  {"id":"fr-1096","topic":"fr-clinic-accents","type":"mcq","q":"[A2] What does the tréma (¨) in 'naïf' indicate?","opts":["The letter is silent","The two vowels are pronounced separately","The consonant is doubled","The word is foreign"],"ans":1,"exp":"'naïf' — tréma on ï: 'a' and 'i' are two separate sounds /a.i/, not the single sound /ɛ/ that 'ai' normally makes. The tréma 'breaks apart' vowel pairs. Examples: naïve, Noël, coïncidence, maïs, Citroën. French reform has moved some trémas (ambiguë → ambigüe)."},

  // ── Clinic 8: Registre de langue (fr-1097 to fr-1104) ────────────────────
