...
window.FR_QUESTIONS = [
  ...
  {"id":"fr-956","topic":"fr-conj","lesson":"fr-l21","type":"typed","q":"Translate to French: 'I ate an apple.' (passé composé)","ans":"J'ai mangé une pomme.","alts":["j'ai mangé une pomme"],"ignoreAccents":false,"exp":"Passé composé = auxiliary (avoir/être) + past participle. manger → mangé. J'ai + mangé + une pomme. Most verbs use avoir as auxiliary."},
  ...
  {"id":"fr-958","topic":"fr-conj","lesson":"fr-l21","type":"typed","q":"Correct this mistake: 'Ils *a mangé* le gâteau.'","ans":"Ils ont mangé le gâteau.","alts":["ils ont mangé le gâteau"],"ignoreAccents":false,"exp":"ils (3rd person plural) → ont (not a). avoir in passé composé: j'ai, tu as, il a, nous avons, vous avez, ILS ONT. ils ont mangé = they ate."},
  ...
  {"id":"fr-960","topic":"fr-conj","lesson":"fr-l22","type":"typed","q":"Translate to French: 'I went to Paris.' (passé composé — aller uses être)","ans":"Je suis allé à Paris.","alts":["je suis allé à Paris","Je suis allée à Paris.","je suis allée à Paris"],"ignoreAccents":false,"exp":"aller uses être as auxiliary: je suis allé(e). The past participle allé agrees with the subject: allé (masc.) / allée (fem.). Being verbs of motion mostly use être: aller, venir, partir, arriver, naître, mourir."},
  ...
  {"id":"fr-989","topic":"fr-conj","lesson":"fr-l28","type":"typed","q":"[B1] Translate to French: 'I would like a coffee.' (polite conditional)","ans":"Je voudrais un café.","alts":["je voudrais un café","Je voudrais un café"],"ignoreAccents":false,"exp":"voudrais = conditional of vouloir = would like. More polite than je veux (I want). Conditional endings: -ais, -ais, -ait, -ions, -iez, -aient added to the infinitive stem."},
  {"id":"fr-990","topic":"fr-conj","lesson":"fr-l29","type":"typed","q":"[B1] Translate to French: 'When I was young, I played football.' (imparfait)","ans":"Quand j'étais jeune, je jouais au football.","alts":["quand j'étais jeune, je jouais au football","Quand j'étais jeune, je jouais au foot.","quand j'étais jeune, je jouais au foot"],"ignoreAccents":false,"exp":"Imparfait = habitual/repeated past action or past state. étais = imperfect of être. jouais = imperfect of jouer. au football = à + le. Imparfait endings: -ais, -ais, -ait, -ions, -iez, -aient."},
  ...
  {"id":"fr-1301","topic":"fr-clinic-pc","type":"typed","q":"Correct: 'Elle a née en 1990.'","ans":"Elle est née en 1990.","alts":["elle est née en 1990","Elle est née en 1990"],"ignoreAccents":false,"exp":"'Naître' (to be born) uses être: elle est née. Subject 'elle' = feminine → née (+e). Very common error to use avoir with naître.","lesson":"fr-clinic-pc"},
