...
window.FR_QUESTIONS = [
  ...
  {"id":"fr-933","topic":"fr-phon","lesson":"fr-l40","type":"typed","tts":"est","q":"How is the French word 'est' (is) pronounced — give the IPA symbol for its vowel.","ans":"/ɛ/","alts":["ɛ","/ε/","ε"],"ignoreAccents":false,"exp":"'est' (is, from être) is pronounced /ɛ/ — an open mid-front vowel, like the 'e' in 'bed'. The final 'st' is silent. This is more open than 'et' (and) which is /e/ — a closed vowel like 'é' in café."},
  ...
  {"id":"fr-1062","topic":"fr-clinic-pc","type":"typed","q":"[A2] Complete: 'Elle s'___ couchée tôt.' (She went to bed early.) — all reflexive verbs use être.","ans":"est","alts":["Est"],"ignoreAccents":false,"exp":"'Elle s'est couchée tôt.' — ALL reflexive (pronominal) verbs use être. Past participle agrees with reflexive pronoun: elle → couchée (f. s.). Examples: il s'est levé, elle s'est habillée, ils se sont dépêchés, elles se sont réveillées.","lesson":"fr-clinic-pc"},
  ...
  {"id":"fr-1071","topic":"fr-clinic-prep","type":"typed","q":"[A2] Complete: 'Je voyage ___ avion.' (I travel by plane.)","ans":"en","alts":["En"],"ignoreAccents":false,"exp":"'Je voyage en avion.' — enclosed vehicles use 'en': en voiture, en train, en bus, en avion, en métro, en bateau. Self-propelled transport uses 'à': à vélo, à pied, à moto. Easy rule: sit inside it = en; ride on top = à.","lesson":"fr-clinic-prep"},
  ...
  {"id":"fr-1073","topic":"fr-clinic-order","type":"typed","q":"Put these words in the correct French order: ne / je / pas / café / aime / le","ans":"Je n'aime pas le café","alts":["je n'aime pas le café","Je n'aime pas le café."],"ignoreAccents":false,"exp":"'Je n'aime pas le café.' Negation wraps the verb: ne BEFORE + pas AFTER. 'Ne' elides before a vowel: ne aime → n'aime. Structure: Subject + ne + verb + pas + (rest of sentence). Spoken French often drops 'ne': 'J'aime pas le café.'","lesson":"fr-clinic-order"},
  ...
  {"id":"fr-1081","topic":"fr-clinic-verbs","type":"typed","q":"Type the missing verb ending: 'Tu parl___.' (You speak — present tense -er verb.)","ans":"parles","alts":["Parles","tu parles","Tu parles"],"ignoreAccents":false,"exp":"'Tu parles.' — -er verbs present tense: je parle / tu parles / il-elle parle / nous parlons / vous parlez / ils-elles parlent. The -s of 'tu parles' is SILENT but mandatory in writing. Very common error: 'tu parle' without the -s.","lesson":"fr-clinic-verbs"},
  ...
  {"id":"fr-1083","topic":"fr-clinic-verbs","type":"typed","q":"[A2] Type the missing verb ending: 'Il fin___.' (He finishes — present tense, regular -ir verb.)","ans":"finit","alts":["Finit","il finit","Il finit"],"ignoreAccents":false,"exp":"'Il finit.' — Regular -ir verbs (finir type): je finis / tu finis / il-elle finit / nous finissons / vous finissez / ils-elles finissent. 'Il finit' ends in -t (no extra -s). Don't confuse with short -ir verbs (partir, sortir): je pars / tu pars / il part (no -iss- infix).","lesson":"fr-clinic-verbs"},
  ...
  {"id":"fr-1085","topic":"fr-clinic-verbs","type":"typed","q":"Type the missing verb ending: 'Elle mang___.' (She eats — present tense.)","ans":"mange","alts":["Mange","elle mange","Elle mange"],"ignoreAccents":false,"exp":"'Elle mange.' — the il/elle form of -er verbs ends in -e (no -s). je mange / tu manges / il-elle mange. Note: 'nous mangeons' adds -e- before -ons for pronunciation (soft g). The endings -e, -es, -ent are all SILENT — only spelling distinguishes them.","lesson":"fr-clinic-verbs"},
  ...
  {"id":"fr-1100","topic":"fr-clinic-register","type":"typed","q":"[B1] Add the missing 'ne' to make formal: 'C'est pas facile.' → 'Ce ___ pas facile.'","ans":"n'est","alts":["N'est"],"ignoreAccents":false,"exp":"'Ce n'est pas facile.' — Spoken French drops 'ne': 'c'est pas facile'. Formal written French always uses both: ne…pas. This applies to all negations: 'il sait pas' → 'il ne sait pas'. Dropping 'ne' in DELF writing tasks is penalised as a register error.","lesson":"fr-clinic-register"},
  ...
  {"id":"fr-1312","topic":"fr-clinic-pc","type":"typed","q":"Translate: 'Did you sleep well?' (informal tu)","ans":"Tu as bien dormi ?","alts":["tu as bien dormi","As-tu bien dormi ?","est-ce que tu as bien dormi ?","Est-ce que tu as bien dormi ?","As-tu bien dormi"],"ignoreAccents":true,"exp":"'Dormir' uses avoir: tu as dormi. 'Bien' (well) goes between the auxiliary and the past participle.","lesson":"fr-clinic-pc"},
