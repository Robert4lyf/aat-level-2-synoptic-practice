      ...
      cards: [
        ...
        },
        {
          ...
          p: [
            ...
            'Two of those will mean nothing yet, and are worth a line here because they are named again before Outcome 2 explains them. A **fuel scale charge** is a fixed amount of extra output tax a business declares instead of keeping mileage records, where it reclaims the VAT on road fuel that is also used privately in a car. **Bad debt relief** recovers VAT already paid over to HMRC on a sale the customer never paid for. Lesson 2E deals with both properly; they appear in the list above only because the assessment hands you their figures.',
            'This is not permission to stop learning them. Knowing roughly what the de minimis limit is tells you a calculation is needed at all; a student who has never met the rule will not think to look it up, and looking up a table you do not understand is slow and error-prone under time pressure. Familiarity is what lets you find the right row quickly and know what to do with it.',
            'But it does redirect effort. The marks are in knowing **which rule applies**, **whether its conditions are met**, and **how to apply it** — not in reciting figures. If you find yourself drilling percentages, you are revising the part the exam hands you and neglecting the part it tests. That is the single most useful thing to know before starting.',
      ...
      cards: [
        ...
        },
        {
          ...
          p: [
            ...
            'Both of those adjustment names came up in lesson 0A and neither is obvious, so to repeat the short version: a **fuel scale charge** is extra *output* tax, declared where a business reclaims the VAT on road fuel that is also used privately in a car. **Bad debt relief** is extra *input* tax, recovering VAT already paid over on a sale the customer never settled. Notice that they sit on opposite sides — which is exactly the decision this card is about.',
          ],
        },
        {
          ...
          p: [
            ...
            'It is worth seeing one before reading anything more about them. A VAT return is **nine numbered boxes** — that is the whole of it. Below is a completed one for a business with £60,000 of standard-rated sales, £15,000 of zero-rated sales and £35,000 of purchases in the quarter, all figures net of VAT.',
      ...
      cards: [
        ...
        },
        {
          ...
          p: [
            ...
            'The retention period is **' + T.records.retentionYears.value + ' years**. That is deliberately longer than the two periods it has to outlast, both of which run for four years and both of which are covered later: HMRC may normally raise an assessment going back four years (lesson 1F), and an error in a return may normally be corrected within four years (lesson 3A). Six years of records means the evidence still exists when either of those powers is exercised near the end of its window — and where tax has been lost deliberately HMRC may go back twenty years, which is why the retention rule gives a margin rather than an exact match.',
      ...
      cards: [
        ...
        },
        {
          ...
          p: [
            ...
            'The benefit is automatic and continuous. A business that gives its customers 60 days to pay is, under the normal scheme, handing VAT to HMRC on invoices it has not yet been paid for. Under cash accounting that never happens. And if a customer never pays at all, no VAT was ever accounted for — which means **bad debt relief becomes irrelevant** while the business is in the scheme, because there is nothing to relieve. (Bad debt relief is the mechanism, set out in lesson 2E, by which a business on the normal scheme recovers VAT it has already paid over on an invoice the customer never settled.)',
      ...
      cards: [
        ...
        },
        {
          ...
          p: [
            ...
            'That is worth understanding rather than memorising, because it explains why the notification requirement exists at all. It is what lets HMRC see the scale and pattern of errors across the taxpayer population. An error buried in a return is invisible; the same error notified is data.',
