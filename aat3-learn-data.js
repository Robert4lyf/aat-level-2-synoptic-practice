      ...
      cards: [
        ...
        },
        {
          ...
          p: [
            ...
            'What that means in practice is that a number of the figures this unit teaches are **looked up, not recalled**. The fuel scale charges. The flat rate percentages. The partial exemption de minimis limits. The conditions for bad debt relief. The penalty points thresholds and the £' + T.penalties.lateSubmission.penalty.value + ' penalty. The late payment percentages and the days they run from. The interest rate and the Bank of England base rate it is built on. The behaviour tables for errors and for failure to notify.',
      ...
      cards: [
        ...
        },
        {
          ...
          p: [
            ...
            'The rule being applied is that a small net error may be corrected on the next return, while a larger one must be separately notified to HMRC on **form ' + T.errorCorrection.separateNotificationForm + '**. Be precise about what goes wrong when a business adjusts a large error on the next return instead of notifying it, because it is easy to overstate. **No separate penalty is created by the choice of method.** What happens is that the original inaccuracy has still not been disclosed — adjusting a figure inside a later return does not tell HMRC anything, and does not count as disclosure.',
