...
(function (root) {
  ...
  var QUESTIONS = [
    ...
    },
    {
      ...
      opts: [
        '30 December',
        '1 January, being the first day of the second month after',
        '31 December, being one calendar month after the year end',
        '5 December, being within seven days of the month end',
      ],
      ans: 0,
    ...
    },
    {
      ...
      opts: [
        '1 September',
        '1 June, three months after the due date',
        '1 March the following year',
        '1 April, one month after the due date',
      ],
      ans: 0,
    ...
    },
    {
      ...
      opts: [
        ...
        'The net value of goods imported during the period',
        'The net cost of client entertaining, on which input tax was blocked',
    ...
    },
    {
      ...
      opts: [
        ...
        '0%, because the error was careless rather than deliberate',
        '10%, matching the prompted minimum for a late notification',
        '30%, since no reduction applies once HMRC has made an enquiry',
      ],
      ans: 0,
    ...
    },
    {
      ...
      opts: [
        'A P45',
        'A P60, summarising pay and tax to the leaving date',
        'A starter checklist, for the employee to give to their next employer',
        'A P11D, reporting the employment ending',
      ],
      ans: 0,
    ...
    /* ── Outcome 5 — reporting (10%) ───────────────────────────────────── */
    {
      ...
      opts: [
        'Whoever manages the cash, so the funds can be planned for',
        'HMRC, so that the liability is notified before the return is filed',
        'The company’s bank, so that an overdraft can be arranged',
        'Nobody, since the figure will be visible on the return itself',
      ],
      ans: 0,
    ...
    },
    {
      ...
      opts: [
        ...
        'Objectivity, since out-of-date knowledge introduces bias',
        'Professional behaviour, since the law must be complied with',
        'Integrity, since using old figures is a form of dishonesty',
      ],
      ans: 0,
