...
(function (root) {
  ...
  var QUESTIONS = [
       ...
       exit, which left the harder half of 1.5.3 unexamined. */
    {
      ...
      opts: [
        'On 31 May 2028, the last day of the month ' + T.penalties.lateSubmission.pointExpiryMonths.value + ' months on',
        'On 7 May 2028, exactly ' + T.penalties.lateSubmission.pointExpiryMonths.value + ' months from the date the return fell due',
        'On 31 May 2027, the last day of the month 12 months on',
    ...
    {
      id: 'P-1-207', unitKey: 'tpfb', lo: 1, criteria: ['TPFB-1.5.3'],
      type: 'mcq',
      q: 'An annual filer submits a return late that was due on 31 March 2026, and stays below the points threshold. When does the point it earned expire?',
      opts: [
        'On 31 March 2028, the last day of the month ' + T.penalties.lateSubmission.pointExpiryMonths.value + ' months on',
        'On 31 March 2027, the last day of the month 12 months on',
        'On 30 April 2028, the last day of the month ' + T.penalties.lateSubmission.pointExpiryMonthEndMonths.value + ' months on',
