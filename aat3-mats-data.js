...
(function (root) {
  ...
  var QUESTIONS = [
    ...
    {
      id: 'M-1-30', unitKey: 'mats', lo: 1, criteria: ['MATS-1.1.1'],
      type: 'picklist',
      q: 'Identify which purpose of management accounting each activity serves.',
      picklist: {
        title: 'Purpose',
        rowHeader: 'Activity', choiceHeader: 'Purpose',
        options: ['Costing', 'Budgeting', 'Internal reporting'],
        rows: [
          { text: 'Working out what one unit of output costs to make', answer: 0 },
          { text: 'Setting a spending target for each department next year', answer: 1 },
          { text: 'Sending managers a monthly statement of results against plan', answer: 2 },
          { text: 'Deciding the absorption rate for factory overheads', answer: 0 },
          { text: 'Preparing a forecast of cash receipts for the coming quarter', answer: 1 },
        ],
      },
      exp: 'Costing answers what something costs, budgeting sets what it should cost, and internal reporting tells managers how the two compared. The three run in sequence, and a business missing any one of them cannot control what it spends.',
    },
    {
      id: 'M-1-31', unitKey: 'mats', lo: 1, criteria: ['MATS-1.1.2'],
      type: 'mcq',
      q: 'A unit cost used for pricing is overstated by 15%. What is the likely consequence?',
      opts: [
        'Prices are set too high and profitable orders are lost to competitors',
        'Prices are set too low and every sale erodes the margin',
        'The reported profit rises, because costs are carried at a higher value',
        'Nothing, because management accounts are not published',
      ],
      ans: 0,
      exp: 'Pricing from a wrong cost sends the price the same way. Too high loses work the business could profitably have done. That loss never appears in any account, which makes an inaccurate cost expensive in a way nobody sees.',
    },
    {
      id: 'M-1-32', unitKey: 'mats', lo: 1, criteria: ['MATS-1.1.2'],
      type: 'truefalse',
      q: 'Decide whether each statement about management information is correct.',
      statements: [
        { text: 'It has no prescribed format, because no outside party is entitled to it.', answer: true },
        { text: 'It may be produced as often as managers find useful.', answer: true },
        { text: 'Being internal, it need not be accurate.', answer: false },
        { text: 'It is usually forward-looking as well as historical.', answer: true },
      ],
      exp: 'Freedom of format and timing is the point of management accounting, and it is not freedom from accuracy — the decisions it drives are real ones. Being internal removes the audience, never the consequence.',
    },
    {
      id: 'M-1-33', unitKey: 'mats', lo: 1, criteria: ['MATS-1.1.3'],
      type: 'numeric',
      q: 'A product sells for £48. Variable costs are £29 a unit and fixed costs £84,000. If 7,000 units are sold, what is the profit, in pounds?',
      answer: 49000, unit: '£',
      exp: 'Contribution per unit = £48 − £29 = £19. Total contribution = £19 × 7,000 = £133,000. Profit = £133,000 − £84,000 = £49,000. Fixed costs are deducted once from total contribution, never per unit.',
    },
    {
      id: 'M-1-34', unitKey: 'mats', lo: 1, criteria: ['MATS-1.1.4'],
      type: 'numeric',
      q: 'Two products share fixed costs of £60,000. A contributes £52,000 and B contributes £31,000. What is the reported profit, in pounds?',
      answer: 23000, unit: '£',
      exp: '£52,000 + £31,000 − £60,000 = £23,000. Segmented reporting shows each product\'s contribution separately, then charges the shared fixed costs once against the total. Splitting the fixed costs between products would invent a loss neither one made.',
    },
    {
      id: 'M-1-35', unitKey: 'mats', lo: 1, criteria: ['MATS-1.2.1'],
      type: 'picklist',
      q: 'Classify each cost for a furniture manufacturer.',
      picklist: {
        title: 'Product or period',
        rowHeader: 'Cost', choiceHeader: 'Classification',
        options: ['Product cost', 'Period cost'],
        rows: [
          { text: 'Timber used in the frames', answer: 0 },
          { text: 'Wages of the machine operators', answer: 0 },
          { text: 'Rent of the sales showroom', answer: 1 },
          { text: 'Depreciation of factory machinery', answer: 0 },
          { text: 'Salary of the finance director', answer: 1 },
          { text: 'Advertising in a trade magazine', answer: 1 },
        ],
      },
      exp: 'Product costs attach to the goods and sit in inventory until they sell; period costs are charged as the period goes by. The line is the factory door: making costs attach, selling and administration costs do not.',
    },
    {
      id: 'M-1-36', unitKey: 'mats', lo: 1, criteria: ['MATS-1.2.2'],
      type: 'mcq',
      q: 'What is the single difference between marginal and absorption costing?',
      opts: [
        'Whether fixed production overhead is included in the unit cost',
        'Whether variable costs are charged to units at all',
        'Whether selling costs are treated as period costs',
        'Whether the business uses standard or actual costs',
      ],
      ans: 0,
      exp: 'Both charge variable production costs to units and both treat selling and administration as period costs. Only the treatment of fixed PRODUCTION overhead differs: absorption puts it into the unit, marginal leaves it as a period cost.',
    },
    {
      id: 'M-1-37', unitKey: 'mats', lo: 1, criteria: ['MATS-1.2.3'],
      type: 'mcq',
      q: 'Production exceeds sales in a period. How do the two profit figures compare?',
      opts: [
        'Absorption profit is higher, because fixed overhead is carried in closing inventory',
        'Marginal profit is higher, because fixed costs are charged in full',
        'The two are equal, since the same costs are incurred either way',
        'Absorption profit is lower, because more overhead is charged to the period',
      ],
      ans: 0,
      exp: 'Building inventory carries some of this period\'s fixed overhead forward inside it under absorption costing, so less is charged now. Marginal charges every penny of fixed overhead as it arises. When sales exceed production the comparison reverses.',
    },
    {
      id: 'M-1-38', unitKey: 'mats', lo: 1, criteria: ['MATS-1.2.3'],
      type: 'numeric',
      q: 'Fixed production overhead is absorbed at £7 a unit. Production is 12,000 units and sales 10,500. By how much does absorption profit exceed marginal profit, in pounds?',
      answer: 10500, unit: '£',
      exp: 'Inventory rose by 12,000 − 10,500 = 1,500 units, each carrying £7 of fixed overhead forward. 1,500 × £7 = £10,500. The difference between the two profits is always the change in inventory times the fixed overhead per unit.',
    },
    {
      id: 'M-1-39', unitKey: 'mats', lo: 1, criteria: ['MATS-1.2.4'],
      type: 'mcq',
      q: 'Which costing basis suits a decision about accepting a one-off order using spare capacity?',
      opts: [
        'Marginal costing, since only the extra costs change with the decision',
        'Absorption costing, since every cost must eventually be covered',
        'Activity-based costing, since it is the most accurate in all cases',
        'Standard costing, since it removes the effect of price changes',
      ],
      ans: 0,
      exp: 'Fixed overhead is being incurred whether the order is taken or not, so charging a share of it to the decision would reject work that adds contribution. Absorption is the right basis for valuing inventory in the financial statements, which is a different question.',
    },
    {
      id: 'M-1-40', unitKey: 'mats', lo: 1, criteria: ['MATS-1.2.4'],
      type: 'truefalse',
      q: 'Decide whether each statement about when each costing technique is used is correct.',
      statements: [
        { text: 'Inventory in the financial statements must be valued on an absorption basis.', answer: true },
        { text: 'Marginal costing is preferred for short-term decisions.', answer: true },
        { text: 'A business must use the same basis for decisions as for its accounts.', answer: false },
        { text: 'Activity-based costing suits businesses with high and varied overheads.', answer: true },
      ],
      exp: 'IAS 2 requires absorption for reporting, and nothing stops a business running marginal figures internally for decisions. Using one basis for both is a common and expensive habit: the reporting basis answers a question decisions are not asking.',
    },
    {
      id: 'M-1-41', unitKey: 'mats', lo: 1, criteria: ['MATS-1.2.5'],
      type: 'numeric',
      q: 'Direct materials are £18 a unit, direct labour £11, direct expenses £3, variable overhead £4 and fixed overhead £9. What is the prime cost, in pounds?',
      answer: 32, unit: '£',
      exp: '£18 + £11 + £3 = £32. Prime cost is every DIRECT cost and nothing else, so neither overhead belongs in it. Marginal cost would add the variable overhead to give £36, and full absorption cost would add the fixed to give £45.',
    },
    {
      id: 'M-1-42', unitKey: 'mats', lo: 1, criteria: ['MATS-1.2.5'],
      type: 'numeric',
      q: 'Using the same figures — materials £18, labour £11, direct expenses £3, variable overhead £4, fixed overhead £9 — what is the full absorption cost per unit, in pounds?',
      answer: 45, unit: '£',
      exp: '£18 + £11 + £3 + £4 + £9 = £45. Full absorption cost is every production cost, direct and indirect, fixed and variable. The three figures build on each other: prime £32, marginal £36, absorption £45.',
    },
    {
      id: 'M-2-30', unitKey: 'mats', lo: 2, criteria: ['MATS-2.5.1'],
      type: 'picklist',
      q: 'Identify the costing system that suits each business.',
      picklist: {
        title: 'Choosing a costing system',
        rowHeader: 'Business', choiceHeader: 'Costing system',
        options: ['Job costing', 'Batch costing', 'Process costing', 'Service costing'],
        rows: [
          { text: 'A builder pricing individual extensions', answer: 0 },
          { text: 'A bakery producing 500 identical loaves at a time', answer: 1 },
          { text: 'An oil refinery running a continuous flow', answer: 2 },
          { text: 'A firm of solicitors billing client matters', answer: 0 },
          { text: 'A hotel costing a room-night', answer: 3 },
          { text: 'A paint manufacturer blending in continuous vats', answer: 2 },
        ],
      },
      exp: 'The question is what the unit of output actually is. A one-off gets job costing, a group of identical units gets batch, an indistinguishable continuous flow gets process, and an intangible unit of service gets service costing.',
    },
    {
      id: 'M-2-31', unitKey: 'mats', lo: 2, criteria: ['MATS-2.5.1'],
      type: 'mcq',
      q: 'What makes process costing necessary rather than job costing in a chemical plant?',
      opts: [
        'Output is continuous and identical, so no single unit can be traced',
        'The costs involved are higher than in job costing industries',
        'Process costing is required by the accounting standards',
        'Chemical plants do not incur direct labour costs',
      ],
      ans: 0,
      exp: 'Job costing needs an identifiable job to collect costs against. Where output pours out continuously and one litre is indistinguishable from the next, cost has to be averaged over the period\'s output instead.',
    },
    {
      id: 'M-2-32', unitKey: 'mats', lo: 2, criteria: ['MATS-2.5.2'],
      type: 'numeric',
      q: 'A process needs 4,000 kg of good output. Normal loss is 20% of input. How many kg must be input?',
      answer: 5000, unit: 'kg',
      exp: 'If 20% is lost, good output is 80% of input, so input = 4,000 ÷ 0.80 = 5,000 kg. Taking 20% off 4,000 gives 3,200 and is the standard error. The loss is a share of what goes IN, not of what comes out.',
    },
    {
      id: 'M-2-33', unitKey: 'mats', lo: 2, criteria: ['MATS-2.5.2'],
      type: 'mcq',
      q: 'How is the cost of NORMAL loss in a process treated?',
      opts: [
        'Absorbed by the good output, raising its cost per unit',
        'Written off separately as an expense of the period',
        'Charged to the material price variance',
        'Carried forward as work in progress',
      ],
      ans: 0,
      exp: 'Normal loss is an expected, unavoidable part of the process, so what it cost is borne by the units that survive it. Abnormal loss is the one written off separately, precisely because it was not expected.',
    },
    {
      id: 'M-2-34', unitKey: 'mats', lo: 2, criteria: ['MATS-2.5.3'],
      type: 'numeric',
      q: 'A job absorbs direct materials of £2,400, direct labour of 60 hours at £18 an hour, and overhead at £22 per labour hour. What is the total job cost, in pounds?',
      answer: 4800, unit: '£',
      exp: '£2,400 materials + (60 × £18 = £1,080) labour + (60 × £22 = £1,320) overhead = £4,800. Job costing collects every cost against the job, with overhead absorbed on whichever base the business has chosen.',
    },
    {
      id: 'M-2-35', unitKey: 'mats', lo: 2, criteria: ['MATS-2.2.1', 'MATS-2.2.2'],
      type: 'picklist',
      q: 'Identify the entries recording £46,000 of materials issued to production.',
      picklist: {
        title: 'Cost accounting journal',
        rowHeader: 'Entry', choiceHeader: 'Debit or credit',
        options: ['Debit', 'Credit'],
        rows: [
          { text: 'Work in progress, £46,000', answer: 0 },
          { text: 'Materials inventory, £46,000', answer: 1 },
        ],
      },
      exp: 'Issuing materials moves value out of stores and into production, so work in progress is debited and materials inventory credited. Nothing has been bought or paid for here — the cost is simply travelling through the system.',
    },
    {
      id: 'M-2-36', unitKey: 'mats', lo: 2, criteria: ['MATS-2.2.1'],
      type: 'mcq',
      q: 'Which account is credited when finished goods are sold?',
      opts: [
        'Finished goods inventory, with cost of sales debited',
        'Work in progress, with finished goods debited',
        'Cost of sales, with finished goods debited',
        'Materials inventory, with work in progress debited',
      ],
      ans: 0,
      exp: 'The cost follows the goods: stores to work in progress, work in progress to finished goods, finished goods to cost of sales as they leave. Each step debits where the value arrives and credits where it left.',
    },
    {
      id: 'M-2-37', unitKey: 'mats', lo: 2, criteria: ['MATS-2.3.1'],
      type: 'numeric',
      q: 'Usage is 80 units a day, lead time is 12 days and the buffer inventory is 300 units. What is the re-order level, in units?',
      answer: 1260, unit: 'units',
      exp: '(80 × 12) + 300 = 1,260 units. The re-order level covers what will be used while waiting for delivery, plus the buffer held against a late delivery or a heavier-than-usual draw.',
    },
    {
      id: 'M-2-38', unitKey: 'mats', lo: 2, criteria: ['MATS-2.3.2'],
      type: 'numeric',
      q: 'Opening inventory is 200 units at £14. A receipt of 300 units at £19 follows. Under AVCO, what is the cost per unit after the receipt, to the nearest penny?',
      answer: 17, unit: '£',
      exp: '(200 × £14) + (300 × £19) = £2,800 + £5,700 = £8,500 over 500 units = £17.00. AVCO strikes a fresh weighted average after every receipt, so the next issue leaves at £17 whichever batch it physically came from.',
    },
    {
      id: 'M-2-39', unitKey: 'mats', lo: 2, criteria: ['MATS-2.3.2', 'MATS-2.3.3'],
      type: 'mcq',
      q: 'Prices have been rising steadily. How does FIFO compare with AVCO?',
      opts: [
        'FIFO gives a lower cost of sales and a higher closing inventory value',
        'FIFO gives a higher cost of sales and a lower closing inventory value',
        'The two give identical figures whatever prices do',
        'FIFO gives a higher cost of sales and a higher closing inventory value',
      ],
      ans: 0,
      exp: 'FIFO issues the oldest and cheapest units first, so cost of sales is lower and what remains is the newest and dearest. AVCO blends old and new, landing between FIFO and the most recent prices.',
    },
    {
      id: 'M-2-40', unitKey: 'mats', lo: 2, criteria: ['MATS-2.4.1'],
      type: 'picklist',
      q: 'Classify each cost by how it behaves as activity changes.',
      picklist: {
        title: 'Cost behaviour',
        rowHeader: 'Cost', choiceHeader: 'Behaviour',
        options: ['Fixed', 'Variable', 'Semi-variable', 'Stepped fixed'],
        rows: [
          { text: 'Factory insurance for the year', answer: 0 },
          { text: 'Raw materials used in production', answer: 1 },
          { text: 'A phone contract with a standing charge plus a rate per minute', answer: 2 },
          { text: 'Supervisors, one needed for every 20 machine operators', answer: 3 },
          { text: 'Sales commission at 3% of revenue', answer: 1 },
        ],
      },
      exp: 'Fixed costs do not move with activity, variable ones move in proportion, semi-variable have both parts, and stepped fixed costs hold then jump when a capacity threshold is crossed. Knowing which is which is what makes a budget flexible.',
    },
    {
      id: 'M-2-41', unitKey: 'mats', lo: 2, criteria: ['MATS-2.4.2'],
      type: 'numeric',
      q: 'At 9,000 units total cost is £74,000; at 14,000 units it is £94,000. What is the variable cost per unit, in pounds?',
      answer: 4, unit: '£',
      exp: '(£94,000 − £74,000) ÷ (14,000 − 9,000) = £20,000 ÷ 5,000 = £4 a unit. The high-low method attributes the whole change in cost to the change in volume, which is why it only works where the fixed element really did stay fixed.',
    },
    {
      id: 'M-2-42', unitKey: 'mats', lo: 2, criteria: ['MATS-2.4.2'],
      type: 'numeric',
      q: 'Using the same data — £74,000 at 9,000 units and £94,000 at 14,000 units — what is the fixed cost, in pounds?',
      answer: 38000, unit: '£',
      exp: 'Variable cost at 9,000 units = 9,000 × £4 = £36,000, so fixed = £74,000 − £36,000 = £38,000. Checking at the high point gives the same answer: £94,000 − (14,000 × £4) = £38,000.',
    },
    {
      id: 'M-3-30', unitKey: 'mats', lo: 3, criteria: ['MATS-3.1.1'],
      type: 'gapfill',
      q: 'Complete the three stages of overhead recovery.',
      template: 'Overheads that belong wholly to one cost centre are {0} to it. Overheads shared between centres are {1} on a fair basis. Service centre costs are then {2} to the production centres.',
      gaps: [
        { options: ['allocated', 'apportioned', 'absorbed'], answer: 0 },
        { options: ['apportioned', 'allocated', 'absorbed'], answer: 0 },
        { options: ['reapportioned', 'allocated', 'recovered'], answer: 0 },
      ],
      exp: 'Allocation is for a cost that is wholly one centre\'s; apportionment shares one that is not. Reapportionment then clears the service centres, because only production centres make units for overhead to be absorbed into.',
    },
    {
      id: 'M-3-31', unitKey: 'mats', lo: 3, criteria: ['MATS-3.1.1'],
      type: 'picklist',
      q: 'Choose a fair basis on which to share each overhead between centres.',
      picklist: {
        title: 'Apportionment bases',
        rowHeader: 'Overhead', choiceHeader: 'Basis',
        options: ['Floor area', 'Number of employees', 'Carrying amount of machinery', 'Machine hours'],
        rows: [
          { text: 'Factory rent', answer: 0 },
          { text: 'Canteen costs', answer: 1 },
          { text: 'Insurance of plant', answer: 2 },
          { text: 'Heating and lighting', answer: 0 },
          { text: 'Depreciation of machinery', answer: 2 },
          { text: 'Machine maintenance', answer: 3 },
        ],
      },
      exp: 'The basis should track whatever drives the cost. Space-related costs follow floor area, people-related costs follow headcount, and machine-related costs follow the value or the usage of the machines.',
    },
    {
      id: 'M-3-32', unitKey: 'mats', lo: 3, criteria: ['MATS-3.1.2'],
      type: 'numeric',
      q: 'Rent of £96,000 is apportioned by floor area. Production centres occupy 3,000 and 5,000 square metres and stores 2,000. What is charged to the LARGER production centre, in pounds?',
      answer: 48000, unit: '£',
      exp: 'Total area is 3,000 + 5,000 + 2,000 = 10,000 sq m, so the rate is £96,000 ÷ 10,000 = £9.60 a square metre. The 5,000 sq m centre takes 5,000 × £9.60 = £48,000. Stores gets its own share, to be reapportioned afterwards.',
    },
    {
      id: 'M-3-33', unitKey: 'mats', lo: 3, criteria: ['MATS-3.1.2'],
      type: 'numeric',
      q: 'Stores costs of £30,000 are reapportioned on the number of requisitions: production centre A raised 1,800 and B raised 1,200. What is reapportioned to A, in pounds?',
      answer: 18000, unit: '£',
      exp: '1,800 of 3,000 requisitions is 60%, so A takes £30,000 × 60% = £18,000. Reapportionment clears the service centre entirely, because its costs have to end up somewhere that makes units.',
    },
    {
      id: 'M-3-34', unitKey: 'mats', lo: 3, criteria: ['MATS-3.2.1'],
      type: 'numeric',
      q: 'Budgeted overheads for a machine-intensive centre are £252,000 and budgeted machine hours 18,000. What is the overhead absorption rate, in pounds per machine hour?',
      answer: 14, unit: '£',
      exp: '£252,000 ÷ 18,000 = £14 a machine hour. The rate is struck on BUDGETED figures before the year starts, which is exactly why actual overhead almost never equals absorbed overhead.',
    },
    {
      id: 'M-3-35', unitKey: 'mats', lo: 3, criteria: ['MATS-3.2.1'],
      type: 'mcq',
      q: 'Which absorption base best suits a cost centre where work is done largely by hand?',
      opts: [
        'Direct labour hours',
        'Machine hours',
        'Units of output',
      ...
      ans: 0,
      exp: 'The base should follow whatever causes the overhead to be incurred. In a labour-intensive centre the overheads track the time people spend, so labour hours fit. Machine hours would attribute almost nothing to a centre with few machines.',
    },
    {
      id: 'M-3-36', unitKey: 'mats', lo: 3, criteria: ['MATS-3.3.1'],
      type: 'mcq',
      q: 'What is the central idea of activity-based costing?',
      opts: [
        'Overheads are caused by activities, so costs follow what drives each activity',
        'Overheads should be shared equally between all products made',
        'Overheads are charged only to products that use machinery',
        'Overheads are excluded from unit cost and treated as period costs',
      ],
      ans: 0,
      exp: 'A single plant-wide rate assumes volume causes overhead. ABC asks what actually causes each pool — set-ups, inspections, orders — and charges each product by how much of that activity it consumes. Low-volume, fiddly products then stop being subsidised.',
    },
    {
      id: 'M-3-37', unitKey: 'mats', lo: 3, criteria: ['MATS-3.3.1'],
      type: 'picklist',
      q: 'Identify a suitable cost driver for each activity.',
      picklist: {
        title: 'Cost drivers',
        rowHeader: 'Activity', choiceHeader: 'Driver',
        options: ['Number of set-ups', 'Number of purchase orders', 'Number of inspections', 'Number of despatches'],
        rows: [
          { text: 'Machine set-up', answer: 0 },
          { text: 'Purchasing department', answer: 1 },
          { text: 'Quality control', answer: 2 },
          { text: 'Goods outwards', answer: 3 },
        ],
      },
      exp: 'A driver has to be the thing that makes the cost happen. Set-up cost rises with the number of set-ups, not with the units each run produces. That is why short runs look so much dearer under ABC than under a volume-based rate.',
    },
    {
      id: 'M-3-38', unitKey: 'mats', lo: 3, criteria: ['MATS-3.3.2'],
      type: 'numeric',
      q: 'Set-up costs are £84,000 for 280 set-ups in the period. A product requires 15 set-ups and makes 3,000 units. What set-up cost is charged per unit, in pounds?',
      answer: 1.5, unit: '£',
      exp: '£84,000 ÷ 280 = £300 a set-up. The product takes 15 × £300 = £4,500, spread over 3,000 units = £1.50 each. Halving the batch size would double that figure while changing nothing else.',
    },
    {
      id: 'M-3-39', unitKey: 'mats', lo: 3, criteria: ['MATS-3.4.1'],
      type: 'numeric',
      q: 'Overhead is absorbed at £16 a labour hour. Actual hours were 21,500 and actual overhead £338,000. What is the over- or under-absorption, in pounds?',
      answer: 6000, unit: '£',
      exp: 'Absorbed = 21,500 × £16 = £344,000 against actual overhead of £338,000, so £6,000 more was charged to production than was incurred. That is an OVER-absorption, and it is credited to profit or loss because the cost was overstated during the period.',
    },
    {
      id: 'M-3-40', unitKey: 'mats', lo: 3, criteria: ['MATS-3.4.1'],
      type: 'truefalse',
      q: 'Decide whether each statement about under- and over-absorbed overhead is correct.',
      statements: [
        { text: 'Under-absorption is debited to profit or loss.', answer: true },
        { text: 'It arises because the rate is set on budgeted figures in advance.', answer: true },
        { text: 'Over-absorption means the business spent less than it planned to.', answer: false },
        { text: 'Actual hours below budget, with overhead as expected, causes under-absorption.', answer: true },
      ],
      exp: 'Either the activity or the spend can differ from budget, so over-absorption can come from working more hours rather than spending less. Under-absorption means production was undercharged, and the shortfall is debited to put the cost back.',
    },
    {
      id: 'M-3-41', unitKey: 'mats', lo: 3, criteria: ['MATS-3.4.1'],
      type: 'mcq',
      q: 'Budgeted overhead was £400,000 on 20,000 hours. Actual overhead was £400,000 on 18,000 hours. What follows?',
      opts: [
        'Overhead is under-absorbed by £40,000, because fewer hours were worked',
        'Overhead is over-absorbed by £40,000, because spending matched budget',
        'There is neither over- nor under-absorption, since spending was as budgeted',
        'Overhead is under-absorbed by £20,000',
      ],
      ans: 0,
      exp: 'The rate is £400,000 ÷ 20,000 = £20 an hour, so 18,000 hours absorb £360,000 against £400,000 incurred — £40,000 short. Spending exactly on budget is no protection when the activity that carries it falls away.',
    },
    {
      id: 'M-3-42', unitKey: 'mats', lo: 3, criteria: ['MATS-3.2.1', 'MATS-3.4.1'],
      type: 'numeric',
      q: 'A centre budgets overheads of £180,000 and 12,000 labour hours. Actual overhead is £191,000 and actual hours 12,400. What is the under-absorption, in pounds?',
      answer: 5000, unit: '£',
      exp: 'Rate = £180,000 ÷ 12,000 = £15 an hour. Absorbed = 12,400 × £15 = £186,000 against £191,000 incurred, so £5,000 was under-absorbed. The extra hours recovered some of the overspend but not all of it.',
    },
    {
      id: 'M-4-30', unitKey: 'mats', lo: 4, criteria: ['MATS-4.1.1'],
      type: 'mcq',
      q: 'How is a standard cost arrived at?',
      opts: [
        'A planned cost per unit, built from expected quantities and prices',
        'The average cost per unit achieved over the last three years',
        'The lowest cost per unit the business has ever recorded',
        'The cost per unit charged by the cheapest available supplier',
      ],
      ans: 0,
      exp: 'A standard is built rather than observed: so many kilograms at so much a kilogram, so many hours at so much an hour. That construction is what lets a variance be split into a price part and a usage part later.',
    },
    {
      id: 'M-4-31', unitKey: 'mats', lo: 4, criteria: ['MATS-4.1.1', 'MATS-4.1.2'],
      type: 'numeric',
      q: 'A unit needs 3 kg at £6 a kg and 0.5 hours at £14 an hour. What is the standard cost per unit, in pounds?',
      answer: 25, unit: '£',
      exp: '(3 × £6) + (0.5 × £14) = £18 + £7 = £25. Each element carries its own quantity and its own price, which is why a later overspend can be traced to whichever of the two moved.',
    },
    {
      id: 'M-4-32', unitKey: 'mats', lo: 4, criteria: ['MATS-4.1.2'],
      type: 'numeric',
      q: 'The standard cost is £25 a unit and the budget is for 9,400 units. What is the budgeted total cost, in pounds?',
      answer: 235000, unit: '£',
      exp: '£25 × 9,400 = £235,000. A standard cost turns into a budget by multiplying by planned volume. That is exactly the step undone when the budget is flexed to the volume actually achieved.',
    },
    {
      id: 'M-4-33', unitKey: 'mats', lo: 4, criteria: ['MATS-4.1.3'],
      type: 'picklist',
      q: 'Identify the type of budget each description fits.',
      picklist: {
        title: 'Types of budget',
        rowHeader: 'Description', choiceHeader: 'Type',
        options: ['Fixed budget', 'Flexed budget', 'Rolling budget', 'Zero-based budget'],
        rows: [
          { text: 'Set for one planned activity level and left alone', answer: 0 },
          { text: 'Restated for the volume actually achieved', answer: 1 },
          { text: 'Extended by a further quarter as each quarter ends', answer: 2 },
          { text: 'Built from nothing each year, justifying every cost afresh', answer: 3 },
        ],
      },
      exp: 'Only the flexed budget makes a fair comparison with actual results, because it removes the effect of volume differing from plan. The other three differ in how the original budget was built or maintained, not in how it is compared.',
    },
    {
      id: 'M-4-34', unitKey: 'mats', lo: 4, criteria: ['MATS-4.1.4'],
      type: 'mcq',
      q: 'Why does an operating statement compare ACTUAL results against a FLEXED budget rather than the original?',
      opts: [
        'Because volume differences are removed, leaving only performance',
        'Because the original budget is usually prepared incorrectly',
        'Because flexing removes the need to investigate any variance',
        'Because flexing makes every reported variance favourable',
      ],
      ans: 0,
      exp: 'Selling 20% more units makes variable costs rise, and comparing that against a budget built for the old volume reports an overspend nobody caused. Flexing puts both columns on the same volume so what is left is genuine.',
    },
    {
      id: 'M-4-35', unitKey: 'mats', lo: 4, criteria: ['MATS-4.1.5'],
      type: 'numeric',
      q: 'Product A budgets 4,000 units contributing £13 each; product B budgets 2,500 units contributing £21 each. Fixed costs are £68,000. What is the budgeted profit, in pounds?',
      answer: 36500, unit: '£',
      exp: '(4,000 × £13) + (2,500 × £21) = £52,000 + £52,500 = £104,500 contribution, less £68,000 fixed = £36,500. Each product carries its own contribution, and the fixed costs are deducted once from the total.',
    },
    {
      id: 'M-4-36', unitKey: 'mats', lo: 4, criteria: ['MATS-4.1.6'],
      type: 'numeric',
      q: 'A budget for 10,000 units has variable costs of £85,000 and fixed costs of £42,000. Flexed to 11,500 units, what is the TOTAL budgeted cost, in pounds?',
      answer: 139750, unit: '£',
      exp: 'Variable cost per unit = £85,000 ÷ 10,000 = £8.50, so 11,500 × £8.50 = £97,750. Fixed costs stay at £42,000, giving £139,750. Flexing moves only the variable element — flexing the fixed too is the standard mistake.',
    },
    {
      id: 'M-4-37', unitKey: 'mats', lo: 4, criteria: ['MATS-4.2.1'],
      type: 'picklist',
      q: 'Classify each variance.',
      picklist: {
        title: 'Favourable or adverse',
        rowHeader: 'Result', choiceHeader: 'Variance',
        options: ['Favourable', 'Adverse'],
        rows: [
          { text: 'Actual materials cost £4,200 against a flexed budget of £4,600', answer: 0 },
          { text: 'Actual revenue £91,000 against a flexed budget of £88,000', answer: 0 },
          { text: 'Actual labour cost £17,900 against a flexed budget of £16,400', answer: 1 },
          { text: 'Actual overheads £23,000 against a flexed budget of £25,500', answer: 0 },
          { text: 'Actual revenue £64,000 against a flexed budget of £70,000', answer: 1 },
        ],
      },
      exp: 'The test is always the effect on profit, never whether the number rose or fell. Spending less than budget is favourable and earning less than budget is adverse, so revenue and cost read in opposite directions.',
    },
    {
      id: 'M-4-38', unitKey: 'mats', lo: 4, criteria: ['MATS-4.2.2'],
      type: 'numeric',
      q: 'A budget for 8,000 units allows materials of £56,000. Actual production was 9,000 units at a materials cost of £61,200. What is the materials variance against the flexed budget, in pounds?',
      answer: 1800, unit: '£',
      exp: 'Flexed budget = (£56,000 ÷ 8,000) × 9,000 = £7 × 9,000 = £63,000. Actual £61,200 is £1,800 less, so the variance is favourable. Against the ORIGINAL budget it would have looked like a £5,200 overspend.',
    },
    {
      id: 'M-4-39', unitKey: 'mats', lo: 4, criteria: ['MATS-4.2.3'],
      type: 'numeric',
      q: 'Flexed budget contribution is £148,000 and actual contribution £139,600. Fixed costs were budgeted at £90,000 and actually £86,500. What is the total profit variance, in pounds?',
      answer: 4900, unit: '£',
      exp: 'Budgeted profit £148,000 − £90,000 = £58,000. Actual profit £139,600 − £86,500 = £53,100. The difference is £4,900 adverse: an £8,400 adverse contribution variance partly offset by a £3,500 favourable fixed cost variance.',
    },
    {
      id: 'M-4-40', unitKey: 'mats', lo: 4, criteria: ['MATS-4.3.1'],
      type: 'picklist',
      q: 'Identify the most likely cause of each variance.',
      picklist: {
        title: 'Causes of variances',
        rowHeader: 'Variance', choiceHeader: 'Likely cause',
        options: ['A change in the price paid', 'A change in the quantity used', 'A change in efficiency'],
        rows: [
          { text: 'Adverse materials price variance', answer: 0 },
          { text: 'Adverse materials usage variance from higher wastage', answer: 1 },
          { text: 'Favourable labour rate variance from using junior staff', answer: 0 },
          { text: 'Adverse labour efficiency variance from those junior staff', answer: 2 },
        ],
      },
      exp: 'The last two rows are the classic linked pair: cheaper staff produce a favourable rate variance and an adverse efficiency one, and the net effect may be either. That is why variances are read together rather than one at a time.',
    },
    {
      id: 'M-4-41', unitKey: 'mats', lo: 4, criteria: ['MATS-4.3.2'],
      type: 'mcq',
      q: 'Which variance most deserves investigation?',
      opts: [
        'One that is large, growing each month and controllable',
        'The single largest adverse variance in the statement',
        'Any adverse variance at all, regardless of its size',
        'Any variance arising on a cost that is fixed',
      ],
      ans: 0,
      exp: 'Size alone is a poor filter: a big variance on a big cost may be trivial in percentage terms, and one nobody can control cannot be fixed by investigating it. A trend matters more than a single month, because it will not correct itself.',
    },
    {
      id: 'M-4-42', unitKey: 'mats', lo: 4, criteria: ['MATS-4.3.3'],
      type: 'truefalse',
      q: 'Decide whether each response to a persistent adverse materials usage variance is appropriate.',
      statements: [
        { text: 'Establish whether the standard is still realistic.', answer: true },
        { text: 'Check whether a change of supplier has affected material quality.', answer: true },
        { text: 'Revise the standard so the variance disappears from the report.', answer: false },
        { text: 'Review machine maintenance, since worn equipment wastes material.', answer: true },
      ],
      exp: 'An out-of-date standard is a real explanation and worth testing. Changing it purely to remove the variance is different: the waste carries on, and the report that would have shown it has been switched off.',
    },
    {
      id: 'M-5-30', unitKey: 'mats', lo: 5, criteria: ['MATS-5.1.1'],
      type: 'mcq',
      q: 'Why should a data set be laid out with one record per row and one field per column?',
      opts: [
        'Sorting, filtering and formulas all depend on that structure',
        'It is the only layout a spreadsheet will accept',
        'It reduces the size of the file on disk',
        'It prevents the data from being edited by others',
      ],
      ans: 0,
      exp: 'Every tool a spreadsheet offers assumes the tabular shape: a table with merged cells or headings buried in the data defeats sorting and breaks lookups. The layout is not presentation, it is what makes analysis possible.',
    },
    {
      id: 'M-5-31', unitKey: 'mats', lo: 5, criteria: ['MATS-5.1.2'],
      type: 'mcq',
      q: 'Which control most directly prevents a cost centre code being entered that does not exist?',
      opts: [
        'Data validation restricting entry to a defined list',
        'Conditional formatting highlighting unusual values',
        'Protecting the worksheet against changes',
        'Freezing the header row',
      ],
      ans: 0,
      exp: 'Validation stops the bad value at the point of entry, which is the only place it is cheap to stop. Conditional formatting shows a problem after it exists, and the other two help navigation and protection rather than accuracy.',
    },
    {
      id: 'M-5-32', unitKey: 'mats', lo: 5, criteria: ['MATS-5.1.2'],
      type: 'truefalse',
      q: 'Decide whether each statement about reliable spreadsheet data is correct.',
      statements: [
        { text: 'Numbers stored as text are excluded from SUM without any warning.', answer: true },
        { text: 'A lookup against a misspelled name returns an error or the wrong row.', answer: true },
        { text: 'Data imported from another system needs no checking.', answer: false },
        { text: 'Trailing spaces can stop two identical-looking codes from matching.', answer: true },
      ],
      exp: 'The dangerous faults are the silent ones. A total that quietly omits the text-formatted rows looks perfectly ordinary, and imported data is exactly where type and spacing problems arrive.',
    },
    {
      id: 'M-5-33', unitKey: 'mats', lo: 5, criteria: ['MATS-5.1.3'],
      type: 'mcq',
      q: 'What does applying a NUMBER format to a cell change?',
      opts: [
        'How the value is displayed, leaving the stored value untouched',
        'The stored value, rounding it to the displayed precision',
        'Whether the cell can be included in a formula',
        'The order in which the column will sort',
      ],
      ans: 0,
      exp: 'Formatting is presentation only: a cell showing £1,235 may hold 1,234.56, and a total of the column will use the stored figures. That is why a column of rounded-looking numbers can appear not to add up.',
    },
    {
      id: 'M-5-34', unitKey: 'mats', lo: 5, criteria: ['MATS-5.2.1'],
      type: 'mcq',
      q: 'Which function totals only the rows belonging to one cost centre?',
      opts: [
        'SUMIF',
        'SUM',
        'COUNTIF',
      ...
      ans: 0,
      exp: 'SUMIF adds the values whose row meets a condition. SUM adds everything given to it, COUNTIF counts rather than totals, and VLOOKUP retrieves a single value rather than aggregating a set.',
    },
    {
      id: 'M-5-35', unitKey: 'mats', lo: 5, criteria: ['MATS-5.2.1'],
      type: 'mcq',
      q: 'A formula copied down a column must always refer to the rate in cell B1. How should B1 be written?',
      opts: [
        'As an absolute reference, $B$1',
        'As a relative reference, B1',
        'As a mixed reference, B$1',
        'As a named range that changes with each row',
      ],
      ans: 0,
      exp: 'A relative reference shifts as the formula is copied, so row 2 would read B2 and row 3 B3 — usually empty, giving a column of zeros. The dollar signs lock the reference so every row uses the same rate.',
    },
    {
      id: 'M-5-36', unitKey: 'mats', lo: 5, criteria: ['MATS-5.2.2'],
      type: 'mcq',
      q: 'What does a pivot table do that a sorted list does not?',
      opts: [
        'Summarises by chosen categories, recalculating as the layout changes',
        'Prevents the underlying data from being altered',
        'Guarantees the underlying data is accurate',
        'Converts text entries into numbers automatically',
      ],
      ans: 0,
      exp: 'A pivot table aggregates: totals by product, by month, by centre, rearranged as the question changes. Sorting only reorders rows. It reports whatever the data says, so it neither protects nor validates it.',
    },
    {
      id: 'M-5-37', unitKey: 'mats', lo: 5, criteria: ['MATS-5.2.3'],
      type: 'mcq',
      q: 'New rows are added at the bottom of a data range, and the total above them does not change. What is the likely cause?',
      opts: [
        'The SUM refers to a fixed range that stops short of the new rows',
        'The new rows were entered in the wrong order',
        'The worksheet needs to be saved before totals update',
        'The new values are negative and cancel out',
      ],
      ans: 0,
      exp: 'A hardcoded range keeps adding exactly what it was told to add. The total looks fine and is quietly wrong, which is why converting the range into a table — so it extends itself — is worth the small effort.',
    },
    {
      id: 'M-5-38', unitKey: 'mats', lo: 5, criteria: ['MATS-5.2.3'],
      type: 'truefalse',
      q: 'Decide whether each statement about updating a spreadsheet model is correct.',
      statements: [
        { text: 'Inserting a row inside a summed range extends the total automatically.', answer: true },
        { text: 'Deleting a column a formula refers to produces a reference error.', answer: true },
        { text: 'Overtyping a formula with a number is visible at a glance.', answer: false },
        { text: 'Assumptions are best held in one place and referenced from there.', answer: true },
      ],
      exp: 'A hardcoded figure sitting where a formula should be looks exactly like the formula\'s answer and is the hardest error in a model to find. Keeping assumptions in one labelled block makes both changing and checking them possible.',
    },
    {
      id: 'M-5-39', unitKey: 'mats', lo: 5, criteria: ['MATS-5.2.4'],
      type: 'mcq',
      q: 'Which auditing tool shows which cells a formula draws its values from?',
      opts: [
        'Trace precedents',
        'Trace dependents',
        'Conditional formatting',
      ...
      ans: 0,
      exp: 'Precedents are what a formula reads; dependents are what reads it. Following precedents back is how a wrong answer is traced to the input that caused it, and following dependents forward shows what a change will affect.',
    },
    {
      id: 'M-5-40', unitKey: 'mats', lo: 5, criteria: ['MATS-5.2.4'],
      type: 'picklist',
      q: 'Identify what each spreadsheet error indicates.',
      picklist: {
        title: 'Error values',
        rowHeader: 'Error', choiceHeader: 'Meaning',
        options: ['A reference has been deleted', 'A value could not be found', 'A number was divided by zero', 'The wrong type of value was used'],
        rows: [
          { text: '#REF!', answer: 0 },
          { text: '#N/A', answer: 1 },
          { text: '#DIV/0!', answer: 2 },
      ...
      exp: 'Each names its own cause. #N/A from a lookup usually means the key is not there, or is there with different spacing. Hiding it behind IFERROR turns a visible question into an invisible one.',
    },
    {
      id: 'M-5-41', unitKey: 'mats', lo: 5, criteria: ['MATS-5.3.1'],
      type: 'mcq',
      q: 'A model is shared with managers who should enter data but not alter the calculations. What achieves that?',
      opts: [
        'Unlock the input cells, then protect the worksheet',
        'Protect the worksheet, which leaves input cells editable by default',
        'Hide the formula rows from view',
        'Save the file in a read-only folder',
      ],
      ans: 0,
      exp: 'Every cell is locked by default, and locking only takes effect once the sheet is protected. So the order matters: unlock the cells people must use, then protect, and everything else becomes read-only.',
    },
    {
      id: 'M-5-42', unitKey: 'mats', lo: 5, criteria: ['MATS-5.3.2'],
      type: 'truefalse',
      q: 'Decide whether each presentation choice helps a manager read a management report.',
      statements: [
        { text: 'Conditional formatting flagging variances above a threshold.', answer: true },
        { text: 'Consistent number formats, with thousands separated.', answer: true },
        { text: 'A different colour scheme on every worksheet.', answer: false },
        { text: 'Column headings frozen so they stay visible when scrolling.', answer: true },
      ],
      exp: 'Presentation earns its place by drawing the eye to what matters and keeping the reader oriented. Colour used decoratively does the opposite: once everything is highlighted, the highlighting has stopped meaning anything.',
    },
    {
      id: 'M-5-43', unitKey: 'mats', lo: 5, criteria: ['MATS-5.1.3', 'MATS-5.3.2'],
      type: 'mcq',
      q: 'A variance column is formatted to show adverse figures in red. What is the main benefit?',
      opts: [
        'The exceptions are found without reading every row',
        'The underlying data becomes more accurate',
        'The figures are protected from being changed',
        'The report will print on fewer pages',
      ],
      ans: 0,
      exp: 'Management by exception depends on the exceptions being visible. Formatting is how a long report becomes scannable — and it changes nothing about the numbers themselves, which is worth remembering when a red cell looks like a finding.',
    },
    {
      id: 'M-6-30', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.1'],
      type: 'numeric',
      q: 'A product sells for £62 with variable costs of £38. What is the contribution to sales ratio, as a percentage to one decimal place?',
      answer: 38.7, unit: '%',
      exp: 'Contribution = £62 − £38 = £24, and £24 ÷ £62 × 100 = 38.7%. The ratio says what share of every pound of revenue is left to cover fixed costs, which is what makes products of different prices comparable.',
    },
    {
      id: 'M-6-31', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.1'],
      type: 'mcq',
      q: 'Why is contribution rather than profit used for short-term decisions?',
      opts: [
        'Fixed costs do not change with the decision, so only contribution moves',
        'Contribution is always larger, which makes options look more attractive',
        'Profit cannot be calculated for a single product',
        'Fixed costs are excluded from the financial statements',
      ],
      ans: 0,
      exp: 'A decision should turn on what it actually changes. In the short term the rent is paid either way. Charging a share of it to each option distorts the comparison, and can reject work that leaves the business better off.',
    },
    {
      id: 'M-6-32', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.2'],
      type: 'picklist',
      q: 'Identify whether each cost is relevant to a decision about accepting a special order.',
      picklist: {
        title: 'Relevant costs',
        rowHeader: 'Cost', choiceHeader: 'Relevant?',
        options: ['Relevant', 'Not relevant'],
        rows: [
          { text: 'Materials bought specially for the order', answer: 0 },
          { text: 'Overtime that will be worked only if the order is accepted', answer: 0 },
          { text: 'A market research report already commissioned and paid for', answer: 1 },
          { text: 'Contribution lost on regular work displaced by the order', answer: 0 },
          { text: 'Depreciation of machinery already owned', answer: 1 },
        ],
      },
      exp: 'A relevant cost is a FUTURE CASH FLOW that CHANGES because of the decision. Money already spent is gone whatever is decided, and depreciation is an allocation rather than a cash flow. Displaced contribution is a real opportunity cost and counts.',
    },
    {
      id: 'M-6-33', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.2'],
      type: 'mcq',
      q: 'Material costing £9,000 is in inventory, has no alternative use and would otherwise be scrapped for £600. What is its relevant cost for a new order?',
      opts: [
        '£600, the scrap proceeds given up by using it',
        '£9,000, the amount originally paid for it',
        'Nil, because it has already been bought',
        '£9,600, the cost plus the scrap value forgone',
      ],
      ans: 0,
      exp: 'The £9,000 is sunk. Using the material on this order gives up the £600 the business would otherwise have received, and that forgone receipt is the real cost of consuming it here.',
    },
    {
      id: 'M-6-34', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.3'],
      type: 'numeric',
      q: 'Fixed costs are £174,000 and contribution per unit is £29. What is the break-even point, in units?',
      answer: 6000, unit: 'units',
      exp: '£174,000 ÷ £29 = 6,000 units. At that volume total contribution exactly covers fixed costs and profit is nil. Every unit after it adds £29 straight to profit.',
    },
    {
      id: 'M-6-35', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.3'],
      type: 'numeric',
      q: 'Fixed costs are £96,000, contribution per unit £16, and the target profit is £40,000. How many units must be sold?',
      answer: 8500, unit: 'units',
      exp: '(£96,000 + £40,000) ÷ £16 = 8,500 units. A target profit is treated exactly like additional fixed cost: the contribution has to cover both before the target is met.',
    },
    {
      id: 'M-6-36', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.3'],
      type: 'numeric',
      q: 'Break-even is 6,000 units and budgeted sales are 7,500 units. What is the margin of safety, as a percentage to one decimal place?',
      answer: 20, unit: '%',
      exp: 'The margin is 7,500 − 6,000 = 1,500 units, and 1,500 as a share of 7,500 budgeted sales is 20.0%. Sales can fall by a fifth before the business stops making a profit. Expressed as a percentage it compares across businesses of different sizes.',
    },
    {
      id: 'M-6-37', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.4'],
      type: 'mcq',
      q: 'A break-even chart is drawn. What does the gap between the total revenue line and the total cost line represent to the RIGHT of break-even?',
      opts: [
        'Profit at that level of activity',
        'Contribution at that level of activity',
        'The margin of safety',
        'Fixed costs',
      ],
      ans: 0,
      exp: 'Revenue less TOTAL cost is profit, and total cost already includes the fixed element. Contribution is the gap between revenue and VARIABLE cost, which is a different and wider gap on the same chart.',
    },
    {
      id: 'M-6-38', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.4'],
      type: 'truefalse',
      q: 'Decide whether each assumption underlying cost-volume-profit analysis is correct.',
      statements: [
        { text: 'Selling price per unit stays constant across the range considered.', answer: true },
        { text: 'Costs can be separated cleanly into fixed and variable elements.', answer: true },
        { text: 'The analysis holds for any volume, however large.', answer: false },
        { text: 'For a multi-product business, the sales mix stays constant.', answer: true },
      ],
      exp: 'CVP holds within the relevant range and no further: outside it, discounts appear, extra supervisors are hired and the straight lines stop being straight. Treating a break-even chart as valid at any volume is where it misleads.',
    },
    {
      id: 'M-6-39', unitKey: 'mats', lo: 6, criteria: ['MATS-6.2.1'],
      type: 'mcq',
      q: 'Output rises from 8,000 to 10,000 units with fixed costs unchanged. What happens to the FIXED cost per unit?',
      opts: [
        'It falls, because the same total is spread over more units',
        'It rises, because more units consume more capacity',
        'It stays the same, because the cost is fixed',
        'It falls in total but stays the same per unit',
      ],
      ans: 0,
      exp: 'Fixed means fixed in TOTAL, not per unit. £80,000 over 8,000 units is £10 each; over 10,000 it is £8. That fall is the whole of the benefit volume brings, and it is where exam questions most often catch people out.',
    },
    {
      id: 'M-6-40', unitKey: 'mats', lo: 6, criteria: ['MATS-6.2.1'],
      type: 'truefalse',
      q: 'Decide whether each statement about changing activity levels is correct.',
      statements: [
        { text: 'Variable cost per unit stays the same as volume rises.', answer: true },
        { text: 'Total variable cost rises in proportion to volume.', answer: true },
        { text: 'Total fixed cost rises as volume rises within the relevant range.', answer: false },
        { text: 'Profit per unit rises as volume rises, with price unchanged.', answer: true },
      ],
      exp: 'Variable costs behave the opposite way round to fixed ones: constant per unit and rising in total, where fixed are constant in total and falling per unit. Profit per unit rises because the fixed element inside it is shrinking.',
    },
    {
      id: 'M-6-41', unitKey: 'mats', lo: 6, criteria: ['MATS-6.2.2'],
      type: 'numeric',
      q: 'Price is £40, variable cost £26 and fixed costs £126,000 on sales of 12,000 units. If a £3 price cut lifts volume to 15,000 units, what is the new profit, in pounds?',
      answer: 39000, unit: '£',
      exp: 'New contribution per unit = £37 − £26 = £11, so 15,000 × £11 = £165,000, less £126,000 = £39,000. The old profit was (12,000 × £14) − £126,000 = £42,000, so the extra volume did not pay for the price cut.',
    },
    {
      id: 'M-6-42', unitKey: 'mats', lo: 6, criteria: ['MATS-6.2.2'],
      type: 'numeric',
      q: 'Contribution per unit is £18 and fixed costs £108,000. If fixed costs rise by £27,000, by how many units must sales rise to hold profit steady?',
      answer: 1500, unit: 'units',
      exp: '£27,000 ÷ £18 = 1,500 units. Any increase in fixed costs has to be recovered by extra contribution, and the number of units needed is simply the increase divided by the contribution each unit brings.',
    },
    {
      id: 'M-7-30', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.1'],
      type: 'picklist',
      q: 'Identify whether each item affects profit, cash, or both.',
      picklist: {
        title: 'Cash against profit',
        rowHeader: 'Item', choiceHeader: 'Affects',
        options: ['Profit only', 'Cash only', 'Both'],
        rows: [
          { text: 'Depreciation charged for the year', answer: 0 },
          { text: 'The owner introducing capital', answer: 1 },
          { text: 'A cash sale', answer: 2 },
          { text: 'Repaying the principal of a loan', answer: 1 },
          { text: 'Buying a machine for cash', answer: 1 },
          { text: 'Paying wages for the month', answer: 2 },
        ],
      },
      exp: 'Depreciation is a charge with no cash behind it; capital, loan principal and asset purchases move cash without touching profit. A profitable business can still run out of money, and that gap is what a cash budget exists to show.',
    },
    {
      id: 'M-7-31', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.1'],
      type: 'mcq',
      q: 'A business is profitable but keeps running short of cash. Which explanation fits best?',
      opts: [
        'It sells on credit and collects more slowly than it pays out',
        'Its depreciation charge has been set far too high',
        'It is making a loss on every single sale it makes',
        'Its fixed costs are higher than its variable costs',
      ],
      ans: 0,
      exp: 'Profit is recognised at the invoice and cash arrives when the customer pays. A business growing on credit funds that gap itself, which is why rapid growth is a common cause of running out of money while trading profitably.',
    },
    {
      id: 'M-7-32', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.2'],
      type: 'numeric',
      q: 'Sales are £60,000 in May and £72,000 in June. Half is collected in the month of sale and half the month after. What is collected in June, in pounds?',
      answer: 66000, unit: '£',
      exp: '(£72,000 × 50%) + (£60,000 × 50%) = £36,000 + £30,000 = £66,000. A receipts forecast lags the sales it comes from, so each month draws on more than one month of trading.',
    },
    {
      id: 'M-7-33', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.3'],
      type: 'picklist',
      q: 'Identify the funding method each description fits.',
      picklist: {
        title: 'Funding non-current assets',
        rowHeader: 'Description', choiceHeader: 'Method',
        options: ['Outright purchase', 'Hire purchase', 'Finance lease', 'Operating lease'],
        rows: [
          { text: 'Paid for in full from the business\'s own funds', answer: 0 },
          { text: 'Instalments, with ownership passing at the end', answer: 1 },
          { text: 'Substantially all the risks and rewards pass to the lessee', answer: 2 },
          { text: 'Short-term rental, with the asset returned to the owner', answer: 3 },
        ],
      },
      exp: 'The distinction turns on who carries the risks and rewards of owning the asset. Hire purchase ends in ownership, a finance lease transfers the substance of it without the title, and an operating lease is renting.',
    },
    {
      id: 'M-7-34', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.4'],
      type: 'mcq',
      q: 'A business needs a specialist machine for a two-year contract and expects it to be obsolete after that. Which funding suits best?',
      opts: [
        'An operating lease, returning the asset when the contract ends',
        'Outright purchase, giving the lowest total cost',
        'Hire purchase, so the business owns it at the end',
        'A long-term bank loan secured on the machine',
      ],
      ans: 0,
      exp: 'Owning an asset the business will not want is the risk here, and an operating lease places obsolescence with the lessor. Outright purchase may cost least overall and still be wrong when the asset has no value at the end of the job.',
    },
    {
      id: 'M-7-35', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.4'],
      type: 'truefalse',
      q: 'Decide whether each statement about choosing a funding method is correct.',
      statements: [
        { text: 'Outright purchase avoids interest but uses cash the business may need.', answer: true },
        { text: 'Hire purchase spreads the cost but usually costs more in total.', answer: true },
        { text: 'Leasing always works out cheaper than buying.', answer: false },
        { text: 'The choice should consider how long the asset will be useful.', answer: true },
      ],
      exp: 'Spreading payments has a price, and paying up front has an opportunity cost. Neither is universally cheaper: the right answer depends on how long the asset is needed and what else the cash could be doing.',
    },
    {
      id: 'M-7-36', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.5'],
      type: 'numeric',
      q: 'Current assets are £186,000, inventory £74,000 and current liabilities £80,000. What is the quick ratio, to two decimal places?',
      answer: 1.4, unit: ':1',
      exp: '(£186,000 − £74,000) ÷ £80,000 = £112,000 ÷ £80,000 = 1.40:1. The quick ratio strips out inventory because it has still to be sold and then collected before it becomes cash.',
    },
    {
      id: 'M-7-37', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.5'],
      type: 'mcq',
      q: 'A current ratio has risen from 1.8 to 3.4 over two years. What is the most cautious reading?',
      opts: [
        'Liquidity may have improved, or cash may be tied up in slow inventory',
        'Liquidity has definitely improved and the business is stronger',
        'The business is close to insolvency',
        'The ratio has been calculated incorrectly',
      ],
      ans: 0,
      exp: 'A rising ratio is not automatically good news. Unsold inventory and uncollected receivables both push it up while the cash position gets worse, so the components matter more than the ratio itself.',
    },
    {
      id: 'M-7-38', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.6'],
      type: 'numeric',
      q: 'Inventory days are 58, receivables days 47 and payables days 39. What is the working capital cycle, in days?',
      answer: 66, unit: 'days',
      exp: '58 + 47 − 39 = 66 days. That is how long cash is tied up between paying for goods and collecting for them. Payables are subtracted because the supplier is funding part of the cycle.',
    },
    {
      id: 'M-7-39', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.8'],
      type: 'numeric',
      q: 'Inventory is £96,000 and cost of sales £584,000. What are the inventory holding days, to the nearest day?',
      answer: 60, unit: 'days',
      exp: '£96,000 ÷ £584,000 × 365 = 60 days. Inventory is compared with COST of sales rather than revenue, because both figures are then measured at cost and the ratio means something.',
    },
    {
      id: 'M-7-40', unitKey: 'mats', lo: 7, criteria: ['MATS-7.2.1'],
      type: 'mcq',
      q: 'Why can a business fail while still reporting a profit?',
      opts: [
        'Debts fall due in cash, and profit is not cash',
        'Profit is always overstated in management accounts',
        'Creditors are entitled to be paid out of profit before tax',
        'Reported profit excludes the cost of goods sold',
      ],
      ans: 0,
      exp: 'Suppliers, staff and lenders all want money rather than a share of a reported figure. A business that cannot pay on the day stops trading whatever its statement of profit or loss says, which is why liquidity is a survival question.',
    },
    {
      id: 'M-7-41', unitKey: 'mats', lo: 7, criteria: ['MATS-7.2.2', 'MATS-7.2.3'],
      type: 'picklist',
      q: 'Classify each action by how quickly it improves cash.',
      picklist: {
        title: 'Improving cash',
        rowHeader: 'Action', choiceHeader: 'Effect',
        options: ['Improves cash quickly', 'Improves cash over time', 'Does not improve cash'],
        rows: [
          { text: 'Chasing overdue customer balances', answer: 0 },
          { text: 'Selling surplus equipment', answer: 0 },
          { text: 'Negotiating longer payment terms with suppliers', answer: 1 },
          { text: 'Reducing the depreciation rate on machinery', answer: 2 },
          { text: 'Cutting slow-moving inventory lines', answer: 1 },
        ],
      },
      exp: 'Collecting what is owed and selling what is not needed bring money in now. Terms and inventory take time to work through. Changing the depreciation rate alters reported profit and moves no cash at all.',
    },
    {
      id: 'M-7-42', unitKey: 'mats', lo: 7, criteria: ['MATS-7.2.4'],
      type: 'truefalse',
      q: 'Decide whether each statement about software and cash management is correct.',
      statements: [
        { text: 'Automated reminders can shorten the time customers take to pay.', answer: true },
        { text: 'A cash flow dashboard can show the forecast position as it changes.', answer: true },
        { text: 'Software removes the need to check the assumptions in a forecast.', answer: false },
        { text: 'Bank feeds keep the cash position current without manual entry.', answer: true },
      ],
      exp: 'Automation shortens the delay between something happening and somebody seeing it, which is most of the value. The assumptions behind a forecast — collection patterns, seasonality, a large order landing — are still judgements, and a confident chart does not test them.',
    },
    {
    ...
    /* ── Written tasks ──────────────────────────────────────────────────────
       MATS is partially human marked, and this is the shape that half takes.
       Every one of these sits on a criterion that asks the reader to report,
       explain or advise — not on one that asks them to calculate. */
    {
      id: 'M-1-27', unitKey: 'mats', lo: 1, criteria: ['MATS-1.1.4', 'MATS-1.2.3'],
      type: 'written', minWords: 70,
      setup: 'Barrow Joinery makes three ranges. The segmented statement you have prepared shows contribution for each range and then stops, with the fixed costs shown once at the foot of the total column. The sales director has asked why you have not gone on to show a profit for each range, since "that is the number I actually need".',
      q: 'Reply to the sales director. Explain why the statement stops at contribution, and say what the figure they have asked for would and would not tell them.',
      rubric: [
        { point: 'States that contribution is a fact about the range: its own revenue less its own variable costs', marks: 2 },
        { point: 'Explains that a profit per range needs the shared fixed costs apportioned between them', marks: 2 },
        { point: 'Makes the point that the apportionment is a choice, so the profit figure changes with the method while nothing about the business changes', marks: 2 },
        { point: 'Warns that a range showing an apportioned loss may still be worth making, because dropping it removes the contribution and leaves the fixed costs behind', marks: 2 },
      ],
      modelAnswer: 'The statement stops at contribution because contribution is the only figure that belongs to a range on its own. It is that range\'s revenue less the costs that exist only because the range was made and sold, so it is a fact about the range rather than an opinion about the business.\n\nA profit for each range needs something more: the fixed costs the three ranges share — the workshop rent, the supervisor, the insurance — split between them. There is no correct way to do that split. Floor area, machine hours, headcount and sales value would all be defensible and would all give a different answer, so the profit per range would move every time we changed the basis while nothing about the ranges had changed at all.\n\nThat matters most when a range looks unprofitable. If we apportion fixed costs and one range shows a loss, the instinct is to drop it. But dropping it removes its contribution while leaving the fixed costs exactly where they were, to be carried by the two that remain — so a range that appeared to lose money can take the whole business down with it when it goes.\n\nI can produce a profit per range if it is useful for a particular decision, provided the basis is stated on the face of it. What I would not do is set the ranges against each other on that figure.',
      exp: 'Two things have to be said and the second is the one that carries the marks. The first is what contribution is; the second is why the figure below it is a product of the apportionment rather than of the range. A reply that only defines contribution has answered a different question — the director already knows they want profit, and what they need to hear is what a profit per range would actually be measuring.',
    },
    {
      id: 'M-2-27', unitKey: 'mats', lo: 2, criteria: ['MATS-2.3.1', 'MATS-2.3.2'],
      type: 'written', minWords: 60,
      setup: 'Redmayne Plastics switched to a cheaper grade of polymer three months ago. The purchase price is 8% lower. Since the switch, the stores record shows more frequent orders, the process has produced more scrap, and two production runs have been stopped to clear blocked machinery. The operations manager says the change has saved money because the invoices are smaller.',
      q: 'Write a short note to the operations manager setting out why the cheaper polymer may not have saved anything, and what evidence would settle it.',
      rubric: [
        { point: 'Accepts the point that the purchase price is genuinely lower, rather than arguing with it', marks: 1 },
        { point: 'Explains that more scrap means more kilograms bought for the same good output, so the cost per GOOD unit is what matters', marks: 2 },
        { point: 'Names at least one cost outside the invoice: stopped runs, lost output, more frequent ordering', marks: 2 },
        { point: 'Proposes a specific comparison — cost per good unit before and after the switch, on the same output', marks: 2 },
      ],
      modelAnswer: 'You are right that the invoices are smaller. The purchase price of the polymer genuinely is 8% lower a kilogram, and that saving is real — I am not arguing with it.\n\nThe difficulty is that the invoice is not the whole cost. If the cheaper grade produces more scrap, we are buying more kilograms to get the same number of good units out of the process — so the price per kilogram has fallen while the cost per good unit may not have. That is the figure the business actually pays.\n\nThere are costs beyond the material as well. Two runs have been stopped to clear blocked machinery, which is labour paid for and output not made, and we are ordering more often, so the ordering cost has risen with it.\n\nWhat would settle this is a comparison on the same basis: total material cost divided by good units produced, for a month before the switch and a month after, with the stopped runs valued at the output they cost us. If the cost per good unit has fallen, the change has worked and we should say so. If it has risen, the 8% has been spent twice over and we should go back.',
      exp: 'The trap in this task is arguing with the manager rather than with the arithmetic. The price per kilogram really has fallen, and a note that disputes it loses the reader on the first line. What has to be established is that the price of an input and the cost of an output are different measurements — and then a specific test that would settle which of them moved.',
    },
    {
      id: 'M-3-27', unitKey: 'mats', lo: 3, criteria: ['MATS-3.1.2', 'MATS-3.4.1'],
      type: 'written', minWords: 70,
      setup: 'The Finishing department manager has seen this month\'s cost report. Their department\'s overhead has risen by £6,400 although nothing in the department has changed: the same people, the same machines, the same hours. Two things did change elsewhere — the stores department took on an extra storekeeper, and the factory\'s insurance premium rose at renewal.',
      q: 'Explain to the Finishing manager why their department\'s overhead has risen, and what part of it they can and cannot be held responsible for.',
      rubric: [
        { point: 'Explains that service centre costs are reapportioned into production departments, so a rise in stores reaches Finishing', marks: 2 },
        { point: 'Explains that an apportioned cost such as insurance is shared on a basis, so Finishing carries a share of any increase', marks: 2 },
        { point: 'Distinguishes clearly between costs the manager controls and costs charged to them', marks: 2 },
        { point: 'Suggests something constructive — reporting controllable and apportioned costs separately, or reviewing the basis', marks: 1 },
      ],
      modelAnswer: 'Nothing has gone wrong in Finishing. The increase has come from two costs that arise outside the department and are charged into it.\n\nThe first is stores. Stores is a service centre: it makes nothing itself, so its costs are reapportioned into the production departments that use it, Finishing among them. Taking on another storekeeper raises the stores total, and Finishing carries its share of that total in proportion to the requisitions it draws.\n\nThe second is the insurance premium. Factory insurance covers the whole building and is apportioned between departments on floor area. Finishing occupies the same floor area as last month, but the cost being shared is larger, so its share is larger too.\n\nNeither of those is something you decide. What you control is the overhead that is allocated to Finishing directly — your own supervision, your consumables, your machine running costs — and those are unchanged, which is the point worth making back to the report.\n\nThe report would be more useful if it separated the two: controllable cost first, apportioned cost below it. I will raise that. If you think requisitions or floor area no longer describe how Finishing actually uses stores or space, that basis is worth revisiting too.',
      exp: 'This is the interpretation task that Outcome 3 keeps setting up and never quite asks for. Allocation, apportionment and reapportionment are usually practised as arithmetic; here they are the explanation, and the mark that matters is the one for separating what the manager controls from what is charged to them. A report that holds somebody responsible for a premium renewal is a report nobody acts on.',
    },
    {
      id: 'M-4-27', unitKey: 'mats', lo: 4, criteria: ['MATS-4.3.1', 'MATS-4.3.2', 'MATS-4.3.3'],
      type: 'written', minWords: 90,
      setup: 'Kelling Castings has flexed its budget to the 9,200 units it actually made. Against that flexed budget the month shows: sales price £5,200 adverse; direct materials £4,100 adverse; direct labour £2,700 favourable; variable overhead £900 adverse; fixed overhead £600 adverse. Two things are known. Purchasing moved to a cheaper supplier at the start of the month. A process change in the machine shop removed a hand-finishing step.',
      q: 'Write a short report to the production manager on the month. Give the net position, name the likely cause of the significant variances, and recommend what should be done.',
      rubric: [
        { point: 'States the net variance and its direction: £8,100 adverse', marks: 2 },
        { point: 'Identifies the sales price variance as the largest single item at £5,200', marks: 1 },
        { point: 'Connects the adverse material variance to the change of supplier, and says the price saving has been more than lost', marks: 2 },
        { point: 'Notes that the favourable labour variance comes from the process change and is a genuine, separate saving', marks: 2 },
        { point: 'Makes a specific recommendation about the material — test the yield, or return to the previous supplier', marks: 2 },
        { point: 'Makes a specific recommendation about the discounting — establish whether it bought enough volume to be worth £5,200', marks: 1 },
      ],
      modelAnswer: 'Report to the production manager — variances for the month\n\nThe month was £8,100 adverse against the flexed budget. Four variances were adverse and totalled £10,800; one was favourable at £2,700.\n\nThe largest single item is the sales price variance of £5,200 adverse. Volume has already been taken out by flexing, so this is entirely price: the units were sold for less each than the standard assumed.\n\nMaterials were £4,100 adverse. That is the month purchasing moved to a cheaper supplier, so the price paid should have improved rather than worsened — which points to usage. The likely reading is that the cheaper material is being wasted, and that the saving on the invoice has been more than lost in what is being scrapped.\n\nLabour was £2,700 favourable. This looks like a genuine and separate saving: the process change in the machine shop removed a hand-finishing step, and fewer hours are being worked on the same output. It is worth confirming that quality has not fallen with it, but on the face of it this one is good news and should be kept.\n\nVariable overhead at £900 adverse and fixed overhead at £600 adverse are small and neither has an obvious cause. I would not spend time on either this month, but I would watch whether they repeat.\n\nRecommendations. First, measure the yield of the new material against the old on a controlled run, and if the yield is worse, go back to the previous supplier — the invoice price is not the cost. Second, establish what the discounting actually bought: if the extra volume it won is worth less than £5,200 of contribution, the price should go back up.',
      exp: 'The report is graded on three things and only one of them is arithmetic. The net figure has to be right and its direction stated. The causes have to be attached to the evidence given rather than guessed at — and the pairing here is the standard one, where a purchasing decision shows up as a material variance that is worse rather than better. And the recommendations have to be actions somebody could take on Monday: "improve materials" is not one, "run a controlled yield test against the old supplier" is.',
    },
    {
      id: 'M-6-27', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.1', 'MATS-6.1.2'],
      type: 'written', minWords: 70,
      setup: 'Farndale Signs sells its standard sign at £48. The variable cost is £29 and the full absorption cost is £41. A trade customer has offered to buy 1,500 signs at £35 each for their own branch refit. The factory is running at about two thirds of capacity, the offer is a one-off, and the customer buys nothing from Farndale at present. The sales manager wants to refuse it because "we would be selling below cost".',
      q: 'Advise the sales manager whether to accept the order. Show the figure that decides it, and set out the conditions you would attach.',
      rubric: [
        { point: 'Calculates the contribution the order earns: £6 a unit, £9,000 in total', marks: 2 },
        { point: 'Explains that the fixed costs in the £41 are unchanged by the decision, so they are not relevant to it', marks: 2 },
        { point: 'Recommends acceptance on the figures given', marks: 1 },
        { point: 'Attaches the spare capacity condition — the answer reverses if the order displaces work at £19 of contribution', marks: 2 },
        { point: 'Attaches a condition about the effect on existing customers or on future pricing', marks: 1 },
      ],
      modelAnswer: 'On the figures given I would accept it.\n\nThe order earns £35.00 − £29.00 = £6.00 of contribution a unit, and 1,500 × £6.00 = £9,000 in total. Because the factory has spare capacity, none of the fixed costs change if we say yes, so every pound of that £9,000 reaches profit.\n\nThe £41 full absorption cost is what makes the order look like a loss, and it is the wrong figure for this decision. It contains a share of fixed overhead that we are paying whether or not this order is placed. Refusing the order does not save that overhead; it only costs us the £9,000.\n\nTwo conditions. First, the capacity has to be genuinely spare. If taking these 1,500 signs displaces ordinary work at £48, we lose £19 of contribution a unit to gain £6, and the answer reverses completely. Second, the price has to stay out of sight of the customers paying £48, and it should be clear to the customer that £35 is a one-off for a refit of this size rather than a new list price. An order that wins £9,000 once and resets everybody\'s expectation of what a sign costs is not worth taking.',
      exp: 'Every short-term decision task in this outcome is the same shape: find the contribution, say why the fixed costs are irrelevant, then name what would reverse the answer. The last part is where the marks separate. A recommendation with no conditions attached is not advice — spare capacity and price leakage are the two that decide most special orders, and a candidate who accepts unconditionally has answered only the arithmetic.',
    },
    {
      id: 'M-6-28', unitKey: 'mats', lo: 6, criteria: ['MATS-6.1.3', 'MATS-6.1.4'],
      type: 'written', minWords: 70,
      setup: 'You have completed a CVP analysis for Alnwick Coffee, which runs one shop. Contribution is £2.10 a cup, fixed costs are £126,000 a year and budgeted sales are 68,000 cups. Break-even is 60,000 cups, the margin of safety is 8,000 cups or 11.8%, and the profit-volume ratio is 42%.',
      q: 'Report to the owner on what these figures mean for the shop, and what you would look at first.',
      rubric: [
        { point: 'Translates the margin of safety into plain terms: sales can fall by about 12% before the shop loses money', marks: 2 },
        { point: 'Says that this is a thin margin, and names the fixed cost base as the reason', marks: 2 },
        { point: 'Uses the profit-volume ratio to make the point that extra revenue converts to profit quickly, at 42p in the pound', marks: 2 },
        { point: 'Recommends something specific and consistent with the figures — volume, price, or the fixed base', marks: 1 },
        { point: 'States at least one assumption the analysis rests on', marks: 1 },
      ],
      modelAnswer: 'The shop breaks even at 60,000 cups a year and the budget is 68,000, so sales can fall by about 12% before it stops making money. That is a thin margin: a wet summer, a closed road or a competitor opening nearby would each account for more than that.\n\nThe reason it is thin is the fixed cost base rather than the price. At £126,000 a year the shop has to sell 60,000 cups before it earns anything at all, so the first two thirds of the year\'s trade goes on covering the rent, the staff and the equipment.\n\nThe encouraging figure is the profit-volume ratio of 42%. Every extra pound of revenue brings 42p of contribution with it, and once break-even is passed that drops straight to profit. Volume is therefore where the leverage is: an extra 5,000 cups is worth about £10,500 of profit, and no additional fixed cost.\n\nWhat I would look at first is trade in the quiet hours. The fixed costs are being paid through them whether anybody comes in or not, so anything that fills them — a lunchtime offer, a morning delivery round — earns 42p in the pound against costs already committed. I would not recommend a price rise until we know what volume it would cost.\n\nOne caution. The analysis assumes the price and the cost per cup stay as they are across the range, and that everything made is sold. It is reliable near 68,000 cups and not much beyond them.',
      exp: 'Interpretation marks are lost far more often to accurate restatement than to wrong figures. "The margin of safety is 11.8%" is a number the owner already has; "sales can fall by about 12% before the shop loses money, and that is thin for a business this seasonal" is a report. The other half of the marks is for using the profit-volume ratio to point at a decision rather than quoting it.',
    },
    {
      id: 'M-7-27', unitKey: 'mats', lo: 7, criteria: ['MATS-7.1.1', 'MATS-7.2.3'],
      type: 'written', minWords: 70,
      setup: 'Thurlby Interiors made a profit of £84,000 last year and its bank balance fell by £11,000 over the same period. The owner is convinced the accounts are wrong. During the year the business bought a van for £26,000 in cash, the owner took £52,000 in drawings, inventory rose by £19,000 as new ranges were stocked, and customers now take an average of 63 days to pay against terms of 30.',
      q: 'Explain to the owner how the business can be profitable and have less cash than it started with, and suggest what to do about it.',
      rubric: [
        { point: 'States plainly that profit and cash answer different questions, so both figures can be right', marks: 2 },
        { point: 'Explains the van: the whole cost left the bank, but only the depreciation reached profit', marks: 2 },
        { point: 'Explains that drawings reduce cash and are not an expense, so they never touch profit', marks: 2 },
        { point: 'Identifies the receivables position — 63 days against 30-day terms — as cash sitting with customers', marks: 1 },
        { point: 'Recommends at least one specific action, such as chasing the overdue accounts or reviewing inventory levels', marks: 1 },
      ],
